...
/-! ## Norm bound: `‖septic_d8_perturbation_poly(a, b)‖ ≤ (‖a‖+‖b‖)⁸`

182 explicit deg-8 terms, max |numerator| = 6272, LCM = 15482880.
Uses the **split-half** Finset.sum approach: the 182-term def is split
into two 91-term halves at definition time, each provable via the
Finset.sum_range_succ pattern (which works reliably at ≤124 terms but
hits a simp recursion limit at 182). The two halves are combined via
`abel` and triangle inequality.

Combined bound: Σ ≤ 182·6272/15482880 = 1141504/15482880 ≈ 0.0737 ≤ 1, so `‖d8_perturbation‖ ≤ s⁸`.
(Actual Σ|num|/15482880 ≈ 0.0126.)
-/

-- Per-Nat-index family for the first half of `septic_d8_perturbation_poly`.
set_option maxHeartbeats 1600000 in
private noncomputable def septicD8FirstTermN (a b : 𝔸) : Nat → 𝔸
  | 0 => (-49 / 15482880 : 𝕂) • (a * a * a * a * a * a * a * b)
  | 1 => (343 / 15482880 : 𝕂) • (a * a * a * a * a * a * b * a)
  | 2 => (278 / 15482880 : 𝕂) • (a * a * a * a * a * a * b * b)
  | 3 => (-1029 / 15482880 : 𝕂) • (a * a * a * a * a * b * a * a)
  | 4 => (-1038 / 15482880 : 𝕂) • (a * a * a * a * a * b * a * b)
  | 5 => (-630 / 15482880 : 𝕂) • (a * a * a * a * a * b * b * a)
  | 6 => (-580 / 15482880 : 𝕂) • (a * a * a * a * a * b * b * b)
  | 7 => (1715 / 15482880 : 𝕂) • (a * a * a * a * b * a * a * a)
  | 8 => (1650 / 15482880 : 𝕂) • (a * a * a * a * b * a * a * b)
  | 9 => (1890 / 15482880 : 𝕂) • (a * a * a * a * b * a * b * a)
  | 10 => (1492 / 15482880 : 𝕂) • (a * a * a * a * b * a * b * b)
  | 11 => (630 / 15482880 : 𝕂) • (a * a * a * a * b * b * a * a)
  | 12 => (708 / 15482880 : 𝕂) • (a * a * a * a * b * b * a * b)
  | 13 => (700 / 15482880 : 𝕂) • (a * a * a * a * b * b * b * a)
  | 14 => (672 / 15482880 : 𝕂) • (a * a * a * a * b * b * b * b)
  | 15 => (-1715 / 15482880 : 𝕂) • (a * a * a * b * a * a * a * a)
  | 16 => (-1780 / 15482880 : 𝕂) • (a * a * a * b * a * a * a * b)
  | 17 => (-1260 / 15482880 : 𝕂) • (a * a * a * b * a * a * b * a)
  | 18 => (-720 / 15482880 : 𝕂) • (a * a * a * b * a * a * b * b)
  | 19 => (-2520 / 15482880 : 𝕂) • (a * a * a * b * a * b * a * a)
  | 20 => (-2848 / 15482880 : 𝕂) • (a * a * a * b * a * b * a * b)
  | 21 => (-1680 / 15482880 : 𝕂) • (a * a * a * b * a * b * b * a)
  | 22 => (-1456 / 15482880 : 𝕂) • (a * a * a * b * a * b * b * b)
  | 23 => (-104 / 15482880 : 𝕂) • (a * a * a * b * b * a * a * b)
  | 24 => (224 / 15482880 : 𝕂) • (a * a * a * b * b * a * b * a)
  | 25 => (112 / 15482880 : 𝕂) • (a * a * a * b * b * a * b * b)
  | 26 => (-672 / 15482880 : 𝕂) • (a * a * a * b * b * b * a * a)
  | 27 => (-896 / 15482880 : 𝕂) • (a * a * a * b * b * b * a * b)
  | 28 => (-448 / 15482880 : 𝕂) • (a * a * a * b * b * b * b * a)
  | 29 => (-352 / 15482880 : 𝕂) • (a * a * a * b * b * b * b * b)
  | 30 => (1029 / 15482880 : 𝕂) • (a * a * b * a * a * a * a * a)
  | 31 => (1020 / 15482880 : 𝕂) • (a * a * b * a * a * a * a * b)
  | 32 => (1260 / 15482880 : 𝕂) • (a * a * b * a * a * a * b * a)
  | 33 => (232 / 15482880 : 𝕂) • (a * a * b * a * a * a * b * b)
  | 34 => (1072 / 15482880 : 𝕂) • (a * a * b * a * a * b * a * b)
  | 35 => (392 / 15482880 : 𝕂) • (a * a * b * a * a * b * b * a)
  | 36 => (-112 / 15482880 : 𝕂) • (a * a * b * a * a * b * b * b)
  | 37 => (2520 / 15482880 : 𝕂) • (a * a * b * a * b * a * a * a)
  | 38 => (2192 / 15482880 : 𝕂) • (a * a * b * a * b * a * a * b)
  | 39 => (2016 / 15482880 : 𝕂) • (a * a * b * a * b * a * b * a)
  | 40 => (1792 / 15482880 : 𝕂) • (a * a * b * a * b * a * b * b)
  | 41 => (1120 / 15482880 : 𝕂) • (a * a * b * a * b * b * a * a)
  | 42 => (1792 / 15482880 : 𝕂) • (a * a * b * a * b * b * a * b)
  | 43 => (1008 / 15482880 : 𝕂) • (a * a * b * a * b * b * b * a)
  | 44 => (992 / 15482880 : 𝕂) • (a * a * b * a * b * b * b * b)
  | 45 => (-630 / 15482880 : 𝕂) • (a * a * b * b * a * a * a * a)
  | 46 => (-552 / 15482880 : 𝕂) • (a * a * b * b * a * a * a * b)
  | 47 => (-224 / 15482880 : 𝕂) • (a * a * b * b * a * a * b * a)
  | 48 => (-784 / 15482880 : 𝕂) • (a * a * b * b * a * a * b * b)
  | 49 => (-1120 / 15482880 : 𝕂) • (a * a * b * b * a * b * a * a)
  | 50 => (-448 / 15482880 : 𝕂) • (a * a * b * b * a * b * a * b)
  | 51 => (-112 / 15482880 : 𝕂) • (a * a * b * b * a * b * b * a)
  | 52 => (-800 / 15482880 : 𝕂) • (a * a * b * b * a * b * b * b)
  | 53 => (672 / 15482880 : 𝕂) • (a * a * b * b * b * a * a * a)
  | 54 => (448 / 15482880 : 𝕂) • (a * a * b * b * b * a * a * b)
  | 55 => (448 / 15482880 : 𝕂) • (a * a * b * b * b * a * b * a)
  | 56 => (320 / 15482880 : 𝕂) • (a * a * b * b * b * a * b * b)
  | 57 => (320 / 15482880 : 𝕂) • (a * a * b * b * b * b * a * b)
  | 58 => (224 / 15482880 : 𝕂) • (a * a * b * b * b * b * b * a)
  | 59 => (64 / 15482880 : 𝕂) • (a * a * b * b * b * b * b * b)
  | 60 => (-343 / 15482880 : 𝕂) • (a * b * a * a * a * a * a * a)
  | 61 => (-408 / 15482880 : 𝕂) • (a * b * a * a * a * a * a * b)
  | 62 => (736 / 15482880 : 𝕂) • (a * b * a * a * a * a * b * b)
  | 63 => (-1260 / 15482880 : 𝕂) • (a * b * a * a * a * b * a * a)
  | 64 => (-2624 / 15482880 : 𝕂) • (a * b * a * a * a * b * a * b)
  | 65 => (-784 / 15482880 : 𝕂) • (a * b * a * a * a * b * b * a)
  | 66 => (-1120 / 15482880 : 𝕂) • (a * b * a * a * a * b * b * b)
  | 67 => (1260 / 15482880 : 𝕂) • (a * b * a * a * b * a * a * a)
  | 68 => (2304 / 15482880 : 𝕂) • (a * b * a * a * b * a * a * b)
  | 69 => (1120 / 15482880 : 𝕂) • (a * b * a * a * b * a * b * a)
  | 70 => (2352 / 15482880 : 𝕂) • (a * b * a * a * b * a * b * b)
  | 71 => (224 / 15482880 : 𝕂) • (a * b * a * a * b * b * a * a)
  | 72 => (672 / 15482880 : 𝕂) • (a * b * a * a * b * b * a * b)
  | 73 => (560 / 15482880 : 𝕂) • (a * b * a * a * b * b * b * a)
  | 74 => (768 / 15482880 : 𝕂) • (a * b * a * a * b * b * b * b)
  | 75 => (-1890 / 15482880 : 𝕂) • (a * b * a * b * a * a * a * a)
  | 76 => (-2624 / 15482880 : 𝕂) • (a * b * a * b * a * a * a * b)
  | 77 => (-1120 / 15482880 : 𝕂) • (a * b * a * b * a * a * b * a)
  | 78 => (112 / 15482880 : 𝕂) • (a * b * a * b * a * a * b * b)
  | 79 => (-2016 / 15482880 : 𝕂) • (a * b * a * b * a * b * a * a)
  | 80 => (-6272 / 15482880 : 𝕂) • (a * b * a * b * a * b * a * b)
  | 81 => (-2240 / 15482880 : 𝕂) • (a * b * a * b * a * b * b * a)
  | 82 => (-2368 / 15482880 : 𝕂) • (a * b * a * b * a * b * b * b)
  | 83 => (-224 / 15482880 : 𝕂) • (a * b * a * b * b * a * a * a)
  | 84 => (672 / 15482880 : 𝕂) • (a * b * a * b * b * a * a * b)
  | 85 => (1440 / 15482880 : 𝕂) • (a * b * a * b * b * a * b * b)
  | 86 => (-448 / 15482880 : 𝕂) • (a * b * a * b * b * b * a * a)
  | 87 => (-1920 / 15482880 : 𝕂) • (a * b * a * b * b * b * a * b)
  | 88 => (-672 / 15482880 : 𝕂) • (a * b * a * b * b * b * b * a)
  | 89 => (-384 / 15482880 : 𝕂) • (a * b * a * b * b * b * b * b)
  | 90 => (630 / 15482880 : 𝕂) • (a * b * b * a * a * a * a * a)
  | _ => 0

/-- `Fin 91`-indexed wrapper. -/
private noncomputable def septicD8FirstTerm (a b : 𝔸) (i : Fin 91) : 𝔸 :=
  septicD8FirstTermN (𝕂 := 𝕂) a b i.val

-- The explicit first-half sum equals the Finset.sum form.
set_option maxHeartbeats 16000000 in
set_option maxRecDepth 2000 in
private theorem septicD8First_explicit_eq_sum (a b : 𝔸) :
    (-49 / 15482880 : 𝕂) • (a * a * a * a * a * a * a * b) +
      (343 / 15482880 : 𝕂) • (a * a * a * a * a * a * b * a) +
      (278 / 15482880 : 𝕂) • (a * a * a * a * a * a * b * b) +
      (-1029 / 15482880 : 𝕂) • (a * a * a * a * a * b * a * a) +
      ...
      (-384 / 15482880 : 𝕂) • (a * b * a * b * b * b * b * b) +
      (630 / 15482880 : 𝕂) • (a * b * b * a * a * a * a * a) =
      ∑ i : Fin 91, septicD8FirstTerm (𝕂 := 𝕂) a b i := by
  unfold septicD8FirstTerm
  rw [Fin.sum_univ_eq_sum_range (fun k => septicD8FirstTermN (𝕂 := 𝕂) a b k)]
  simp only [Finset.sum_range_succ, Finset.sum_range_zero,
    septicD8FirstTermN, zero_add]

-- Per-index uniform bound: `‖septicD8FirstTerm a b i‖ ≤ (6272/15482880) · s^8`
set_option maxHeartbeats 8000000 in
private lemma septicD8FirstTerm_norm_le (a b : 𝔸) (s : ℝ)
    (ha : ‖a‖ ≤ s) (hb : ‖b‖ ≤ s) (hs : 0 ≤ s) :
    ∀ i : Fin 91, ‖septicD8FirstTerm (𝕂 := 𝕂) a b i‖ ≤ (6272 / 15482880 : ℝ) * s^8 := fun i =>
  match i with
  | ⟨0, _⟩ =>
    show ‖(-49 / 15482880 : 𝕂) • (a * a * a * a * a * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-49 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a a a a b s ha ha ha ha ha ha ha hb (by norm_num) hs
  | ⟨1, _⟩ =>
    show ‖(343 / 15482880 : 𝕂) • (a * a * a * a * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (343 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a a a b a s ha ha ha ha ha ha hb ha (by norm_num) hs
  | ⟨2, _⟩ =>
    show ‖(278 / 15482880 : 𝕂) • (a * a * a * a * a * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (278 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a a a b b s ha ha ha ha ha ha hb hb (by norm_num) hs
  | ⟨3, _⟩ =>
    show ‖(-1029 / 15482880 : 𝕂) • (a * a * a * a * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1029 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a a b a a s ha ha ha ha ha hb ha ha (by norm_num) hs
  | ⟨4, _⟩ =>
    show ‖(-1038 / 15482880 : 𝕂) • (a * a * a * a * a * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1038 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a a b a b s ha ha ha ha ha hb ha hb (by norm_num) hs
  | ⟨5, _⟩ =>
    show ‖(-630 / 15482880 : 𝕂) • (a * a * a * a * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-630 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a a b b a s ha ha ha ha ha hb hb ha (by norm_num) hs
  | ⟨6, _⟩ =>
    show ‖(-580 / 15482880 : 𝕂) • (a * a * a * a * a * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-580 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a a b b b s ha ha ha ha ha hb hb hb (by norm_num) hs
  | ⟨7, _⟩ =>
    show ‖(1715 / 15482880 : 𝕂) • (a * a * a * a * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1715 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b a a a s ha ha ha ha hb ha ha ha (by norm_num) hs
  | ⟨8, _⟩ =>
    show ‖(1650 / 15482880 : 𝕂) • (a * a * a * a * b * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1650 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b a a b s ha ha ha ha hb ha ha hb (by norm_num) hs
  | ⟨9, _⟩ =>
    show ‖(1890 / 15482880 : 𝕂) • (a * a * a * a * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1890 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b a b a s ha ha ha ha hb ha hb ha (by norm_num) hs
  | ⟨10, _⟩ =>
    show ‖(1492 / 15482880 : 𝕂) • (a * a * a * a * b * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1492 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b a b b s ha ha ha ha hb ha hb hb (by norm_num) hs
  | ⟨11, _⟩ =>
    show ‖(630 / 15482880 : 𝕂) • (a * a * a * a * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (630 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b b a a s ha ha ha ha hb hb ha ha (by norm_num) hs
  | ⟨12, _⟩ =>
    show ‖(708 / 15482880 : 𝕂) • (a * a * a * a * b * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (708 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b b a b s ha ha ha ha hb hb ha hb (by norm_num) hs
  | ⟨13, _⟩ =>
    show ‖(700 / 15482880 : 𝕂) • (a * a * a * a * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (700 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b b b a s ha ha ha ha hb hb hb ha (by norm_num) hs
  | ⟨14, _⟩ =>
    show ‖(672 / 15482880 : 𝕂) • (a * a * a * a * b * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b b b b s ha ha ha ha hb hb hb hb (by norm_num) hs
  | ⟨15, _⟩ =>
    show ‖(-1715 / 15482880 : 𝕂) • (a * a * a * b * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1715 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a a a a s ha ha ha hb ha ha ha ha (by norm_num) hs
  | ⟨16, _⟩ =>
    show ‖(-1780 / 15482880 : 𝕂) • (a * a * a * b * a * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1780 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a a a b s ha ha ha hb ha ha ha hb (by norm_num) hs
  | ⟨17, _⟩ =>
    show ‖(-1260 / 15482880 : 𝕂) • (a * a * a * b * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1260 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a a b a s ha ha ha hb ha ha hb ha (by norm_num) hs
  | ⟨18, _⟩ =>
    show ‖(-720 / 15482880 : 𝕂) • (a * a * a * b * a * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-720 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a a b b s ha ha ha hb ha ha hb hb (by norm_num) hs
  | ⟨19, _⟩ =>
    show ‖(-2520 / 15482880 : 𝕂) • (a * a * a * b * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2520 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a b a a s ha ha ha hb ha hb ha ha (by norm_num) hs
  | ⟨20, _⟩ =>
    show ‖(-2848 / 15482880 : 𝕂) • (a * a * a * b * a * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2848 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a b a b s ha ha ha hb ha hb ha hb (by norm_num) hs
  | ⟨21, _⟩ =>
    show ‖(-1680 / 15482880 : 𝕂) • (a * a * a * b * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1680 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a b b a s ha ha ha hb ha hb hb ha (by norm_num) hs
  | ⟨22, _⟩ =>
    show ‖(-1456 / 15482880 : 𝕂) • (a * a * a * b * a * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1456 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a b b b s ha ha ha hb ha hb hb hb (by norm_num) hs
  | ⟨23, _⟩ =>
    show ‖(-104 / 15482880 : 𝕂) • (a * a * a * b * b * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-104 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b a a b s ha ha ha hb hb ha ha hb (by norm_num) hs
  | ⟨24, _⟩ =>
    show ‖(224 / 15482880 : 𝕂) • (a * a * a * b * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (224 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b a b a s ha ha ha hb hb ha hb ha (by norm_num) hs
  | ⟨25, _⟩ =>
    show ‖(112 / 15482880 : 𝕂) • (a * a * a * b * b * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b a b b s ha ha ha hb hb ha hb hb (by norm_num) hs
  | ⟨26, _⟩ =>
    show ‖(-672 / 15482880 : 𝕂) • (a * a * a * b * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b b a a s ha ha ha hb hb hb ha ha (by norm_num) hs
  | ⟨27, _⟩ =>
    show ‖(-896 / 15482880 : 𝕂) • (a * a * a * b * b * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-896 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b b a b s ha ha ha hb hb hb ha hb (by norm_num) hs
  | ⟨28, _⟩ =>
    show ‖(-448 / 15482880 : 𝕂) • (a * a * a * b * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b b b a s ha ha ha hb hb hb hb ha (by norm_num) hs
  | ⟨29, _⟩ =>
    show ‖(-352 / 15482880 : 𝕂) • (a * a * a * b * b * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b b b b s ha ha ha hb hb hb hb hb (by norm_num) hs
  | ⟨30, _⟩ =>
    show ‖(1029 / 15482880 : 𝕂) • (a * a * b * a * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1029 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a a a a a s ha ha hb ha ha ha ha ha (by norm_num) hs
  | ⟨31, _⟩ =>
    show ‖(1020 / 15482880 : 𝕂) • (a * a * b * a * a * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1020 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a a a a b s ha ha hb ha ha ha ha hb (by norm_num) hs
  | ⟨32, _⟩ =>
    show ‖(1260 / 15482880 : 𝕂) • (a * a * b * a * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1260 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a a a b a s ha ha hb ha ha ha hb ha (by norm_num) hs
  | ⟨33, _⟩ =>
    show ‖(232 / 15482880 : 𝕂) • (a * a * b * a * a * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (232 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a a a b b s ha ha hb ha ha ha hb hb (by norm_num) hs
  | ⟨34, _⟩ =>
    show ‖(1072 / 15482880 : 𝕂) • (a * a * b * a * a * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1072 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a a b a b s ha ha hb ha ha hb ha hb (by norm_num) hs
  | ⟨35, _⟩ =>
    show ‖(392 / 15482880 : 𝕂) • (a * a * b * a * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (392 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a a b b a s ha ha hb ha ha hb hb ha (by norm_num) hs
  | ⟨36, _⟩ =>
    show ‖(-112 / 15482880 : 𝕂) • (a * a * b * a * a * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a a b b b s ha ha hb ha ha hb hb hb (by norm_num) hs
  | ⟨37, _⟩ =>
    show ‖(2520 / 15482880 : 𝕂) • (a * a * b * a * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2520 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b a a a s ha ha hb ha hb ha ha ha (by norm_num) hs
  | ⟨38, _⟩ =>
    show ‖(2192 / 15482880 : 𝕂) • (a * a * b * a * b * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2192 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b a a b s ha ha hb ha hb ha ha hb (by norm_num) hs
  | ⟨39, _⟩ =>
    show ‖(2016 / 15482880 : 𝕂) • (a * a * b * a * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2016 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b a b a s ha ha hb ha hb ha hb ha (by norm_num) hs
  | ⟨40, _⟩ =>
    show ‖(1792 / 15482880 : 𝕂) • (a * a * b * a * b * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1792 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b a b b s ha ha hb ha hb ha hb hb (by norm_num) hs
  | ⟨41, _⟩ =>
    show ‖(1120 / 15482880 : 𝕂) • (a * a * b * a * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b b a a s ha ha hb ha hb hb ha ha (by norm_num) hs
  | ⟨42, _⟩ =>
    show ‖(1792 / 15482880 : 𝕂) • (a * a * b * a * b * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1792 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b b a b s ha ha hb ha hb hb ha hb (by norm_num) hs
  | ⟨43, _⟩ =>
    show ‖(1008 / 15482880 : 𝕂) • (a * a * b * a * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1008 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b b b a s ha ha hb ha hb hb hb ha (by norm_num) hs
  | ⟨44, _⟩ =>
    show ‖(992 / 15482880 : 𝕂) • (a * a * b * a * b * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (992 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b b b b s ha ha hb ha hb hb hb hb (by norm_num) hs
  | ⟨45, _⟩ =>
    show ‖(-630 / 15482880 : 𝕂) • (a * a * b * b * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-630 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a a a a s ha ha hb hb ha ha ha ha (by norm_num) hs
  | ⟨46, _⟩ =>
    show ‖(-552 / 15482880 : 𝕂) • (a * a * b * b * a * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-552 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a a a b s ha ha hb hb ha ha ha hb (by norm_num) hs
  | ⟨47, _⟩ =>
    show ‖(-224 / 15482880 : 𝕂) • (a * a * b * b * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-224 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a a b a s ha ha hb hb ha ha hb ha (by norm_num) hs
  | ⟨48, _⟩ =>
    show ‖(-784 / 15482880 : 𝕂) • (a * a * b * b * a * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-784 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a a b b s ha ha hb hb ha ha hb hb (by norm_num) hs
  | ⟨49, _⟩ =>
    show ‖(-1120 / 15482880 : 𝕂) • (a * a * b * b * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a b a a s ha ha hb hb ha hb ha ha (by norm_num) hs
  | ⟨50, _⟩ =>
    show ‖(-448 / 15482880 : 𝕂) • (a * a * b * b * a * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a b a b s ha ha hb hb ha hb ha hb (by norm_num) hs
  | ⟨51, _⟩ =>
    show ‖(-112 / 15482880 : 𝕂) • (a * a * b * b * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a b b a s ha ha hb hb ha hb hb ha (by norm_num) hs
  | ⟨52, _⟩ =>
    show ‖(-800 / 15482880 : 𝕂) • (a * a * b * b * a * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-800 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a b b b s ha ha hb hb ha hb hb hb (by norm_num) hs
  | ⟨53, _⟩ =>
    show ‖(672 / 15482880 : 𝕂) • (a * a * b * b * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b b a a a s ha ha hb hb hb ha ha ha (by norm_num) hs
  | ⟨54, _⟩ =>
    show ‖(448 / 15482880 : 𝕂) • (a * a * b * b * b * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b b a a b s ha ha hb hb hb ha ha hb (by norm_num) hs
  | ⟨55, _⟩ =>
    show ‖(448 / 15482880 : 𝕂) • (a * a * b * b * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b b a b a s ha ha hb hb hb ha hb ha (by norm_num) hs
  | ⟨56, _⟩ =>
    show ‖(320 / 15482880 : 𝕂) • (a * a * b * b * b * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (320 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b b a b b s ha ha hb hb hb ha hb hb (by norm_num) hs
  | ⟨57, _⟩ =>
    show ‖(320 / 15482880 : 𝕂) • (a * a * b * b * b * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (320 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b b b a b s ha ha hb hb hb hb ha hb (by norm_num) hs
  | ⟨58, _⟩ =>
    show ‖(224 / 15482880 : 𝕂) • (a * a * b * b * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (224 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b b b b a s ha ha hb hb hb hb hb ha (by norm_num) hs
  | ⟨59, _⟩ =>
    show ‖(64 / 15482880 : 𝕂) • (a * a * b * b * b * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (64 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b b b b b s ha ha hb hb hb hb hb hb (by norm_num) hs
  | ⟨60, _⟩ =>
    show ‖(-343 / 15482880 : 𝕂) • (a * b * a * a * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-343 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a a a a a s ha hb ha ha ha ha ha ha (by norm_num) hs
  | ⟨61, _⟩ =>
    show ‖(-408 / 15482880 : 𝕂) • (a * b * a * a * a * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-408 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a a a a b s ha hb ha ha ha ha ha hb (by norm_num) hs
  | ⟨62, _⟩ =>
    show ‖(736 / 15482880 : 𝕂) • (a * b * a * a * a * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (736 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a a a b b s ha hb ha ha ha ha hb hb (by norm_num) hs
  | ⟨63, _⟩ =>
    show ‖(-1260 / 15482880 : 𝕂) • (a * b * a * a * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1260 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a a b a a s ha hb ha ha ha hb ha ha (by norm_num) hs
  | ⟨64, _⟩ =>
    show ‖(-2624 / 15482880 : 𝕂) • (a * b * a * a * a * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2624 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a a b a b s ha hb ha ha ha hb ha hb (by norm_num) hs
  | ⟨65, _⟩ =>
    show ‖(-784 / 15482880 : 𝕂) • (a * b * a * a * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-784 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a a b b a s ha hb ha ha ha hb hb ha (by norm_num) hs
  | ⟨66, _⟩ =>
    show ‖(-1120 / 15482880 : 𝕂) • (a * b * a * a * a * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a a b b b s ha hb ha ha ha hb hb hb (by norm_num) hs
  | ⟨67, _⟩ =>
    show ‖(1260 / 15482880 : 𝕂) • (a * b * a * a * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1260 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a b a a a s ha hb ha ha hb ha ha ha (by norm_num) hs
  | ⟨68, _⟩ =>
    show ‖(2304 / 15482880 : 𝕂) • (a * b * a * a * b * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2304 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a b a a b s ha hb ha ha hb ha ha hb (by norm_num) hs
  | ⟨69, _⟩ =>
    show ‖(1120 / 15482880 : 𝕂) • (a * b * a * a * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a b a b a s ha hb ha ha hb ha hb ha (by norm_num) hs
  | ⟨70, _⟩ =>
    show ‖(2352 / 15482880 : 𝕂) • (a * b * a * a * b * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a b a b b s ha hb ha ha hb ha hb hb (by norm_num) hs
  | ⟨71, _⟩ =>
    show ‖(224 / 15482880 : 𝕂) • (a * b * a * a * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (224 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a b b a a s ha hb ha ha hb hb ha ha (by norm_num) hs
  | ⟨72, _⟩ =>
    show ‖(672 / 15482880 : 𝕂) • (a * b * a * a * b * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a b b a b s ha hb ha ha hb hb ha hb (by norm_num) hs
  | ⟨73, _⟩ =>
    show ‖(560 / 15482880 : 𝕂) • (a * b * a * a * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (560 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a b b b a s ha hb ha ha hb hb hb ha (by norm_num) hs
  | ⟨74, _⟩ =>
    show ‖(768 / 15482880 : 𝕂) • (a * b * a * a * b * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (768 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a b b b b s ha hb ha ha hb hb hb hb (by norm_num) hs
  | ⟨75, _⟩ =>
    show ‖(-1890 / 15482880 : 𝕂) • (a * b * a * b * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1890 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a a a a s ha hb ha hb ha ha ha ha (by norm_num) hs
  | ⟨76, _⟩ =>
    show ‖(-2624 / 15482880 : 𝕂) • (a * b * a * b * a * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2624 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a a a b s ha hb ha hb ha ha ha hb (by norm_num) hs
  | ⟨77, _⟩ =>
    show ‖(-1120 / 15482880 : 𝕂) • (a * b * a * b * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a a b a s ha hb ha hb ha ha hb ha (by norm_num) hs
  | ⟨78, _⟩ =>
    show ‖(112 / 15482880 : 𝕂) • (a * b * a * b * a * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a a b b s ha hb ha hb ha ha hb hb (by norm_num) hs
  | ⟨79, _⟩ =>
    show ‖(-2016 / 15482880 : 𝕂) • (a * b * a * b * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2016 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a b a a s ha hb ha hb ha hb ha ha (by norm_num) hs
  | ⟨80, _⟩ =>
    show ‖(-6272 / 15482880 : 𝕂) • (a * b * a * b * a * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-6272 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a b a b s ha hb ha hb ha hb ha hb (by norm_num) hs
  | ⟨81, _⟩ =>
    show ‖(-2240 / 15482880 : 𝕂) • (a * b * a * b * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2240 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a b b a s ha hb ha hb ha hb hb ha (by norm_num) hs
  | ⟨82, _⟩ =>
    show ‖(-2368 / 15482880 : 𝕂) • (a * b * a * b * a * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2368 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a b b b s ha hb ha hb ha hb hb hb (by norm_num) hs
  | ⟨83, _⟩ =>
    show ‖(-224 / 15482880 : 𝕂) • (a * b * a * b * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-224 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b b a a a s ha hb ha hb hb ha ha ha (by norm_num) hs
  | ⟨84, _⟩ =>
    show ‖(672 / 15482880 : 𝕂) • (a * b * a * b * b * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b b a a b s ha hb ha hb hb ha ha hb (by norm_num) hs
  | ⟨85, _⟩ =>
    show ‖(1440 / 15482880 : 𝕂) • (a * b * a * b * b * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1440 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b b a b b s ha hb ha hb hb ha hb hb (by norm_num) hs
  | ⟨86, _⟩ =>
    show ‖(-448 / 15482880 : 𝕂) • (a * b * a * b * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b b b a a s ha hb ha hb hb hb ha ha (by norm_num) hs
  | ⟨87, _⟩ =>
    show ‖(-1920 / 15482880 : 𝕂) • (a * b * a * b * b * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1920 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b b b a b s ha hb ha hb hb hb ha hb (by norm_num) hs
  | ⟨88, _⟩ =>
    show ‖(-672 / 15482880 : 𝕂) • (a * b * a * b * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b b b b a s ha hb ha hb hb hb hb ha (by norm_num) hs
  | ⟨89, _⟩ =>
    show ‖(-384 / 15482880 : 𝕂) • (a * b * a * b * b * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-384 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b b b b b s ha hb ha hb hb hb hb hb (by norm_num) hs
  | ⟨90, _⟩ =>
    show ‖(630 / 15482880 : 𝕂) • (a * b * b * a * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (630 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a a a a a s ha hb hb ha ha ha ha ha (by norm_num) hs
  | ⟨_ + 91, h⟩ => absurd h (by omega)

set_option maxHeartbeats 1600000 in
-- Norm bound on the first half (Finset.sum form).
private theorem norm_septicD8FirstSum_le (a b : 𝔸) :
    ‖∑ i : Fin 91, septicD8FirstTerm (𝕂 := 𝕂) a b i‖ ≤ (91 * 6272 / 15482880 : ℝ) * (‖a‖ + ‖b‖) ^ 8 := by
  set s := ‖a‖ + ‖b‖ with hs_def
  have hs_nn : 0 ≤ s := by positivity
  have ha_le : ‖a‖ ≤ s := by linarith [norm_nonneg b]
  have hb_le : ‖b‖ ≤ s := by linarith [norm_nonneg a]
  calc ‖∑ i : Fin 91, septicD8FirstTerm (𝕂 := 𝕂) a b i‖
      ≤ ∑ i : Fin 91, ‖septicD8FirstTerm (𝕂 := 𝕂) a b i‖ := norm_sum_le _ _
    _ ≤ ∑ _i : Fin 91, (6272 / 15482880 : ℝ) * s^8 :=
        Finset.sum_le_sum (fun i _ => septicD8FirstTerm_norm_le (𝕂 := 𝕂) a b s ha_le hb_le hs_nn i)
    _ = 91 * ((6272 / 15482880 : ℝ) * s^8) := by
        rw [Finset.sum_const, Finset.card_univ, Fintype.card_fin]; ring
    _ = (91 * 6272 / 15482880 : ℝ) * s^8 := by ring

-- Per-Nat-index family for the second half of `septic_d8_perturbation_poly`.
set_option maxHeartbeats 1600000 in
private noncomputable def septicD8SecondTermN (a b : 𝔸) : Nat → 𝔸
  | 0 => (736 / 15482880 : 𝕂) • (a * b * b * a * a * a * a * b)
  | 1 => (784 / 15482880 : 𝕂) • (a * b * b * a * a * a * b * a)
  | 2 => (448 / 15482880 : 𝕂) • (a * b * b * a * a * a * b * b)
  | 3 => (-392 / 15482880 : 𝕂) • (a * b * b * a * a * b * a * a)
  | 4 => (112 / 15482880 : 𝕂) • (a * b * b * a * a * b * a * b)
  | 5 => (-352 / 15482880 : 𝕂) • (a * b * b * a * a * b * b * b)
  | 6 => (1680 / 15482880 : 𝕂) • (a * b * b * a * b * a * a * a)
  | 7 => (2352 / 15482880 : 𝕂) • (a * b * b * a * b * a * a * b)
  | 8 => (2240 / 15482880 : 𝕂) • (a * b * b * a * b * a * b * a)
  | 9 => (2112 / 15482880 : 𝕂) • (a * b * b * a * b * a * b * b)
  | 10 => (112 / 15482880 : 𝕂) • (a * b * b * a * b * b * a * a)
  | 11 => (1440 / 15482880 : 𝕂) • (a * b * b * a * b * b * a * b)
  | 12 => (1120 / 15482880 : 𝕂) • (a * b * b * a * b * b * b * a)
  | 13 => (960 / 15482880 : 𝕂) • (a * b * b * a * b * b * b * b)
  | 14 => (-700 / 15482880 : 𝕂) • (a * b * b * b * a * a * a * a)
  | 15 => (-1120 / 15482880 : 𝕂) • (a * b * b * b * a * a * a * b)
  | 16 => (-560 / 15482880 : 𝕂) • (a * b * b * b * a * a * b * a)
  | 17 => (-352 / 15482880 : 𝕂) • (a * b * b * b * a * a * b * b)
  | 18 => (-1008 / 15482880 : 𝕂) • (a * b * b * b * a * b * a * a)
  | 19 => (-2368 / 15482880 : 𝕂) • (a * b * b * b * a * b * a * b)
  | 20 => (-1120 / 15482880 : 𝕂) • (a * b * b * b * a * b * b * a)
  | 21 => (-1280 / 15482880 : 𝕂) • (a * b * b * b * a * b * b * b)
  | 22 => (448 / 15482880 : 𝕂) • (a * b * b * b * b * a * a * a)
  | 23 => (768 / 15482880 : 𝕂) • (a * b * b * b * b * a * a * b)
  | 24 => (672 / 15482880 : 𝕂) • (a * b * b * b * b * a * b * a)
  | 25 => (960 / 15482880 : 𝕂) • (a * b * b * b * b * a * b * b)
  | 26 => (-224 / 15482880 : 𝕂) • (a * b * b * b * b * b * a * a)
  | 27 => (-384 / 15482880 : 𝕂) • (a * b * b * b * b * b * a * b)
  | 28 => (49 / 15482880 : 𝕂) • (b * a * a * a * a * a * a * a)
  | 29 => (408 / 15482880 : 𝕂) • (b * a * a * a * a * a * b * a)
  | 30 => (-1020 / 15482880 : 𝕂) • (b * a * a * a * a * b * a * a)
  | 31 => (-736 / 15482880 : 𝕂) • (b * a * a * a * a * b * b * a)
  | 32 => (1780 / 15482880 : 𝕂) • (b * a * a * a * b * a * a * a)
  | 33 => (2624 / 15482880 : 𝕂) • (b * a * a * a * b * a * b * a)
  | 34 => (552 / 15482880 : 𝕂) • (b * a * a * a * b * b * a * a)
  | 35 => (1120 / 15482880 : 𝕂) • (b * a * a * a * b * b * b * a)
  | 36 => (-1650 / 15482880 : 𝕂) • (b * a * a * b * a * a * a * a)
  | 37 => (-2304 / 15482880 : 𝕂) • (b * a * a * b * a * a * b * a)
  | 38 => (-2192 / 15482880 : 𝕂) • (b * a * a * b * a * b * a * a)
  | 39 => (-2352 / 15482880 : 𝕂) • (b * a * a * b * a * b * b * a)
  | 40 => (104 / 15482880 : 𝕂) • (b * a * a * b * b * a * a * a)
  | 41 => (-672 / 15482880 : 𝕂) • (b * a * a * b * b * a * b * a)
  | 42 => (-448 / 15482880 : 𝕂) • (b * a * a * b * b * b * a * a)
  | 43 => (-768 / 15482880 : 𝕂) • (b * a * a * b * b * b * b * a)
  | 44 => (1038 / 15482880 : 𝕂) • (b * a * b * a * a * a * a * a)
  | 45 => (2624 / 15482880 : 𝕂) • (b * a * b * a * a * a * b * a)
  | 46 => (-1072 / 15482880 : 𝕂) • (b * a * b * a * a * b * a * a)
  | 47 => (-112 / 15482880 : 𝕂) • (b * a * b * a * a * b * b * a)
  | 48 => (2848 / 15482880 : 𝕂) • (b * a * b * a * b * a * a * a)
  | 49 => (6272 / 15482880 : 𝕂) • (b * a * b * a * b * a * b * a)
  | 50 => (448 / 15482880 : 𝕂) • (b * a * b * a * b * b * a * a)
  | 51 => (2368 / 15482880 : 𝕂) • (b * a * b * a * b * b * b * a)
  | 52 => (-708 / 15482880 : 𝕂) • (b * a * b * b * a * a * a * a)
  | 53 => (-672 / 15482880 : 𝕂) • (b * a * b * b * a * a * b * a)
  | 54 => (-1792 / 15482880 : 𝕂) • (b * a * b * b * a * b * a * a)
  | 55 => (-1440 / 15482880 : 𝕂) • (b * a * b * b * a * b * b * a)
  | 56 => (896 / 15482880 : 𝕂) • (b * a * b * b * b * a * a * a)
  | 57 => (1920 / 15482880 : 𝕂) • (b * a * b * b * b * a * b * a)
  | 58 => (-320 / 15482880 : 𝕂) • (b * a * b * b * b * b * a * a)
  | 59 => (384 / 15482880 : 𝕂) • (b * a * b * b * b * b * b * a)
  | 60 => (-278 / 15482880 : 𝕂) • (b * b * a * a * a * a * a * a)
  | 61 => (-736 / 15482880 : 𝕂) • (b * b * a * a * a * a * b * a)
  | 62 => (-232 / 15482880 : 𝕂) • (b * b * a * a * a * b * a * a)
  | 63 => (-448 / 15482880 : 𝕂) • (b * b * a * a * a * b * b * a)
  | 64 => (720 / 15482880 : 𝕂) • (b * b * a * a * b * a * a * a)
  | 65 => (-112 / 15482880 : 𝕂) • (b * b * a * a * b * a * b * a)
  | 66 => (784 / 15482880 : 𝕂) • (b * b * a * a * b * b * a * a)
  | 67 => (352 / 15482880 : 𝕂) • (b * b * a * a * b * b * b * a)
  | 68 => (-1492 / 15482880 : 𝕂) • (b * b * a * b * a * a * a * a)
  | 69 => (-2352 / 15482880 : 𝕂) • (b * b * a * b * a * a * b * a)
  | 70 => (-1792 / 15482880 : 𝕂) • (b * b * a * b * a * b * a * a)
  | 71 => (-2112 / 15482880 : 𝕂) • (b * b * a * b * a * b * b * a)
  | 72 => (-112 / 15482880 : 𝕂) • (b * b * a * b * b * a * a * a)
  | 73 => (-1440 / 15482880 : 𝕂) • (b * b * a * b * b * a * b * a)
  | 74 => (-320 / 15482880 : 𝕂) • (b * b * a * b * b * b * a * a)
  | 75 => (-960 / 15482880 : 𝕂) • (b * b * a * b * b * b * b * a)
  | 76 => (580 / 15482880 : 𝕂) • (b * b * b * a * a * a * a * a)
  | 77 => (1120 / 15482880 : 𝕂) • (b * b * b * a * a * a * b * a)
  | 78 => (112 / 15482880 : 𝕂) • (b * b * b * a * a * b * a * a)
  | 79 => (352 / 15482880 : 𝕂) • (b * b * b * a * a * b * b * a)
  | 80 => (1456 / 15482880 : 𝕂) • (b * b * b * a * b * a * a * a)
  | 81 => (2368 / 15482880 : 𝕂) • (b * b * b * a * b * a * b * a)
  | 82 => (800 / 15482880 : 𝕂) • (b * b * b * a * b * b * a * a)
  | 83 => (1280 / 15482880 : 𝕂) • (b * b * b * a * b * b * b * a)
  | 84 => (-672 / 15482880 : 𝕂) • (b * b * b * b * a * a * a * a)
  | 85 => (-768 / 15482880 : 𝕂) • (b * b * b * b * a * a * b * a)
  | 86 => (-992 / 15482880 : 𝕂) • (b * b * b * b * a * b * a * a)
  | 87 => (-960 / 15482880 : 𝕂) • (b * b * b * b * a * b * b * a)
  | 88 => (352 / 15482880 : 𝕂) • (b * b * b * b * b * a * a * a)
  | 89 => (384 / 15482880 : 𝕂) • (b * b * b * b * b * a * b * a)
  | 90 => (-64 / 15482880 : 𝕂) • (b * b * b * b * b * b * a * a)
  | _ => 0

/-- `Fin 91`-indexed wrapper. -/
private noncomputable def septicD8SecondTerm (a b : 𝔸) (i : Fin 91) : 𝔸 :=
  septicD8SecondTermN (𝕂 := 𝕂) a b i.val

-- The explicit second-half sum equals the Finset.sum form.
set_option maxHeartbeats 16000000 in
set_option maxRecDepth 2000 in
private theorem septicD8Second_explicit_eq_sum (a b : 𝔸) :
    (736 / 15482880 : 𝕂) • (a * b * b * a * a * a * a * b) +
      (784 / 15482880 : 𝕂) • (a * b * b * a * a * a * b * a) +
      (448 / 15482880 : 𝕂) • (a * b * b * a * a * a * b * b) +
      (-392 / 15482880 : 𝕂) • (a * b * b * a * a * b * a * a) +
      ...
      (384 / 15482880 : 𝕂) • (b * b * b * b * b * a * b * a) +
      (-64 / 15482880 : 𝕂) • (b * b * b * b * b * b * a * a) =
      ∑ i : Fin 91, septicD8SecondTerm (𝕂 := 𝕂) a b i := by
  unfold septicD8SecondTerm
  rw [Fin.sum_univ_eq_sum_range (fun k => septicD8SecondTermN (𝕂 := 𝕂) a b k)]
  simp only [Finset.sum_range_succ, Finset.sum_range_zero,
    septicD8SecondTermN, zero_add]

-- Per-index uniform bound: `‖septicD8SecondTerm a b i‖ ≤ (6272/15482880) · s^8`
set_option maxHeartbeats 8000000 in
private lemma septicD8SecondTerm_norm_le (a b : 𝔸) (s : ℝ)
    (ha : ‖a‖ ≤ s) (hb : ‖b‖ ≤ s) (hs : 0 ≤ s) :
    ∀ i : Fin 91, ‖septicD8SecondTerm (𝕂 := 𝕂) a b i‖ ≤ (6272 / 15482880 : ℝ) * s^8 := fun i =>
  match i with
  | ⟨0, _⟩ =>
    show ‖(736 / 15482880 : 𝕂) • (a * b * b * a * a * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (736 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a a a a b s ha hb hb ha ha ha ha hb (by norm_num) hs
  | ⟨1, _⟩ =>
    show ‖(784 / 15482880 : 𝕂) • (a * b * b * a * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (784 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a a a b a s ha hb hb ha ha ha hb ha (by norm_num) hs
  | ⟨2, _⟩ =>
    show ‖(448 / 15482880 : 𝕂) • (a * b * b * a * a * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a a a b b s ha hb hb ha ha ha hb hb (by norm_num) hs
  | ⟨3, _⟩ =>
    show ‖(-392 / 15482880 : 𝕂) • (a * b * b * a * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-392 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a a b a a s ha hb hb ha ha hb ha ha (by norm_num) hs
  | ⟨4, _⟩ =>
    show ‖(112 / 15482880 : 𝕂) • (a * b * b * a * a * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a a b a b s ha hb hb ha ha hb ha hb (by norm_num) hs
  | ⟨5, _⟩ =>
    show ‖(-352 / 15482880 : 𝕂) • (a * b * b * a * a * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a a b b b s ha hb hb ha ha hb hb hb (by norm_num) hs
  | ⟨6, _⟩ =>
    show ‖(1680 / 15482880 : 𝕂) • (a * b * b * a * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1680 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b a a a s ha hb hb ha hb ha ha ha (by norm_num) hs
  | ⟨7, _⟩ =>
    show ‖(2352 / 15482880 : 𝕂) • (a * b * b * a * b * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b a a b s ha hb hb ha hb ha ha hb (by norm_num) hs
  | ⟨8, _⟩ =>
    show ‖(2240 / 15482880 : 𝕂) • (a * b * b * a * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2240 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b a b a s ha hb hb ha hb ha hb ha (by norm_num) hs
  | ⟨9, _⟩ =>
    show ‖(2112 / 15482880 : 𝕂) • (a * b * b * a * b * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b a b b s ha hb hb ha hb ha hb hb (by norm_num) hs
  | ⟨10, _⟩ =>
    show ‖(112 / 15482880 : 𝕂) • (a * b * b * a * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b b a a s ha hb hb ha hb hb ha ha (by norm_num) hs
  | ⟨11, _⟩ =>
    show ‖(1440 / 15482880 : 𝕂) • (a * b * b * a * b * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1440 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b b a b s ha hb hb ha hb hb ha hb (by norm_num) hs
  | ⟨12, _⟩ =>
    show ‖(1120 / 15482880 : 𝕂) • (a * b * b * a * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b b b a s ha hb hb ha hb hb hb ha (by norm_num) hs
  | ⟨13, _⟩ =>
    show ‖(960 / 15482880 : 𝕂) • (a * b * b * a * b * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (960 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b b b b s ha hb hb ha hb hb hb hb (by norm_num) hs
  | ⟨14, _⟩ =>
    show ‖(-700 / 15482880 : 𝕂) • (a * b * b * b * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-700 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a a a a s ha hb hb hb ha ha ha ha (by norm_num) hs
  | ⟨15, _⟩ =>
    show ‖(-1120 / 15482880 : 𝕂) • (a * b * b * b * a * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a a a b s ha hb hb hb ha ha ha hb (by norm_num) hs
  | ⟨16, _⟩ =>
    show ‖(-560 / 15482880 : 𝕂) • (a * b * b * b * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-560 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a a b a s ha hb hb hb ha ha hb ha (by norm_num) hs
  | ⟨17, _⟩ =>
    show ‖(-352 / 15482880 : 𝕂) • (a * b * b * b * a * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a a b b s ha hb hb hb ha ha hb hb (by norm_num) hs
  | ⟨18, _⟩ =>
    show ‖(-1008 / 15482880 : 𝕂) • (a * b * b * b * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1008 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a b a a s ha hb hb hb ha hb ha ha (by norm_num) hs
  | ⟨19, _⟩ =>
    show ‖(-2368 / 15482880 : 𝕂) • (a * b * b * b * a * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2368 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a b a b s ha hb hb hb ha hb ha hb (by norm_num) hs
  | ⟨20, _⟩ =>
    show ‖(-1120 / 15482880 : 𝕂) • (a * b * b * b * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a b b a s ha hb hb hb ha hb hb ha (by norm_num) hs
  | ⟨21, _⟩ =>
    show ‖(-1280 / 15482880 : 𝕂) • (a * b * b * b * a * b * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1280 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a b b b s ha hb hb hb ha hb hb hb (by norm_num) hs
  | ⟨22, _⟩ =>
    show ‖(448 / 15482880 : 𝕂) • (a * b * b * b * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b b a a a s ha hb hb hb hb ha ha ha (by norm_num) hs
  | ⟨23, _⟩ =>
    show ‖(768 / 15482880 : 𝕂) • (a * b * b * b * b * a * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (768 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b b a a b s ha hb hb hb hb ha ha hb (by norm_num) hs
  | ⟨24, _⟩ =>
    show ‖(672 / 15482880 : 𝕂) • (a * b * b * b * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b b a b a s ha hb hb hb hb ha hb ha (by norm_num) hs
  | ⟨25, _⟩ =>
    show ‖(960 / 15482880 : 𝕂) • (a * b * b * b * b * a * b * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (960 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b b a b b s ha hb hb hb hb ha hb hb (by norm_num) hs
  | ⟨26, _⟩ =>
    show ‖(-224 / 15482880 : 𝕂) • (a * b * b * b * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-224 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b b b a a s ha hb hb hb hb hb ha ha (by norm_num) hs
  | ⟨27, _⟩ =>
    show ‖(-384 / 15482880 : 𝕂) • (a * b * b * b * b * b * a * b)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-384 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b b b a b s ha hb hb hb hb hb ha hb (by norm_num) hs
  | ⟨28, _⟩ =>
    show ‖(49 / 15482880 : 𝕂) • (b * a * a * a * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (49 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a a a a a a s hb ha ha ha ha ha ha ha (by norm_num) hs
  | ⟨29, _⟩ =>
    show ‖(408 / 15482880 : 𝕂) • (b * a * a * a * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (408 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a a a a b a s hb ha ha ha ha ha hb ha (by norm_num) hs
  | ⟨30, _⟩ =>
    show ‖(-1020 / 15482880 : 𝕂) • (b * a * a * a * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1020 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a a a b a a s hb ha ha ha ha hb ha ha (by norm_num) hs
  | ⟨31, _⟩ =>
    show ‖(-736 / 15482880 : 𝕂) • (b * a * a * a * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-736 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a a a b b a s hb ha ha ha ha hb hb ha (by norm_num) hs
  | ⟨32, _⟩ =>
    show ‖(1780 / 15482880 : 𝕂) • (b * a * a * a * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1780 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a a b a a a s hb ha ha ha hb ha ha ha (by norm_num) hs
  | ⟨33, _⟩ =>
    show ‖(2624 / 15482880 : 𝕂) • (b * a * a * a * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2624 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a a b a b a s hb ha ha ha hb ha hb ha (by norm_num) hs
  | ⟨34, _⟩ =>
    show ‖(552 / 15482880 : 𝕂) • (b * a * a * a * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (552 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a a b b a a s hb ha ha ha hb hb ha ha (by norm_num) hs
  | ⟨35, _⟩ =>
    show ‖(1120 / 15482880 : 𝕂) • (b * a * a * a * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a a b b b a s hb ha ha ha hb hb hb ha (by norm_num) hs
  | ⟨36, _⟩ =>
    show ‖(-1650 / 15482880 : 𝕂) • (b * a * a * b * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1650 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b a a a a s hb ha ha hb ha ha ha ha (by norm_num) hs
  | ⟨37, _⟩ =>
    show ‖(-2304 / 15482880 : 𝕂) • (b * a * a * b * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2304 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b a a b a s hb ha ha hb ha ha hb ha (by norm_num) hs
  | ⟨38, _⟩ =>
    show ‖(-2192 / 15482880 : 𝕂) • (b * a * a * b * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2192 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b a b a a s hb ha ha hb ha hb ha ha (by norm_num) hs
  | ⟨39, _⟩ =>
    show ‖(-2352 / 15482880 : 𝕂) • (b * a * a * b * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b a b b a s hb ha ha hb ha hb hb ha (by norm_num) hs
  | ⟨40, _⟩ =>
    show ‖(104 / 15482880 : 𝕂) • (b * a * a * b * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (104 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b b a a a s hb ha ha hb hb ha ha ha (by norm_num) hs
  | ⟨41, _⟩ =>
    show ‖(-672 / 15482880 : 𝕂) • (b * a * a * b * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b b a b a s hb ha ha hb hb ha hb ha (by norm_num) hs
  | ⟨42, _⟩ =>
    show ‖(-448 / 15482880 : 𝕂) • (b * a * a * b * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b b b a a s hb ha ha hb hb hb ha ha (by norm_num) hs
  | ⟨43, _⟩ =>
    show ‖(-768 / 15482880 : 𝕂) • (b * a * a * b * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-768 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b b b b a s hb ha ha hb hb hb hb ha (by norm_num) hs
  | ⟨44, _⟩ =>
    show ‖(1038 / 15482880 : 𝕂) • (b * a * b * a * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1038 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a a a a a s hb ha hb ha ha ha ha ha (by norm_num) hs
  | ⟨45, _⟩ =>
    show ‖(2624 / 15482880 : 𝕂) • (b * a * b * a * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2624 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a a a b a s hb ha hb ha ha ha hb ha (by norm_num) hs
  | ⟨46, _⟩ =>
    show ‖(-1072 / 15482880 : 𝕂) • (b * a * b * a * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1072 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a a b a a s hb ha hb ha ha hb ha ha (by norm_num) hs
  | ⟨47, _⟩ =>
    show ‖(-112 / 15482880 : 𝕂) • (b * a * b * a * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a a b b a s hb ha hb ha ha hb hb ha (by norm_num) hs
  | ⟨48, _⟩ =>
    show ‖(2848 / 15482880 : 𝕂) • (b * a * b * a * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2848 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a b a a a s hb ha hb ha hb ha ha ha (by norm_num) hs
  | ⟨49, _⟩ =>
    show ‖(6272 / 15482880 : 𝕂) • (b * a * b * a * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (6272 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a b a b a s hb ha hb ha hb ha hb ha (by norm_num) hs
  | ⟨50, _⟩ =>
    show ‖(448 / 15482880 : 𝕂) • (b * a * b * a * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a b b a a s hb ha hb ha hb hb ha ha (by norm_num) hs
  | ⟨51, _⟩ =>
    show ‖(2368 / 15482880 : 𝕂) • (b * a * b * a * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2368 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a b b b a s hb ha hb ha hb hb hb ha (by norm_num) hs
  | ⟨52, _⟩ =>
    show ‖(-708 / 15482880 : 𝕂) • (b * a * b * b * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-708 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b a a a a s hb ha hb hb ha ha ha ha (by norm_num) hs
  | ⟨53, _⟩ =>
    show ‖(-672 / 15482880 : 𝕂) • (b * a * b * b * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b a a b a s hb ha hb hb ha ha hb ha (by norm_num) hs
  | ⟨54, _⟩ =>
    show ‖(-1792 / 15482880 : 𝕂) • (b * a * b * b * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1792 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b a b a a s hb ha hb hb ha hb ha ha (by norm_num) hs
  | ⟨55, _⟩ =>
    show ‖(-1440 / 15482880 : 𝕂) • (b * a * b * b * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1440 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b a b b a s hb ha hb hb ha hb hb ha (by norm_num) hs
  | ⟨56, _⟩ =>
    show ‖(896 / 15482880 : 𝕂) • (b * a * b * b * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (896 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b b a a a s hb ha hb hb hb ha ha ha (by norm_num) hs
  | ⟨57, _⟩ =>
    show ‖(1920 / 15482880 : 𝕂) • (b * a * b * b * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1920 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b b a b a s hb ha hb hb hb ha hb ha (by norm_num) hs
  | ⟨58, _⟩ =>
    show ‖(-320 / 15482880 : 𝕂) • (b * a * b * b * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-320 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b b b a a s hb ha hb hb hb hb ha ha (by norm_num) hs
  | ⟨59, _⟩ =>
    show ‖(384 / 15482880 : 𝕂) • (b * a * b * b * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (384 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b b b b a s hb ha hb hb hb hb hb ha (by norm_num) hs
  | ⟨60, _⟩ =>
    show ‖(-278 / 15482880 : 𝕂) • (b * b * a * a * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-278 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a a a a a s hb hb ha ha ha ha ha ha (by norm_num) hs
  | ⟨61, _⟩ =>
    show ‖(-736 / 15482880 : 𝕂) • (b * b * a * a * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-736 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a a a b a s hb hb ha ha ha ha hb ha (by norm_num) hs
  | ⟨62, _⟩ =>
    show ‖(-232 / 15482880 : 𝕂) • (b * b * a * a * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-232 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a a b a a s hb hb ha ha ha hb ha ha (by norm_num) hs
  | ⟨63, _⟩ =>
    show ‖(-448 / 15482880 : 𝕂) • (b * b * a * a * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-448 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a a b b a s hb hb ha ha ha hb hb ha (by norm_num) hs
  | ⟨64, _⟩ =>
    show ‖(720 / 15482880 : 𝕂) • (b * b * a * a * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (720 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a b a a a s hb hb ha ha hb ha ha ha (by norm_num) hs
  | ⟨65, _⟩ =>
    show ‖(-112 / 15482880 : 𝕂) • (b * b * a * a * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a b a b a s hb hb ha ha hb ha hb ha (by norm_num) hs
  | ⟨66, _⟩ =>
    show ‖(784 / 15482880 : 𝕂) • (b * b * a * a * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (784 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a b b a a s hb hb ha ha hb hb ha ha (by norm_num) hs
  | ⟨67, _⟩ =>
    show ‖(352 / 15482880 : 𝕂) • (b * b * a * a * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a b b b a s hb hb ha ha hb hb hb ha (by norm_num) hs
  | ⟨68, _⟩ =>
    show ‖(-1492 / 15482880 : 𝕂) • (b * b * a * b * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1492 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b a a a a s hb hb ha hb ha ha ha ha (by norm_num) hs
  | ⟨69, _⟩ =>
    show ‖(-2352 / 15482880 : 𝕂) • (b * b * a * b * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b a a b a s hb hb ha hb ha ha hb ha (by norm_num) hs
  | ⟨70, _⟩ =>
    show ‖(-1792 / 15482880 : 𝕂) • (b * b * a * b * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1792 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b a b a a s hb hb ha hb ha hb ha ha (by norm_num) hs
  | ⟨71, _⟩ =>
    show ‖(-2112 / 15482880 : 𝕂) • (b * b * a * b * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-2112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b a b b a s hb hb ha hb ha hb hb ha (by norm_num) hs
  | ⟨72, _⟩ =>
    show ‖(-112 / 15482880 : 𝕂) • (b * b * a * b * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b b a a a s hb hb ha hb hb ha ha ha (by norm_num) hs
  | ⟨73, _⟩ =>
    show ‖(-1440 / 15482880 : 𝕂) • (b * b * a * b * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-1440 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b b a b a s hb hb ha hb hb ha hb ha (by norm_num) hs
  | ⟨74, _⟩ =>
    show ‖(-320 / 15482880 : 𝕂) • (b * b * a * b * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-320 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b b b a a s hb hb ha hb hb hb ha ha (by norm_num) hs
  | ⟨75, _⟩ =>
    show ‖(-960 / 15482880 : 𝕂) • (b * b * a * b * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-960 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b b b b a s hb hb ha hb hb hb hb ha (by norm_num) hs
  | ⟨76, _⟩ =>
    show ‖(580 / 15482880 : 𝕂) • (b * b * b * a * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (580 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a a a a a s hb hb hb ha ha ha ha ha (by norm_num) hs
  | ⟨77, _⟩ =>
    show ‖(1120 / 15482880 : 𝕂) • (b * b * b * a * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1120 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a a a b a s hb hb hb ha ha ha hb ha (by norm_num) hs
  | ⟨78, _⟩ =>
    show ‖(112 / 15482880 : 𝕂) • (b * b * b * a * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (112 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a a b a a s hb hb hb ha ha hb ha ha (by norm_num) hs
  | ⟨79, _⟩ =>
    show ‖(352 / 15482880 : 𝕂) • (b * b * b * a * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a a b b a s hb hb hb ha ha hb hb ha (by norm_num) hs
  | ⟨80, _⟩ =>
    show ‖(1456 / 15482880 : 𝕂) • (b * b * b * a * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1456 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a b a a a s hb hb hb ha hb ha ha ha (by norm_num) hs
  | ⟨81, _⟩ =>
    show ‖(2368 / 15482880 : 𝕂) • (b * b * b * a * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (2368 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a b a b a s hb hb hb ha hb ha hb ha (by norm_num) hs
  | ⟨82, _⟩ =>
    show ‖(800 / 15482880 : 𝕂) • (b * b * b * a * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (800 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a b b a a s hb hb hb ha hb hb ha ha (by norm_num) hs
  | ⟨83, _⟩ =>
    show ‖(1280 / 15482880 : 𝕂) • (b * b * b * a * b * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (1280 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a b b b a s hb hb hb ha hb hb hb ha (by norm_num) hs
  | ⟨84, _⟩ =>
    show ‖(-672 / 15482880 : 𝕂) • (b * b * b * b * a * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-672 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b b a a a a s hb hb hb hb ha ha ha ha (by norm_num) hs
  | ⟨85, _⟩ =>
    show ‖(-768 / 15482880 : 𝕂) • (b * b * b * b * a * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-768 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b b a a b a s hb hb hb hb ha ha hb ha (by norm_num) hs
  | ⟨86, _⟩ =>
    show ‖(-992 / 15482880 : 𝕂) • (b * b * b * b * a * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-992 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b b a b a a s hb hb hb hb ha hb ha ha (by norm_num) hs
  | ⟨87, _⟩ =>
    show ‖(-960 / 15482880 : 𝕂) • (b * b * b * b * a * b * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-960 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b b a b b a s hb hb hb hb ha hb hb ha (by norm_num) hs
  | ⟨88, _⟩ =>
    show ‖(352 / 15482880 : 𝕂) • (b * b * b * b * b * a * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (352 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b b b a a a s hb hb hb hb hb ha ha ha (by norm_num) hs
  | ⟨89, _⟩ =>
    show ‖(384 / 15482880 : 𝕂) • (b * b * b * b * b * a * b * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (384 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b b b a b a s hb hb hb hb hb ha hb ha (by norm_num) hs
  | ⟨90, _⟩ =>
    show ‖(-64 / 15482880 : 𝕂) • (b * b * b * b * b * b * a * a)‖ ≤ (6272 / 15482880 : ℝ) * s^8 from
      deg8_smul_word_le (-64 / 15482880 : 𝕂) (6272 / 15482880 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
...
set_option maxHeartbeats 1600000 in
-- Norm bound on the second half (Finset.sum form).
private theorem norm_septicD8SecondSum_le (a b : 𝔸) :
    ‖∑ i : Fin 91, septicD8SecondTerm (𝕂 := 𝕂) a b i‖ ≤ (91 * 6272 / 15482880 : ℝ) * (‖a‖ + ‖b‖) ^ 8 := by
  set s := ‖a‖ + ‖b‖ with hs_def
  have hs_nn : 0 ≤ s := by positivity
  have ha_le : ‖a‖ ≤ s := by linarith [norm_nonneg b]
  have hb_le : ‖b‖ ≤ s := by linarith [norm_nonneg a]
  calc ‖∑ i : Fin 91, septicD8SecondTerm (𝕂 := 𝕂) a b i‖
      ≤ ∑ i : Fin 91, ‖septicD8SecondTerm (𝕂 := 𝕂) a b i‖ := norm_sum_le _ _
    _ ≤ ∑ _i : Fin 91, (6272 / 15482880 : ℝ) * s^8 :=
        Finset.sum_le_sum (fun i _ => septicD8SecondTerm_norm_le (𝕂 := 𝕂) a b s ha_le hb_le hs_nn i)
    _ = 91 * ((6272 / 15482880 : ℝ) * s^8) := by
        rw [Finset.sum_const, Finset.card_univ, Fintype.card_fin]; ring
    _ = (91 * 6272 / 15482880 : ℝ) * s^8 := by ring

-- The full 182-term def equals the sum of the two halves' explicit forms.
-- Reassociation of a 182-term `+`-tree via `abel` (handles add_assoc/comm).
set_option maxHeartbeats 64000000 in
private theorem septic_d8_perturbation_poly_split (a b : 𝔸) :
    septic_d8_perturbation_poly 𝕂 a b =
      ((-49 / 15482880 : 𝕂) • (a * a * a * a * a * a * a * b) +
        (343 / 15482880 : 𝕂) • (a * a * a * a * a * a * b * a) +
        (278 / 15482880 : 𝕂) • (a * a * a * a * a * a * b * b) +
      ...
      ((736 / 15482880 : 𝕂) • (a * b * b * a * a * a * a * b) +
        ...
        (352 / 15482880 : 𝕂) • (b * b * b * b * b * a * a * a) +
        (384 / 15482880 : 𝕂) • (b * b * b * b * b * a * b * a) +
        (-64 / 15482880 : 𝕂) • (b * b * b * b * b * b * a * a)) := by
  unfold septic_d8_perturbation_poly
  abel

/-- **Norm bound for `septic_d8_perturbation_poly`**:
`‖septic_d8_perturbation(a, b)‖ ≤ (‖a‖+‖b‖)⁸`.

Uses the **split-half** approach: ‖poly‖ ≤ ‖first‖ + ‖second‖ ≤
2·91·6272/15482880·s⁸ = 1141504/15482880·s⁸ ≈ 0.0737·s⁸ ≤ s⁸.
Actual Σ|num|/15482880 ≈ 0.0126.

Companion to `norm_septic_d7_perturbation_poly_le` at one degree higher.
By `septic_d8_cancellation_poly_form`,
`d8_perturbation = -(C₈(½a,b) + ½·[C₇(½a,b), ½a] + C₈(½a+b, ½a))`. -/
theorem norm_septic_d8_perturbation_poly_le (a b : 𝔸) :
    ‖septic_d8_perturbation_poly 𝕂 a b‖ ≤ (‖a‖ + ‖b‖) ^ 8 := by
  set s := ‖a‖ + ‖b‖ with hs_def
  have hs_nn : 0 ≤ s := by positivity
  have hs8_nn : 0 ≤ s ^ 8 := pow_nonneg hs_nn 8
  rw [septic_d8_perturbation_poly_split,
      septicD8First_explicit_eq_sum,
      septicD8Second_explicit_eq_sum]
  calc ‖(∑ i : Fin 91, septicD8FirstTerm (𝕂 := 𝕂) a b i) + (∑ i : Fin 91, septicD8SecondTerm (𝕂 := 𝕂) a b i)‖
      ≤ ‖∑ i : Fin 91, septicD8FirstTerm (𝕂 := 𝕂) a b i‖ +
          ‖∑ i : Fin 91, septicD8SecondTerm (𝕂 := 𝕂) a b i‖ := norm_add_le _ _
    _ ≤ (91 * 6272 / 15482880 : ℝ) * s^8 +
          (91 * 6272 / 15482880 : ℝ) * s^8 :=
        add_le_add (norm_septicD8FirstSum_le a b) (norm_septicD8SecondSum_le a b)
...
/-! ## 6-piece operator-form decomposition of septic_d7_perturbation_poly

From CAS verification (`scripts/verify_d7_operator_decomp.py`):

    septic_d7_perturbation_poly
      = septic_d7_P2_poly + septic_d7_P3_poly + septic_d7_P4_poly
        + septic_d7_P5_poly + septic_d7_cross_V2_V3_poly + septic_d7_cross_V2_V4_poly

Each piece corresponds to a specific operator-form perturbation:
  • P_j := (bch(x + V_j, ½a) − bch(x, ½a))_deg7  (single-V_j perturbation).
  • Cross(V_j, V_k) := (bch(x+V_j+V_k, ½a) − bch(x+V_j, ½a)
                       − bch(x+V_k, ½a) + bch(x, ½a))_deg7  (mixed cross).

Foundation for the Phase B-septic operator-form identity (eventual O(s⁹)
joint bound replacing the current O(s⁷) per-piece bound on
septic_d7_perturbation_poly via Lipschitz bounds on each operator form).
-/

/-- **septic_d7_P2_poly**: V_2-only deg-7 perturbation piece (P_2). Captures contributions from linear-in-V_2 in C_6, quadratic-in-V_2 in C_5, cubic-in-V_2 in C_4, and quartic-in-V_2 in C_3.

CAS-derived; denominator 92160, 96 terms,
Σ|num|/LCM = 2552/92160 ≈ 0.0277. -/
noncomputable def septic_d7_P2_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-3 / 92160 : 𝕂) • (a * a * a * a * a * a * b)
  + (18 / 92160 : 𝕂) • (a * a * a * a * a * b * a)
  + (12 / 92160 : 𝕂) • (a * a * a * a * a * b * b)
  + (-45 / 92160 : 𝕂) • (a * a * a * a * b * a * a)
  + (-40 / 92160 : 𝕂) • (a * a * a * a * b * a * b)
  + (-20 / 92160 : 𝕂) • (a * a * a * a * b * b * a)
  + (-14 / 92160 : 𝕂) • (a * a * a * a * b * b * b)
  + (60 / 92160 : 𝕂) • (a * a * a * b * a * a * a)
  + (57 / 92160 : 𝕂) • (a * a * a * b * a * a * b)
  + (46 / 92160 : 𝕂) • (a * a * a * b * a * b * a)
  + (40 / 92160 : 𝕂) • (a * a * a * b * a * b * b)
  + (17 / 92160 : 𝕂) • (a * a * a * b * b * a * a)
  + (6 / 92160 : 𝕂) • (a * a * a * b * b * a * b)
  + (10 / 92160 : 𝕂) • (a * a * a * b * b * b * a)
  + (4 / 92160 : 𝕂) • (a * a * a * b * b * b * b)
  + (-45 / 92160 : 𝕂) • (a * a * b * a * a * a * a)
  + (-68 / 92160 : 𝕂) • (a * a * b * a * a * a * b)
  + (33 / 92160 : 𝕂) • (a * a * b * a * a * b * a)
  + (-24 / 92160 : 𝕂) • (a * a * b * a * a * b * b)
  + (-102 / 92160 : 𝕂) • (a * a * b * a * b * a * a)
  + (-56 / 92160 : 𝕂) • (a * a * b * a * b * a * b)
  + (-16 / 92160 : 𝕂) • (a * a * b * a * b * b * a)
  + (-20 / 92160 : 𝕂) • (a * a * b * a * b * b * b)
  + (17 / 92160 : 𝕂) • (a * a * b * b * a * a * a)
  + (2 / 92160 : 𝕂) • (a * a * b * b * a * a * b)
  + (34 / 92160 : 𝕂) • (a * a * b * b * a * b * a)
  + (24 / 92160 : 𝕂) • (a * a * b * b * a * b * b)
  + (-24 / 92160 : 𝕂) • (a * a * b * b * b * a * a)
  + (-16 / 92160 : 𝕂) • (a * a * b * b * b * a * b)
  + (18 / 92160 : 𝕂) • (a * b * a * a * a * a * a)
  + (45 / 92160 : 𝕂) • (a * b * a * a * a * a * b)
  + (-44 / 92160 : 𝕂) • (a * b * a * a * a * b * a)
  + (10 / 92160 : 𝕂) • (a * b * a * a * a * b * b)
  + (33 / 92160 : 𝕂) • (a * b * a * a * b * a * a)
  + (44 / 92160 : 𝕂) • (a * b * a * a * b * a * b)
  + (-26 / 92160 : 𝕂) • (a * b * a * a * b * b * a)
  + (20 / 92160 : 𝕂) • (a * b * a * a * b * b * b)
  + (46 / 92160 : 𝕂) • (a * b * a * b * a * a * a)
  + (4 / 92160 : 𝕂) • (a * b * a * b * a * a * b)
  + (16 / 92160 : 𝕂) • (a * b * a * b * a * b * a)
  + (-28 / 92160 : 𝕂) • (a * b * a * b * a * b * b)
  + (34 / 92160 : 𝕂) • (a * b * a * b * b * a * a)
  + (16 / 92160 : 𝕂) • (a * b * a * b * b * a * b)
  + (12 / 92160 : 𝕂) • (a * b * a * b * b * b * a)
  + (-20 / 92160 : 𝕂) • (a * b * b * a * a * a * a)
  + (6 / 92160 : 𝕂) • (a * b * b * a * a * a * b)
  + (-26 / 92160 : 𝕂) • (a * b * b * a * a * b * a)
  + (4 / 92160 : 𝕂) • (a * b * b * a * a * b * b)
  + (-16 / 92160 : 𝕂) • (a * b * b * a * b * a * a)
  + (-4 / 92160 : 𝕂) • (a * b * b * a * b * a * b)
  + (-24 / 92160 : 𝕂) • (a * b * b * a * b * b * a)
  + (10 / 92160 : 𝕂) • (a * b * b * b * a * a * a)
  + (4 / 92160 : 𝕂) • (a * b * b * b * a * a * b)
  + (12 / 92160 : 𝕂) • (a * b * b * b * a * b * a)
  + (-3 / 92160 : 𝕂) • (b * a * a * a * a * a * a)
  + (-18 / 92160 : 𝕂) • (b * a * a * a * a * a * b)
  + (45 / 92160 : 𝕂) • (b * a * a * a * a * b * a)
  + (16 / 92160 : 𝕂) • (b * a * a * a * a * b * b)
  + (-68 / 92160 : 𝕂) • (b * a * a * a * b * a * a)
  + (-80 / 92160 : 𝕂) • (b * a * a * a * b * a * b)
  + (6 / 92160 : 𝕂) • (b * a * a * a * b * b * a)
  + (-16 / 92160 : 𝕂) • (b * a * a * a * b * b * b)
  + (57 / 92160 : 𝕂) • (b * a * a * b * a * a * a)
  + (96 / 92160 : 𝕂) • (b * a * a * b * a * a * b)
  + (4 / 92160 : 𝕂) • (b * a * a * b * a * b * a)
  + (40 / 92160 : 𝕂) • (b * a * a * b * a * b * b)
  + (2 / 92160 : 𝕂) • (b * a * a * b * b * a * a)
  + (-16 / 92160 : 𝕂) • (b * a * a * b * b * a * b)
  + (4 / 92160 : 𝕂) • (b * a * a * b * b * b * a)
  + (-40 / 92160 : 𝕂) • (b * a * b * a * a * a * a)
  + (-80 / 92160 : 𝕂) • (b * a * b * a * a * a * b)
  + (44 / 92160 : 𝕂) • (b * a * b * a * a * b * a)
  + (-40 / 92160 : 𝕂) • (b * a * b * a * a * b * b)
  + (-56 / 92160 : 𝕂) • (b * a * b * a * b * a * a)
  + (32 / 92160 : 𝕂) • (b * a * b * a * b * a * b)
  + (-4 / 92160 : 𝕂) • (b * a * b * a * b * b * a)
  + (6 / 92160 : 𝕂) • (b * a * b * b * a * a * a)
  + (-16 / 92160 : 𝕂) • (b * a * b * b * a * a * b)
  + (16 / 92160 : 𝕂) • (b * a * b * b * a * b * a)
  + (-16 / 92160 : 𝕂) • (b * a * b * b * b * a * a)
  + (12 / 92160 : 𝕂) • (b * b * a * a * a * a * a)
  + (16 / 92160 : 𝕂) • (b * b * a * a * a * a * b)
  + (10 / 92160 : 𝕂) • (b * b * a * a * a * b * a)
  + (24 / 92160 : 𝕂) • (b * b * a * a * a * b * b)
  + (-24 / 92160 : 𝕂) • (b * b * a * a * b * a * a)
  + (-40 / 92160 : 𝕂) • (b * b * a * a * b * a * b)
  + (4 / 92160 : 𝕂) • (b * b * a * a * b * b * a)
  + (40 / 92160 : 𝕂) • (b * b * a * b * a * a * a)
  + (40 / 92160 : 𝕂) • (b * b * a * b * a * a * b)
  + (-28 / 92160 : 𝕂) • (b * b * a * b * a * b * a)
  + (24 / 92160 : 𝕂) • (b * b * a * b * b * a * a)
  + (-14 / 92160 : 𝕂) • (b * b * b * a * a * a * a)
  + (-16 / 92160 : 𝕂) • (b * b * b * a * a * a * b)
  + (20 / 92160 : 𝕂) • (b * b * b * a * a * b * a)
  + (-20 / 92160 : 𝕂) • (b * b * b * a * b * a * a)
  + (4 / 92160 : 𝕂) • (b * b * b * b * a * a * a)

/-- **septic_d7_P3_poly**: V_3-only deg-7 perturbation piece (P_3). Captures linear-in-V_3 in C_5 and quadratic-in-V_3 in C_3.

CAS-derived; denominator 276480, 108 terms,
Σ|num|/LCM = 7808/276480 ≈ 0.0282. -/
noncomputable def septic_d7_P3_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-7 / 276480 : 𝕂) • (a * a * a * a * a * b * b)
  + (37 / 276480 : 𝕂) • (a * a * a * a * b * a * b)
  + (-2 / 276480 : 𝕂) • (a * a * a * a * b * b * a)
  + (-82 / 276480 : 𝕂) • (a * a * a * b * a * a * b)
  + (16 / 276480 : 𝕂) • (a * a * a * b * a * b * a)
  + (-30 / 276480 : 𝕂) • (a * a * a * b * a * b * b)
  + (-4 / 276480 : 𝕂) • (a * a * a * b * b * a * a)
  + (34 / 276480 : 𝕂) • (a * a * a * b * b * a * b)
  + (-4 / 276480 : 𝕂) • (a * a * a * b * b * b * a)
  + (24 / 276480 : 𝕂) • (a * a * a * b * b * b * b)
  + (98 / 276480 : 𝕂) • (a * a * b * a * a * a * b)
  + (-48 / 276480 : 𝕂) • (a * a * b * a * a * b * a)
  + (70 / 276480 : 𝕂) • (a * a * b * a * a * b * b)
  + (24 / 276480 : 𝕂) • (a * a * b * a * b * a * a)
  + (-56 / 276480 : 𝕂) • (a * a * b * a * b * a * b)
  + (6 / 276480 : 𝕂) • (a * a * b * a * b * b * a)
  + (-4 / 276480 : 𝕂) • (a * a * b * a * b * b * b)
  + (-4 / 276480 : 𝕂) • (a * a * b * b * a * a * a)
  + (14 / 276480 : 𝕂) • (a * a * b * b * a * a * b)
  + (-74 / 276480 : 𝕂) • (a * a * b * b * a * b * a)
  + (-56 / 276480 : 𝕂) • (a * a * b * b * a * b * b)
  + (40 / 276480 : 𝕂) • (a * a * b * b * b * a * a)
  + (-64 / 276480 : 𝕂) • (a * a * b * b * b * a * b)
  + (52 / 276480 : 𝕂) • (a * a * b * b * b * b * a)
  + (-8 / 276480 : 𝕂) • (a * a * b * b * b * b * b)
  + (-65 / 276480 : 𝕂) • (a * b * a * a * a * a * b)
  + (64 / 276480 : 𝕂) • (a * b * a * a * a * b * a)
  + (-24 / 276480 : 𝕂) • (a * b * a * a * a * b * b)
  + (-48 / 276480 : 𝕂) • (a * b * a * a * b * a * a)
  + (-80 / 276480 : 𝕂) • (a * b * a * a * b * a * b)
  + (12 / 276480 : 𝕂) • (a * b * a * a * b * b * a)
  + (-92 / 276480 : 𝕂) • (a * b * a * a * b * b * b)
  + (16 / 276480 : 𝕂) • (a * b * a * b * a * a * a)
  + (80 / 276480 : 𝕂) • (a * b * a * b * a * a * b)
  + (112 / 276480 : 𝕂) • (a * b * a * b * a * b * a)
  + (172 / 276480 : 𝕂) • (a * b * a * b * a * b * b)
  + (-74 / 276480 : 𝕂) • (a * b * a * b * b * a * a)
  + (112 / 276480 : 𝕂) • (a * b * a * b * b * a * b)
  + (-92 / 276480 : 𝕂) • (a * b * a * b * b * b * a)
  + (8 / 276480 : 𝕂) • (a * b * a * b * b * b * b)
  + (-2 / 276480 : 𝕂) • (a * b * b * a * a * a * a)
  + (-40 / 276480 : 𝕂) • (a * b * b * a * a * a * b)
  + (12 / 276480 : 𝕂) • (a * b * b * a * a * b * a)
  + (-124 / 276480 : 𝕂) • (a * b * b * a * a * b * b)
  + (6 / 276480 : 𝕂) • (a * b * b * a * b * a * a)
  + (212 / 276480 : 𝕂) • (a * b * b * a * b * a * b)
  + (-24 / 276480 : 𝕂) • (a * b * b * a * b * b * a)
  + (32 / 276480 : 𝕂) • (a * b * b * a * b * b * b)
  + (-4 / 276480 : 𝕂) • (a * b * b * b * a * a * a)
  + (-52 / 276480 : 𝕂) • (a * b * b * b * a * a * b)
  + (-92 / 276480 : 𝕂) • (a * b * b * b * a * b * a)
  + (-48 / 276480 : 𝕂) • (a * b * b * b * a * b * b)
  + (52 / 276480 : 𝕂) • (a * b * b * b * b * a * a)
  + (40 / 276480 : 𝕂) • (a * b * b * b * b * a * b)
  + (-16 / 276480 : 𝕂) • (a * b * b * b * b * b * a)
  + (26 / 276480 : 𝕂) • (b * a * a * a * a * a * b)
  + (-65 / 276480 : 𝕂) • (b * a * a * a * a * b * a)
  + (-16 / 276480 : 𝕂) • (b * a * a * a * a * b * b)
  + (98 / 276480 : 𝕂) • (b * a * a * a * b * a * a)
  + (128 / 276480 : 𝕂) • (b * a * a * a * b * a * b)
  + (-40 / 276480 : 𝕂) • (b * a * a * a * b * b * a)
  + (-82 / 276480 : 𝕂) • (b * a * a * b * a * a * a)
  + (-192 / 276480 : 𝕂) • (b * a * a * b * a * a * b)
  + (80 / 276480 : 𝕂) • (b * a * a * b * a * b * a)
  + (-48 / 276480 : 𝕂) • (b * a * a * b * a * b * b)
  + (14 / 276480 : 𝕂) • (b * a * a * b * b * a * a)
  + (192 / 276480 : 𝕂) • (b * a * a * b * b * a * b)
  + (-52 / 276480 : 𝕂) • (b * a * a * b * b * b * a)
  + (32 / 276480 : 𝕂) • (b * a * a * b * b * b * b)
  + (37 / 276480 : 𝕂) • (b * a * b * a * a * a * a)
  + (128 / 276480 : 𝕂) • (b * a * b * a * a * a * b)
  + (-80 / 276480 : 𝕂) • (b * a * b * a * a * b * a)
  + (352 / 276480 : 𝕂) • (b * a * b * a * a * b * b)
  + (-56 / 276480 : 𝕂) • (b * a * b * a * b * a * a)
  + (-992 / 276480 : 𝕂) • (b * a * b * a * b * a * b)
  + (212 / 276480 : 𝕂) • (b * a * b * a * b * b * a)
  + (-96 / 276480 : 𝕂) • (b * a * b * a * b * b * b)
  + (34 / 276480 : 𝕂) • (b * a * b * b * a * a * a)
  + (192 / 276480 : 𝕂) • (b * a * b * b * a * a * b)
  + (112 / 276480 : 𝕂) • (b * a * b * b * a * b * a)
  + (48 / 276480 : 𝕂) • (b * a * b * b * a * b * b)
  + (-64 / 276480 : 𝕂) • (b * a * b * b * b * a * a)
  + (-64 / 276480 : 𝕂) • (b * a * b * b * b * a * b)
  + (40 / 276480 : 𝕂) • (b * a * b * b * b * b * a)
  + (-7 / 276480 : 𝕂) • (b * b * a * a * a * a * a)
  + (-16 / 276480 : 𝕂) • (b * b * a * a * a * a * b)
  + (-24 / 276480 : 𝕂) • (b * b * a * a * a * b * a)
  + (-152 / 276480 : 𝕂) • (b * b * a * a * a * b * b)
  + (70 / 276480 : 𝕂) • (b * b * a * a * b * a * a)
  + (352 / 276480 : 𝕂) • (b * b * a * a * b * a * b)
  + (-124 / 276480 : 𝕂) • (b * b * a * a * b * b * a)
  + (-16 / 276480 : 𝕂) • (b * b * a * a * b * b * b)
  + (-30 / 276480 : 𝕂) • (b * b * a * b * a * a * a)
  + (-48 / 276480 : 𝕂) • (b * b * a * b * a * a * b)
  + (172 / 276480 : 𝕂) • (b * b * a * b * a * b * a)
  + (96 / 276480 : 𝕂) • (b * b * a * b * a * b * b)
  + (-56 / 276480 : 𝕂) • (b * b * a * b * b * a * a)
...
/-- **septic_d7_P4_poly**: V_4-only deg-7 perturbation piece (P_4). Captures only linear-in-V_4 in C_4 (higher-order V_4 contributions exceed deg 7).

CAS-derived; denominator 18432, 35 terms,
Σ|num|/LCM = 172/18432 ≈ 0.0093. -/
noncomputable def septic_d7_P4_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (1 / 18432 : 𝕂) • (a * a * a * a * a * b * b)
  + (-2 / 18432 : 𝕂) • (a * a * a * a * b * a * b)
  + (-3 / 18432 : 𝕂) • (a * a * a * a * b * b * a)
  + (-2 / 18432 : 𝕂) • (a * a * a * a * b * b * b)
  + (8 / 18432 : 𝕂) • (a * a * a * b * a * b * a)
  + (4 / 18432 : 𝕂) • (a * a * a * b * a * b * b)
  + (2 / 18432 : 𝕂) • (a * a * a * b * b * a * a)
  + (4 / 18432 : 𝕂) • (a * a * a * b * b * a * b)
  + (-2 / 18432 : 𝕂) • (a * a * b * a * a * b * b)
  + (-12 / 18432 : 𝕂) • (a * a * b * a * b * a * a)
  + (-8 / 18432 : 𝕂) • (a * a * b * a * b * a * b)
  + (2 / 18432 : 𝕂) • (a * a * b * b * a * a * a)
  + (2 / 18432 : 𝕂) • (a * a * b * b * a * a * b)
  + (-8 / 18432 : 𝕂) • (a * a * b * b * a * b * a)
  + (4 / 18432 : 𝕂) • (a * a * b * b * b * a * a)
  + (4 / 18432 : 𝕂) • (a * b * a * a * a * b * b)
  + (-8 / 18432 : 𝕂) • (a * b * a * a * b * a * b)
  + (8 / 18432 : 𝕂) • (a * b * a * b * a * a * a)
  + (8 / 18432 : 𝕂) • (a * b * a * b * a * a * b)
  + (16 / 18432 : 𝕂) • (a * b * a * b * a * b * a)
  + (-8 / 18432 : 𝕂) • (a * b * a * b * b * a * a)
  + (-3 / 18432 : 𝕂) • (a * b * b * a * a * a * a)
  + (-4 / 18432 : 𝕂) • (a * b * b * a * a * a * b)
  + (-4 / 18432 : 𝕂) • (b * a * a * a * b * b * a)
  + (8 / 18432 : 𝕂) • (b * a * a * b * a * b * a)
  + (2 / 18432 : 𝕂) • (b * a * a * b * b * a * a)
  + (-2 / 18432 : 𝕂) • (b * a * b * a * a * a * a)
  + (-8 / 18432 : 𝕂) • (b * a * b * a * a * b * a)
  + (-8 / 18432 : 𝕂) • (b * a * b * a * b * a * a)
  + (4 / 18432 : 𝕂) • (b * a * b * b * a * a * a)
  + (1 / 18432 : 𝕂) • (b * b * a * a * a * a * a)
  + (4 / 18432 : 𝕂) • (b * b * a * a * a * b * a)
  + (-2 / 18432 : 𝕂) • (b * b * a * a * b * a * a)
  + (4 / 18432 : 𝕂) • (b * b * a * b * a * a * a)
  + (-2 / 18432 : 𝕂) • (b * b * b * a * a * a * a)

/-- **septic_d7_P5_poly**: V_5-only deg-7 perturbation piece (P_5). Captures only linear-in-V_5 in C_3 (higher-order V_5 contributions exceed deg 7).

CAS-derived; denominator 276480, 100 terms,
Σ|num|/LCM = 3440/276480 ≈ 0.0124. -/
noncomputable def septic_d7_P5_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-1 / 276480 : 𝕂) • (a * a * a * a * a * b * b)
  + (6 / 276480 : 𝕂) • (a * a * a * a * b * a * b)
  + (-1 / 276480 : 𝕂) • (a * a * a * a * b * b * a)
  + (8 / 276480 : 𝕂) • (a * a * a * a * b * b * b)
  + (-14 / 276480 : 𝕂) • (a * a * a * b * a * a * b)
  + (4 / 276480 : 𝕂) • (a * a * a * b * a * b * a)
  + (-12 / 276480 : 𝕂) • (a * a * a * b * a * b * b)
  + (-28 / 276480 : 𝕂) • (a * a * a * b * b * a * b)
  + (8 / 276480 : 𝕂) • (a * a * a * b * b * b * a)
  + (16 / 276480 : 𝕂) • (a * a * a * b * b * b * b)
  + (16 / 276480 : 𝕂) • (a * a * b * a * a * a * b)
  + (-6 / 276480 : 𝕂) • (a * a * b * a * a * b * a)
  + (-12 / 276480 : 𝕂) • (a * a * b * a * a * b * b)
  + (72 / 276480 : 𝕂) • (a * a * b * a * b * a * b)
  + (-12 / 276480 : 𝕂) • (a * a * b * a * b * b * a)
  + (-24 / 276480 : 𝕂) • (a * a * b * a * b * b * b)
  + (12 / 276480 : 𝕂) • (a * a * b * b * a * a * b)
  + (-12 / 276480 : 𝕂) • (a * a * b * b * a * b * a)
  + (-24 / 276480 : 𝕂) • (a * a * b * b * a * b * b)
  + (-16 / 276480 : 𝕂) • (a * a * b * b * b * a * b)
  + (16 / 276480 : 𝕂) • (a * a * b * b * b * b * a)
  + (-8 / 276480 : 𝕂) • (a * a * b * b * b * b * b)
  + (-10 / 276480 : 𝕂) • (a * b * a * a * a * a * b)
  + (8 / 276480 : 𝕂) • (a * b * a * a * a * b * a)
  + (16 / 276480 : 𝕂) • (a * b * a * a * a * b * b)
  + (-6 / 276480 : 𝕂) • (a * b * a * a * b * a * a)
  + (-24 / 276480 : 𝕂) • (a * b * a * a * b * b * a)
  + (-8 / 276480 : 𝕂) • (a * b * a * a * b * b * b)
  + (4 / 276480 : 𝕂) • (a * b * a * b * a * a * a)
  + (-120 / 276480 : 𝕂) • (a * b * a * b * a * a * b)
  + (96 / 276480 : 𝕂) • (a * b * a * b * a * b * a)
  + (72 / 276480 : 𝕂) • (a * b * a * b * a * b * b)
  + (-12 / 276480 : 𝕂) • (a * b * a * b * b * a * a)
  + (-8 / 276480 : 𝕂) • (a * b * a * b * b * b * a)
  + (24 / 276480 : 𝕂) • (a * b * a * b * b * b * b)
  + (-1 / 276480 : 𝕂) • (a * b * b * a * a * a * a)
  + (40 / 276480 : 𝕂) • (a * b * b * a * a * a * b)
  + (-24 / 276480 : 𝕂) • (a * b * b * a * a * b * a)
  + (-48 / 276480 : 𝕂) • (a * b * b * a * a * b * b)
  + (-12 / 276480 : 𝕂) • (a * b * b * a * b * a * a)
  + (120 / 276480 : 𝕂) • (a * b * b * a * b * a * b)
  + (-48 / 276480 : 𝕂) • (a * b * b * a * b * b * a)
  + (-16 / 276480 : 𝕂) • (a * b * b * a * b * b * b)
  + (8 / 276480 : 𝕂) • (a * b * b * b * a * a * a)
  + (-40 / 276480 : 𝕂) • (a * b * b * b * a * a * b)
  + (-8 / 276480 : 𝕂) • (a * b * b * b * a * b * a)
  + (-16 / 276480 : 𝕂) • (a * b * b * b * a * b * b)
  + (16 / 276480 : 𝕂) • (a * b * b * b * b * a * a)
  + (40 / 276480 : 𝕂) • (a * b * b * b * b * a * b)
  + (-16 / 276480 : 𝕂) • (a * b * b * b * b * b * a)
  + (4 / 276480 : 𝕂) • (b * a * a * a * a * a * b)
  + (-10 / 276480 : 𝕂) • (b * a * a * a * a * b * a)
  + (-16 / 276480 : 𝕂) • (b * a * a * a * a * b * b)
  + (16 / 276480 : 𝕂) • (b * a * a * a * b * a * a)
  + (8 / 276480 : 𝕂) • (b * a * a * a * b * a * b)
  + (40 / 276480 : 𝕂) • (b * a * a * a * b * b * a)
  + (-32 / 276480 : 𝕂) • (b * a * a * a * b * b * b)
  + (-14 / 276480 : 𝕂) • (b * a * a * b * a * a * a)
  + (48 / 276480 : 𝕂) • (b * a * a * b * a * a * b)
  + (-120 / 276480 : 𝕂) • (b * a * a * b * a * b * a)
  + (48 / 276480 : 𝕂) • (b * a * a * b * a * b * b)
  + (12 / 276480 : 𝕂) • (b * a * a * b * b * a * a)
  + (96 / 276480 : 𝕂) • (b * a * a * b * b * a * b)
  + (-40 / 276480 : 𝕂) • (b * a * a * b * b * b * a)
  + (16 / 276480 : 𝕂) • (b * a * a * b * b * b * b)
  + (6 / 276480 : 𝕂) • (b * a * b * a * a * a * a)
  + (8 / 276480 : 𝕂) • (b * a * b * a * a * a * b)
  + (48 / 276480 : 𝕂) • (b * a * b * a * a * b * b)
  + (72 / 276480 : 𝕂) • (b * a * b * a * b * a * a)
  + (-384 / 276480 : 𝕂) • (b * a * b * a * b * a * b)
  + (120 / 276480 : 𝕂) • (b * a * b * a * b * b * a)
  + (-64 / 276480 : 𝕂) • (b * a * b * a * b * b * b)
  + (-28 / 276480 : 𝕂) • (b * a * b * b * a * a * a)
  + (96 / 276480 : 𝕂) • (b * a * b * b * a * a * b)
  + (96 / 276480 : 𝕂) • (b * a * b * b * a * b * b)
  + (-16 / 276480 : 𝕂) • (b * a * b * b * b * a * a)
  + (-128 / 276480 : 𝕂) • (b * a * b * b * b * a * b)
  + (40 / 276480 : 𝕂) • (b * a * b * b * b * b * a)
  + (-1 / 276480 : 𝕂) • (b * b * a * a * a * a * a)
  + (-16 / 276480 : 𝕂) • (b * b * a * a * a * a * b)
  + (16 / 276480 : 𝕂) • (b * b * a * a * a * b * a)
  + (-12 / 276480 : 𝕂) • (b * b * a * a * b * a * a)
  + (48 / 276480 : 𝕂) • (b * b * a * a * b * a * b)
  + (-48 / 276480 : 𝕂) • (b * b * a * a * b * b * a)
  + (-12 / 276480 : 𝕂) • (b * b * a * b * a * a * a)
  + (48 / 276480 : 𝕂) • (b * b * a * b * a * a * b)
  + (72 / 276480 : 𝕂) • (b * b * a * b * a * b * a)
  + (-24 / 276480 : 𝕂) • (b * b * a * b * b * a * a)
  + (96 / 276480 : 𝕂) • (b * b * a * b * b * a * b)
  + (-16 / 276480 : 𝕂) • (b * b * a * b * b * b * a)
  + (8 / 276480 : 𝕂) • (b * b * b * a * a * a * a)
  + (-32 / 276480 : 𝕂) • (b * b * b * a * a * a * b)
  + (-8 / 276480 : 𝕂) • (b * b * b * a * a * b * a)
  + (-24 / 276480 : 𝕂) • (b * b * b * a * b * a * a)
  + (-64 / 276480 : 𝕂) • (b * b * b * a * b * a * b)
  + (-16 / 276480 : 𝕂) • (b * b * b * a * b * b * a)
  + (16 / 276480 : 𝕂) • (b * b * b * b * a * a * a)
  + (16 / 276480 : 𝕂) • (b * b * b * b * a * a * b)
  + (24 / 276480 : 𝕂) • (b * b * b * b * a * b * a)
  + (-8 / 276480 : 𝕂) • (b * b * b * b * b * a * a)

/-- **septic_d7_cross_V2_V3_poly**: V_2·V_3 cross deg-7 perturbation piece. Bilinear V_2·V_3 from C_4 (deg 4+1+2=7) plus trilinear V_2²·V_3 from C_3 (deg 3+1+1+2=7).

CAS-derived; denominator 18432, 41 terms,
Σ|num|/LCM = 164/18432 ≈ 0.0089. -/
noncomputable def septic_d7_cross_V2_V3_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-1 / 18432 : 𝕂) • (a * a * a * a * b * a * b)
  + (1 / 18432 : 𝕂) • (a * a * a * a * b * b * a)
  + (3 / 18432 : 𝕂) • (a * a * a * b * a * a * b)
  + (-2 / 18432 : 𝕂) • (a * a * a * b * a * b * a)
  + (-2 / 18432 : 𝕂) • (a * a * a * b * a * b * b)
  + (-1 / 18432 : 𝕂) • (a * a * a * b * b * a * a)
  + (2 / 18432 : 𝕂) • (a * a * a * b * b * a * b)
  + (-2 / 18432 : 𝕂) • (a * a * b * a * a * a * b)
  + (-3 / 18432 : 𝕂) • (a * a * b * a * a * b * a)
  + (6 / 18432 : 𝕂) • (a * a * b * a * a * b * b)
  + (6 / 18432 : 𝕂) • (a * a * b * a * b * a * a)
  + (-8 / 18432 : 𝕂) • (a * a * b * a * b * a * b)
  + (2 / 18432 : 𝕂) • (a * a * b * a * b * b * a)
  + (-1 / 18432 : 𝕂) • (a * a * b * b * a * a * a)
  + (2 / 18432 : 𝕂) • (a * a * b * b * a * a * b)
  + (-2 / 18432 : 𝕂) • (a * a * b * b * a * b * a)
  + (4 / 18432 : 𝕂) • (a * b * a * a * a * b * a)
  + (-4 / 18432 : 𝕂) • (a * b * a * a * a * b * b)
  + (-3 / 18432 : 𝕂) • (a * b * a * a * b * a * a)
  + (8 / 18432 : 𝕂) • (a * b * a * a * b * a * b)
  + (-8 / 18432 : 𝕂) • (a * b * a * a * b * b * a)
  + (-2 / 18432 : 𝕂) • (a * b * a * b * a * a * a)
  + (-8 / 18432 : 𝕂) • (a * b * a * b * a * a * b)
  + (16 / 18432 : 𝕂) • (a * b * a * b * a * b * a)
  + (-2 / 18432 : 𝕂) • (a * b * a * b * b * a * a)
  + (1 / 18432 : 𝕂) • (a * b * b * a * a * a * a)
  + (4 / 18432 : 𝕂) • (a * b * b * a * a * a * b)
  + (-8 / 18432 : 𝕂) • (a * b * b * a * a * b * a)
  + (2 / 18432 : 𝕂) • (a * b * b * a * b * a * a)
  + (-2 / 18432 : 𝕂) • (b * a * a * a * b * a * a)
  + (4 / 18432 : 𝕂) • (b * a * a * a * b * b * a)
  + (3 / 18432 : 𝕂) • (b * a * a * b * a * a * a)
  + (-8 / 18432 : 𝕂) • (b * a * a * b * a * b * a)
  + (2 / 18432 : 𝕂) • (b * a * a * b * b * a * a)
  + (-1 / 18432 : 𝕂) • (b * a * b * a * a * a * a)
  + (8 / 18432 : 𝕂) • (b * a * b * a * a * b * a)
  + (-8 / 18432 : 𝕂) • (b * a * b * a * b * a * a)
  + (2 / 18432 : 𝕂) • (b * a * b * b * a * a * a)
  + (-4 / 18432 : 𝕂) • (b * b * a * a * a * b * a)
  + (6 / 18432 : 𝕂) • (b * b * a * a * b * a * a)
  + (-2 / 18432 : 𝕂) • (b * b * a * b * a * a * a)

/-- **septic_d7_cross_V2_V4_poly**: V_2·V_4 cross deg-7 perturbation piece. Bilinear V_2·V_4 from C_3 (deg 3+1+3=7); only contribution at deg 7.

CAS-derived; denominator 9216, 30 terms,
Σ|num|/LCM = 96/9216 ≈ 0.0104. -/
noncomputable def septic_d7_cross_V2_V4_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (1 / 9216 : 𝕂) • (a * a * a * b * b * a * b)
  + (-1 / 9216 : 𝕂) • (a * a * a * b * b * b * a)
  + (1 / 9216 : 𝕂) • (a * a * b * a * a * b * b)
  + (-4 / 9216 : 𝕂) • (a * a * b * a * b * a * b)
  + (2 / 9216 : 𝕂) • (a * a * b * a * b * b * a)
  + (-2 / 9216 : 𝕂) • (a * a * b * b * a * a * b)
  + (5 / 9216 : 𝕂) • (a * a * b * b * a * b * a)
  + (-2 / 9216 : 𝕂) • (a * a * b * b * b * a * a)
  + (-3 / 9216 : 𝕂) • (a * b * a * a * a * b * b)
  + (6 / 9216 : 𝕂) • (a * b * a * a * b * a * b)
  + (1 / 9216 : 𝕂) • (a * b * a * a * b * b * a)
  + (6 / 9216 : 𝕂) • (a * b * a * b * a * a * b)
  + (-16 / 9216 : 𝕂) • (a * b * a * b * a * b * a)
  + (5 / 9216 : 𝕂) • (a * b * a * b * b * a * a)
  + (-1 / 9216 : 𝕂) • (a * b * b * a * a * a * b)
  + (1 / 9216 : 𝕂) • (a * b * b * a * a * b * a)
  + (2 / 9216 : 𝕂) • (a * b * b * a * b * a * a)
  + (-1 / 9216 : 𝕂) • (a * b * b * b * a * a * a)
  + (2 / 9216 : 𝕂) • (b * a * a * a * a * b * b)
  + (-4 / 9216 : 𝕂) • (b * a * a * a * b * a * b)
  + (-1 / 9216 : 𝕂) • (b * a * a * a * b * b * a)
  + (6 / 9216 : 𝕂) • (b * a * a * b * a * b * a)
  + (-2 / 9216 : 𝕂) • (b * a * a * b * b * a * a)
  + (-4 / 9216 : 𝕂) • (b * a * b * a * a * a * b)
  + (6 / 9216 : 𝕂) • (b * a * b * a * a * b * a)
  + (-4 / 9216 : 𝕂) • (b * a * b * a * b * a * a)
  + (1 / 9216 : 𝕂) • (b * a * b * b * a * a * a)
  + (2 / 9216 : 𝕂) • (b * b * a * a * a * a * b)
...
/-! ### Sub-piece decomposition of `septic_d7_P2_poly`
...
P_2 captures the V_2-only deg-7 perturbation. At deg 7, the contributions are:
  ...
  • Higher orders (cubic from C_4, quartic from C_3) are IMPOSSIBLE — they
    would need C_p with 3+ or 4+ z-positions, but C_4 has 2 and C_3 has 2.

So P_2 has only 2 sub-pieces, NOT 4 as initially thought. Both use higher-k
bch_term defs (in monomial form in Lean, not Dynkin Lie form), so neither
has a clean Dynkin-expressible operator form. Both remain as polynomial
DEFs; their operator interpretation will be via Lipschitz bounds on
`bch_sextic_term` and `bch_quintic_term` in a future session.

CAS-verified at `scripts/verify_P2_decomp.py` (using forward/backward
symmetry trick: half-sum at deg 7 = even-in-V_2 part = C_5 quad piece;
half-diff at deg 7 = odd-in-V_2 part = C_6 lin piece). -/

/-- **septic_d7_P2_C6_lin_poly**: C_6 linear-in-V_2 part of P_2 at deg 7. Equals the deg-7 part of (bch_sextic_term(x+V_2, ½a) - bch_sextic_term(x, ½a)) where x = ½a+b, V_2 = ½·[½a, b]. Not Dynkin-expressible in Lean (bch_sextic_term is monomial form), but bounded via Lipschitz on bch_sextic_term.
   CAS-derived; denominator 92160, 60 terms, Σ|num|/LCM ≈ 0.0184. -/
noncomputable def septic_d7_P2_C6_lin_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-3 / 92160 : 𝕂) • (a * a * a * a * a * a * b)
  + (18 / 92160 : 𝕂) • (a * a * a * a * a * b * a)
  + (12 / 92160 : 𝕂) • (a * a * a * a * a * b * b)
  + (-45 / 92160 : 𝕂) • (a * a * a * a * b * a * a)
  + (-33 / 92160 : 𝕂) • (a * a * a * a * b * a * b)
  + (-27 / 92160 : 𝕂) • (a * a * a * a * b * b * a)
  + (-14 / 92160 : 𝕂) • (a * a * a * a * b * b * b)
  + (60 / 92160 : 𝕂) • (a * a * a * b * a * a * a)
  + (27 / 92160 : 𝕂) • (a * a * a * b * a * a * b)
  + (78 / 92160 : 𝕂) • (a * a * a * b * a * b * a)
  + (26 / 92160 : 𝕂) • (a * a * a * b * a * b * b)
  + (15 / 92160 : 𝕂) • (a * a * a * b * b * a * a)
  + (6 / 92160 : 𝕂) • (a * a * a * b * b * a * b)
  + (24 / 92160 : 𝕂) • (a * a * a * b * b * b * a)
  + (4 / 92160 : 𝕂) • (a * a * a * b * b * b * b)
  + (-45 / 92160 : 𝕂) • (a * a * b * a * a * a * a)
  + (-18 / 92160 : 𝕂) • (a * a * b * a * a * a * b)
  + (-27 / 92160 : 𝕂) • (a * a * b * a * a * b * a)
  + (16 / 92160 : 𝕂) • (a * a * b * a * a * b * b)
  + (-90 / 92160 : 𝕂) • (a * a * b * a * b * a * a)
  + (-64 / 92160 : 𝕂) • (a * a * b * a * b * a * b)
  + (-46 / 92160 : 𝕂) • (a * a * b * a * b * b * a)
  + (-16 / 92160 : 𝕂) • (a * a * b * a * b * b * b)
  + (15 / 92160 : 𝕂) • (a * a * b * b * a * a * a)
  + (16 / 92160 : 𝕂) • (a * a * b * b * a * a * b)
  + (14 / 92160 : 𝕂) • (a * a * b * b * a * b * a)
  + (24 / 92160 : 𝕂) • (a * a * b * b * a * b * b)
  + (-20 / 92160 : 𝕂) • (a * a * b * b * b * a * a)
  + (-16 / 92160 : 𝕂) • (a * a * b * b * b * a * b)
  + (-4 / 92160 : 𝕂) • (a * a * b * b * b * b * a)
  + (18 / 92160 : 𝕂) • (a * b * a * a * a * a * a)
  + (36 / 92160 : 𝕂) • (a * b * a * a * a * b * a)
  + (-27 / 92160 : 𝕂) • (a * b * a * a * b * a * a)
  + (-32 / 92160 : 𝕂) • (a * b * a * a * b * b * a)
  + (78 / 92160 : 𝕂) • (a * b * a * b * a * a * a)
  + (128 / 92160 : 𝕂) • (a * b * a * b * a * b * a)
  + (14 / 92160 : 𝕂) • (a * b * a * b * b * a * a)
  + (32 / 92160 : 𝕂) • (a * b * a * b * b * b * a)
  + (-27 / 92160 : 𝕂) • (a * b * b * a * a * a * a)
  + (-32 / 92160 : 𝕂) • (a * b * b * a * a * b * a)
  + (-46 / 92160 : 𝕂) • (a * b * b * a * b * a * a)
  + (-48 / 92160 : 𝕂) • (a * b * b * a * b * b * a)
  + (24 / 92160 : 𝕂) • (a * b * b * b * a * a * a)
  + (32 / 92160 : 𝕂) • (a * b * b * b * a * b * a)
  + (-4 / 92160 : 𝕂) • (a * b * b * b * b * a * a)
  + (-3 / 92160 : 𝕂) • (b * a * a * a * a * a * a)
  + (-18 / 92160 : 𝕂) • (b * a * a * a * b * a * a)
  + (27 / 92160 : 𝕂) • (b * a * a * b * a * a * a)
  + (16 / 92160 : 𝕂) • (b * a * a * b * b * a * a)
  + (-33 / 92160 : 𝕂) • (b * a * b * a * a * a * a)
  + (-64 / 92160 : 𝕂) • (b * a * b * a * b * a * a)
  + (6 / 92160 : 𝕂) • (b * a * b * b * a * a * a)
  + (-16 / 92160 : 𝕂) • (b * a * b * b * b * a * a)
  + (12 / 92160 : 𝕂) • (b * b * a * a * a * a * a)
  + (16 / 92160 : 𝕂) • (b * b * a * a * b * a * a)
  + (26 / 92160 : 𝕂) • (b * b * a * b * a * a * a)
  + (24 / 92160 : 𝕂) • (b * b * a * b * b * a * a)
  + (-14 / 92160 : 𝕂) • (b * b * b * a * a * a * a)
  + (-16 / 92160 : 𝕂) • (b * b * b * a * b * a * a)
  + (4 / 92160 : 𝕂) • (b * b * b * b * a * a * a)

/-- **septic_d7_P2_C5_quad_poly**: C_5 quadratic-in-V_2 part of P_2 at deg 7. Equals the deg-7 part of (bch_quintic_term(x+V_2, ½a) - bch_quintic_term(x, ½a)). Not Dynkin-expressible (bch_quintic_term is monomial form). The bch_quintic_term Lipschitz bound gives bound K·s⁴·‖V_2‖ ≤ K·s⁶ on the FULL diff; the deg-7 quadratic piece is a residual after the deg-6 linear piece.
   CAS-derived; denominator 92160, 79 terms, Σ|num|/LCM ≈ 0.0207. -/
noncomputable def septic_d7_P2_C5_quad_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-7 / 92160 : 𝕂) • (a * a * a * a * b * a * b)
  + (7 / 92160 : 𝕂) • (a * a * a * a * b * b * a)
  + (30 / 92160 : 𝕂) • (a * a * a * b * a * a * b)
...
/-- **P_2 sub-piece decomposition**: split septic_d7_P2_poly into its two
operator components (C_6 lin + C_5 quad). -/
private theorem septic_d7_P2_pieces_decomp
    {𝕂 : Type*} [RCLike 𝕂] {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸]
    (a b : 𝔸) :
    septic_d7_P2_poly 𝕂 a b =
      septic_d7_P2_C6_lin_poly 𝕂 a b + septic_d7_P2_C5_quad_poly 𝕂 a b := by
...
/-! ## 9-piece operator-form decomposition of septic_d8_perturbation_poly

From CAS verification (`scripts/verify_d8_operator_decomp.py`):
...
Each piece corresponds to a specific operator-form perturbation:
  • P_j := (bch(x + V_j, ½a) − bch(x, ½a))_deg8  (single-V_j perturbation).
  • Cross(V_j, V_k) := (bch(x+V_j+V_k, ½a) − bch(x+V_j, ½a)
                       − bch(x+V_k, ½a) + bch(x, ½a))_deg8  (mixed cross).

d8 analog of the 6-piece d7 decomposition. Three potential cross pieces
(Cross(V_2,V_6), Cross(V_3,V_5), Cross(V_4,V_5)) vanish at deg 8 because
the required C_p with p+(j-1)+(k-1) = 8 and j,k ≥ 3 forces p ≤ 2, but
C_2 has only 1 z-position and cannot admit bilinear substitution.

Foundation for the Phase C-septic operator-form identity (eventual O(s⁹)
joint bound replacing the current O(s⁸) per-piece bound on
septic_d8_perturbation_poly via Lipschitz bounds on each operator form).
-/

/-- **septic_d8_P2_poly**: V_2-only deg-8 perturbation piece (P_2_d8). Captures linear-in-V_2 from C_7, quadratic-in-V_2 from C_6, and cubic V_2³ from C_5.

CAS-derived; denominator 7741440, 186 terms,
Σ|num|/LCM = 102486/7741440 ≈ 0.0132. -/
noncomputable def septic_d8_P2_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (62 / 7741440 : 𝕂) • (a * a * a * a * a * a * b * b)
  + (-64 / 7741440 : 𝕂) • (a * a * a * a * a * b * a * b)
  + (-308 / 7741440 : 𝕂) • (a * a * a * a * a * b * b * a)
  + (-248 / 7741440 : 𝕂) • (a * a * a * a * a * b * b * b)
  + (-267 / 7741440 : 𝕂) • (a * a * a * a * b * a * a * b)
  + (854 / 7741440 : 𝕂) • (a * a * a * a * b * a * b * a)
  + (354 / 7741440 : 𝕂) • (a * a * a * a * b * a * b * b)
  + (343 / 7741440 : 𝕂) • (a * a * a * a * b * b * a * a)
  + (396 / 7741440 : 𝕂) • (a * a * a * a * b * b * a * b)
  + (490 / 7741440 : 𝕂) • (a * a * a * a * b * b * b * a)
  + (336 / 7741440 : 𝕂) • (a * a * a * a * b * b * b * b)
  + (468 / 7741440 : 𝕂) • (a * a * a * b * a * a * a * b)
  + (-336 / 7741440 : 𝕂) • (a * a * a * b * a * a * b * a)
  + (452 / 7741440 : 𝕂) • (a * a * a * b * a * a * b * b)
  + (-1372 / 7741440 : 𝕂) • (a * a * a * b * a * b * a * a)
  + (-1186 / 7741440 : 𝕂) • (a * a * a * b * a * b * a * b)
  + (-1134 / 7741440 : 𝕂) • (a * a * a * b * a * b * b * a)
  + (-644 / 7741440 : 𝕂) • (a * a * a * b * a * b * b * b)
  + (-80 / 7741440 : 𝕂) • (a * a * a * b * b * a * a * b)
  + (-238 / 7741440 : 𝕂) • (a * a * a * b * b * a * b * a)
  + (56 / 7741440 : 𝕂) • (a * a * a * b * b * a * b * b)
  + (-294 / 7741440 : 𝕂) • (a * a * a * b * b * b * a * a)
  + (-448 / 7741440 : 𝕂) • (a * a * a * b * b * b * a * b)
  + (-308 / 7741440 : 𝕂) • (a * a * a * b * b * b * b * a)
  + (-176 / 7741440 : 𝕂) • (a * a * a * b * b * b * b * b)
  + (-435 / 7741440 : 𝕂) • (a * a * b * a * a * a * a * b)
  + (336 / 7741440 : 𝕂) • (a * a * b * a * a * a * b * a)
  + (-94 / 7741440 : 𝕂) • (a * a * b * a * a * a * b * b)
  + (-1228 / 7741440 : 𝕂) • (a * a * b * a * a * b * a * b)
  + (154 / 7741440 : 𝕂) • (a * a * b * a * a * b * b * a)
  + (-476 / 7741440 : 𝕂) • (a * a * b * a * a * b * b * b)
  + (1372 / 7741440 : 𝕂) • (a * a * b * a * b * a * a * a)
  + (1726 / 7741440 : 𝕂) • (a * a * b * a * b * a * a * b)
  + (2562 / 7741440 : 𝕂) • (a * a * b * a * b * a * b * a)
  + (1400 / 7741440 : 𝕂) • (a * a * b * a * b * a * b * b)
  + (266 / 7741440 : 𝕂) • (a * a * b * a * b * b * a * a)
  + (560 / 7741440 : 𝕂) • (a * a * b * a * b * b * a * b)
  + (924 / 7741440 : 𝕂) • (a * a * b * a * b * b * b * a)
  + (496 / 7741440 : 𝕂) • (a * a * b * a * b * b * b * b)
  + (-343 / 7741440 : 𝕂) • (a * a * b * b * a * a * a * a)
  + (-276 / 7741440 : 𝕂) • (a * a * b * b * a * a * a * b)
  + (-658 / 7741440 : 𝕂) • (a * a * b * b * a * a * b * a)
  + (-392 / 7741440 : 𝕂) • (a * a * b * b * a * a * b * b)
  + (-266 / 7741440 : 𝕂) • (a * a * b * b * a * b * a * a)
  + (-224 / 7741440 : 𝕂) • (a * a * b * b * a * b * a * b)
  + (-560 / 7741440 : 𝕂) • (a * a * b * b * a * b * b * a)
  + (-400 / 7741440 : 𝕂) • (a * a * b * b * a * b * b * b)
  + (294 / 7741440 : 𝕂) • (a * a * b * b * b * a * a * a)
  + (224 / 7741440 : 𝕂) • (a * a * b * b * b * a * a * b)
  + (560 / 7741440 : 𝕂) • (a * a * b * b * b * a * b * a)
  + (160 / 7741440 : 𝕂) • (a * a * b * b * b * a * b * b)
  + (160 / 7741440 : 𝕂) • (a * a * b * b * b * b * a * b)
  + (112 / 7741440 : 𝕂) • (a * a * b * b * b * b * b * a)
  + (32 / 7741440 : 𝕂) • (a * a * b * b * b * b * b * b)
  + (174 / 7741440 : 𝕂) • (a * b * a * a * a * a * a * b)
  + (32 / 7741440 : 𝕂) • (a * b * a * a * a * a * b * b)
  + (-336 / 7741440 : 𝕂) • (a * b * a * a * a * b * a * a)
  + (578 / 7741440 : 𝕂) • (a * b * a * a * a * b * a * b)
  + (-518 / 7741440 : 𝕂) • (a * b * a * a * a * b * b * a)
  + (-224 / 7741440 : 𝕂) • (a * b * a * a * a * b * b * b)
  + (336 / 7741440 : 𝕂) • (a * b * a * a * b * a * a * a)
  + (396 / 7741440 : 𝕂) • (a * b * a * a * b * a * a * b)
  + (-70 / 7741440 : 𝕂) • (a * b * a * a * b * a * b * a)
  + (756 / 7741440 : 𝕂) • (a * b * a * a * b * a * b * b)
  + (658 / 7741440 : 𝕂) • (a * b * a * a * b * b * a * a)
  + (672 / 7741440 : 𝕂) • (a * b * a * a * b * b * a * b)
  + (196 / 7741440 : 𝕂) • (a * b * a * a * b * b * b * a)
  + (384 / 7741440 : 𝕂) • (a * b * a * a * b * b * b * b)
  + (-854 / 7741440 : 𝕂) • (a * b * a * b * a * a * a * a)
  + (-1438 / 7741440 : 𝕂) • (a * b * a * b * a * a * a * b)
  + (70 / 7741440 : 𝕂) • (a * b * a * b * a * a * b * a)
  + (-28 / 7741440 : 𝕂) • (a * b * a * b * a * a * b * b)
  + (-2562 / 7741440 : 𝕂) • (a * b * a * b * a * b * a * a)
  + (-3136 / 7741440 : 𝕂) • (a * b * a * b * a * b * a * b)
  + (-1120 / 7741440 : 𝕂) • (a * b * a * b * a * b * b * a)
  + (-1184 / 7741440 : 𝕂) • (a * b * a * b * a * b * b * b)
  + (238 / 7741440 : 𝕂) • (a * b * a * b * b * a * a * a)
  + (336 / 7741440 : 𝕂) • (a * b * a * b * b * a * a * b)
  + (720 / 7741440 : 𝕂) • (a * b * a * b * b * a * b * b)
  + (-560 / 7741440 : 𝕂) • (a * b * a * b * b * b * a * a)
  + (-960 / 7741440 : 𝕂) • (a * b * a * b * b * b * a * b)
  + (-336 / 7741440 : 𝕂) • (a * b * a * b * b * b * b * a)
  + (-192 / 7741440 : 𝕂) • (a * b * a * b * b * b * b * b)
  + (308 / 7741440 : 𝕂) • (a * b * b * a * a * a * a * a)
  + (368 / 7741440 : 𝕂) • (a * b * b * a * a * a * a * b)
  + (518 / 7741440 : 𝕂) • (a * b * b * a * a * a * b * a)
  + (224 / 7741440 : 𝕂) • (a * b * b * a * a * a * b * b)
  + (-154 / 7741440 : 𝕂) • (a * b * b * a * a * b * a * a)
  + (140 / 7741440 : 𝕂) • (a * b * b * a * a * b * a * b)
  + (-176 / 7741440 : 𝕂) • (a * b * b * a * a * b * b * b)
  + (1134 / 7741440 : 𝕂) • (a * b * b * a * b * a * a * a)
  + (1092 / 7741440 : 𝕂) • (a * b * b * a * b * a * a * b)
  + (1120 / 7741440 : 𝕂) • (a * b * b * a * b * a * b * a)
  + (1056 / 7741440 : 𝕂) • (a * b * b * a * b * a * b * b)
  + (560 / 7741440 : 𝕂) • (a * b * b * a * b * b * a * a)
  + (720 / 7741440 : 𝕂) • (a * b * b * a * b * b * a * b)
  + (560 / 7741440 : 𝕂) • (a * b * b * a * b * b * b * a)
  + (480 / 7741440 : 𝕂) • (a * b * b * a * b * b * b * b)
  + (-490 / 7741440 : 𝕂) • (a * b * b * b * a * a * a * a)
  + (-560 / 7741440 : 𝕂) • (a * b * b * b * a * a * a * b)
  + (-196 / 7741440 : 𝕂) • (a * b * b * b * a * a * b * a)
  + (-176 / 7741440 : 𝕂) • (a * b * b * b * a * a * b * b)
  + (-924 / 7741440 : 𝕂) • (a * b * b * b * a * b * a * a)
  + (-1184 / 7741440 : 𝕂) • (a * b * b * b * a * b * a * b)
  + (-560 / 7741440 : 𝕂) • (a * b * b * b * a * b * b * a)
  + (-640 / 7741440 : 𝕂) • (a * b * b * b * a * b * b * b)
  + (308 / 7741440 : 𝕂) • (a * b * b * b * b * a * a * a)
  + (384 / 7741440 : 𝕂) • (a * b * b * b * b * a * a * b)
  + (336 / 7741440 : 𝕂) • (a * b * b * b * b * a * b * a)
  + (480 / 7741440 : 𝕂) • (a * b * b * b * b * a * b * b)
  + (-112 / 7741440 : 𝕂) • (a * b * b * b * b * b * a * a)
  + (-192 / 7741440 : 𝕂) • (a * b * b * b * b * b * a * b)
  + (-174 / 7741440 : 𝕂) • (b * a * a * a * a * a * b * a)
  + (435 / 7741440 : 𝕂) • (b * a * a * a * a * b * a * a)
  + (336 / 7741440 : 𝕂) • (b * a * a * a * a * b * a * b)
  + (-368 / 7741440 : 𝕂) • (b * a * a * a * a * b * b * a)
  + (-468 / 7741440 : 𝕂) • (b * a * a * a * b * a * a * a)
  + (-1680 / 7741440 : 𝕂) • (b * a * a * a * b * a * a * b)
  + (1438 / 7741440 : 𝕂) • (b * a * a * a * b * a * b * a)
  + (-336 / 7741440 : 𝕂) • (b * a * a * a * b * a * b * b)
  + (276 / 7741440 : 𝕂) • (b * a * a * a * b * b * a * a)
  + (560 / 7741440 : 𝕂) • (b * a * a * a * b * b * b * a)
  + (267 / 7741440 : 𝕂) • (b * a * a * b * a * a * a * a)
  + (1680 / 7741440 : 𝕂) • (b * a * a * b * a * a * a * b)
  + (-396 / 7741440 : 𝕂) • (b * a * a * b * a * a * b * a)
  + (840 / 7741440 : 𝕂) • (b * a * a * b * a * a * b * b)
  + (-1726 / 7741440 : 𝕂) • (b * a * a * b * a * b * a * a)
  + (-336 / 7741440 : 𝕂) • (b * a * a * b * a * b * a * b)
  + (-1092 / 7741440 : 𝕂) • (b * a * a * b * a * b * b * a)
  + (80 / 7741440 : 𝕂) • (b * a * a * b * b * a * a * a)
  + (-336 / 7741440 : 𝕂) • (b * a * a * b * b * a * b * a)
  + (-224 / 7741440 : 𝕂) • (b * a * a * b * b * b * a * a)
  + (-384 / 7741440 : 𝕂) • (b * a * a * b * b * b * b * a)
  + (64 / 7741440 : 𝕂) • (b * a * b * a * a * a * a * a)
  + (-336 / 7741440 : 𝕂) • (b * a * b * a * a * a * a * b)
  + (-578 / 7741440 : 𝕂) • (b * a * b * a * a * a * b * a)
  + (-504 / 7741440 : 𝕂) • (b * a * b * a * a * a * b * b)
  + (1228 / 7741440 : 𝕂) • (b * a * b * a * a * b * a * a)
  + (-140 / 7741440 : 𝕂) • (b * a * b * a * a * b * b * a)
  + (1186 / 7741440 : 𝕂) • (b * a * b * a * b * a * a * a)
  + (336 / 7741440 : 𝕂) • (b * a * b * a * b * a * a * b)
  + (3136 / 7741440 : 𝕂) • (b * a * b * a * b * a * b * a)
  + (224 / 7741440 : 𝕂) • (b * a * b * a * b * b * a * a)
  + (1184 / 7741440 : 𝕂) • (b * a * b * a * b * b * b * a)
  + (-396 / 7741440 : 𝕂) • (b * a * b * b * a * a * a * a)
  + (-672 / 7741440 : 𝕂) • (b * a * b * b * a * a * b * a)
  + (-560 / 7741440 : 𝕂) • (b * a * b * b * a * b * a * a)
  + (-720 / 7741440 : 𝕂) • (b * a * b * b * a * b * b * a)
  + (448 / 7741440 : 𝕂) • (b * a * b * b * b * a * a * a)
  + (960 / 7741440 : 𝕂) • (b * a * b * b * b * a * b * a)
  + (-160 / 7741440 : 𝕂) • (b * a * b * b * b * b * a * a)
  + (192 / 7741440 : 𝕂) • (b * a * b * b * b * b * b * a)
  + (-62 / 7741440 : 𝕂) • (b * b * a * a * a * a * a * a)
  + (-32 / 7741440 : 𝕂) • (b * b * a * a * a * a * b * a)
  + (94 / 7741440 : 𝕂) • (b * b * a * a * a * b * a * a)
  + (504 / 7741440 : 𝕂) • (b * b * a * a * a * b * a * b)
  + (-224 / 7741440 : 𝕂) • (b * b * a * a * a * b * b * a)
  + (-452 / 7741440 : 𝕂) • (b * b * a * a * b * a * a * a)
  + (-840 / 7741440 : 𝕂) • (b * b * a * a * b * a * a * b)
  + (28 / 7741440 : 𝕂) • (b * b * a * a * b * a * b * a)
  + (392 / 7741440 : 𝕂) • (b * b * a * a * b * b * a * a)
  + (176 / 7741440 : 𝕂) • (b * b * a * a * b * b * b * a)
  + (-354 / 7741440 : 𝕂) • (b * b * a * b * a * a * a * a)
  + (336 / 7741440 : 𝕂) • (b * b * a * b * a * a * a * b)
  + (-756 / 7741440 : 𝕂) • (b * b * a * b * a * a * b * a)
  + (-1400 / 7741440 : 𝕂) • (b * b * a * b * a * b * a * a)
  + (-1056 / 7741440 : 𝕂) • (b * b * a * b * a * b * b * a)
  + (-56 / 7741440 : 𝕂) • (b * b * a * b * b * a * a * a)
  + (-720 / 7741440 : 𝕂) • (b * b * a * b * b * a * b * a)
  + (-160 / 7741440 : 𝕂) • (b * b * a * b * b * b * a * a)
  + (-480 / 7741440 : 𝕂) • (b * b * a * b * b * b * b * a)
  + (248 / 7741440 : 𝕂) • (b * b * b * a * a * a * a * a)
  + (224 / 7741440 : 𝕂) • (b * b * b * a * a * a * b * a)
  + (476 / 7741440 : 𝕂) • (b * b * b * a * a * b * a * a)
  + (176 / 7741440 : 𝕂) • (b * b * b * a * a * b * b * a)
  + (644 / 7741440 : 𝕂) • (b * b * b * a * b * a * a * a)
  + (1184 / 7741440 : 𝕂) • (b * b * b * a * b * a * b * a)
  + (400 / 7741440 : 𝕂) • (b * b * b * a * b * b * a * a)
  + (640 / 7741440 : 𝕂) • (b * b * b * a * b * b * b * a)
  + (-336 / 7741440 : 𝕂) • (b * b * b * b * a * a * a * a)
  + (-384 / 7741440 : 𝕂) • (b * b * b * b * a * a * b * a)
  + (-496 / 7741440 : 𝕂) • (b * b * b * b * a * b * a * a)
  + (-480 / 7741440 : 𝕂) • (b * b * b * b * a * b * b * a)
  + (176 / 7741440 : 𝕂) • (b * b * b * b * b * a * a * a)
  + (192 / 7741440 : 𝕂) • (b * b * b * b * b * a * b * a)
  + (-32 / 7741440 : 𝕂) • (b * b * b * b * b * b * a * a)

/-- **septic_d8_P3_poly**: V_3-only deg-8 perturbation piece (P_3_d8). Captures linear-in-V_3 from C_6 and quadratic-in-V_3 from C_4.

CAS-derived; denominator 1105920, 166 terms,
Σ|num|/LCM = 14858/1105920 ≈ 0.0134. -/
noncomputable def septic_d8_P3_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-3 / 1105920 : 𝕂) • (a * a * a * a * a * a * a * b)
  + (21 / 1105920 : 𝕂) • (a * a * a * a * a * a * b * a)
  + (6 / 1105920 : 𝕂) • (a * a * a * a * a * a * b * b)
  + (-63 / 1105920 : 𝕂) • (a * a * a * a * a * b * a * a)
  + (-45 / 1105920 : 𝕂) • (a * a * a * a * a * b * a * b)
  + (9 / 1105920 : 𝕂) • (a * a * a * a * a * b * b * a)
  + (10 / 1105920 : 𝕂) • (a * a * a * a * a * b * b * b)
  + (105 / 1105920 : 𝕂) • (a * a * a * a * b * a * a * a)
  + (112 / 1105920 : 𝕂) • (a * a * a * a * b * a * a * b)
  + (1 / 1105920 : 𝕂) • (a * a * a * a * b * a * b * a)
  + (20 / 1105920 : 𝕂) • (a * a * a * a * b * a * b * b)
  + (-23 / 1105920 : 𝕂) • (a * a * a * a * b * b * a * a)
  + (-64 / 1105920 : 𝕂) • (a * a * a * a * b * b * a * b)
  + (-6 / 1105920 : 𝕂) • (a * a * a * a * b * b * b * a)
  + (-24 / 1105920 : 𝕂) • (a * a * a * a * b * b * b * b)
  + (-105 / 1105920 : 𝕂) • (a * a * a * b * a * a * a * a)
  + (-118 / 1105920 : 𝕂) • (a * a * a * b * a * a * a * b)
  + (-94 / 1105920 : 𝕂) • (a * a * a * b * a * a * b * a)
  + (-90 / 1105920 : 𝕂) • (a * a * a * b * a * a * b * b)
  + (92 / 1105920 : 𝕂) • (a * a * a * b * a * b * a * a)
  + (136 / 1105920 : 𝕂) • (a * a * a * b * a * b * a * b)
  + (-36 / 1105920 : 𝕂) • (a * a * a * b * a * b * b * a)
  + (4 / 1105920 : 𝕂) • (a * a * a * b * a * b * b * b)
  + (-34 / 1105920 : 𝕂) • (a * a * a * b * b * a * a * b)
  + (188 / 1105920 : 𝕂) • (a * a * a * b * b * a * b * a)
  + (56 / 1105920 : 𝕂) • (a * a * a * b * b * a * b * b)
  + (-64 / 1105920 : 𝕂) • (a * a * a * b * b * b * a * a)
  + (64 / 1105920 : 𝕂) • (a * a * a * b * b * b * a * b)
  + (-28 / 1105920 : 𝕂) • (a * a * a * b * b * b * b * a)
  + (8 / 1105920 : 𝕂) • (a * a * a * b * b * b * b * b)
  + (63 / 1105920 : 𝕂) • (a * a * b * a * a * a * a * a)
  + (65 / 1105920 : 𝕂) • (a * a * b * a * a * a * a * b)
  + (94 / 1105920 : 𝕂) • (a * a * b * a * a * a * b * a)
  + (24 / 1105920 : 𝕂) • (a * a * b * a * a * a * b * b)
  + (80 / 1105920 : 𝕂) • (a * a * b * a * a * b * a * b)
  + (118 / 1105920 : 𝕂) • (a * a * b * a * a * b * b * a)
  + (92 / 1105920 : 𝕂) • (a * a * b * a * a * b * b * b)
  + (-92 / 1105920 : 𝕂) • (a * a * b * a * b * a * a * a)
  + (-80 / 1105920 : 𝕂) • (a * a * b * a * b * a * a * b)
  + (-408 / 1105920 : 𝕂) • (a * a * b * a * b * a * b * a)
  + (-172 / 1105920 : 𝕂) • (a * a * b * a * b * a * b * b)
  + (140 / 1105920 : 𝕂) • (a * a * b * a * b * b * a * a)
  + (-112 / 1105920 : 𝕂) • (a * a * b * a * b * b * a * b)
  + (88 / 1105920 : 𝕂) • (a * a * b * a * b * b * b * a)
  + (-8 / 1105920 : 𝕂) • (a * a * b * a * b * b * b * b)
  + (23 / 1105920 : 𝕂) • (a * a * b * b * a * a * a * a)
  + (40 / 1105920 : 𝕂) • (a * a * b * b * a * a * a * b)
  + (62 / 1105920 : 𝕂) • (a * a * b * b * a * a * b * a)
  + (124 / 1105920 : 𝕂) • (a * a * b * b * a * a * b * b)
  + (-140 / 1105920 : 𝕂) • (a * a * b * b * a * b * a * a)
  + (-212 / 1105920 : 𝕂) • (a * a * b * b * a * b * a * b)
  + (-32 / 1105920 : 𝕂) • (a * a * b * b * a * b * b * a)
  + (-32 / 1105920 : 𝕂) • (a * a * b * b * a * b * b * b)
  + (64 / 1105920 : 𝕂) • (a * a * b * b * b * a * a * a)
  + (52 / 1105920 : 𝕂) • (a * a * b * b * b * a * a * b)
  + (28 / 1105920 : 𝕂) • (a * a * b * b * b * a * b * a)
  + (48 / 1105920 : 𝕂) • (a * a * b * b * b * a * b * b)
  + (-40 / 1105920 : 𝕂) • (a * a * b * b * b * b * a * b)
  + (8 / 1105920 : 𝕂) • (a * a * b * b * b * b * b * a)
  + (-21 / 1105920 : 𝕂) • (a * b * a * a * a * a * a * a)
  + (-26 / 1105920 : 𝕂) • (a * b * a * a * a * a * a * b)
  + (16 / 1105920 : 𝕂) • (a * b * a * a * a * a * b * b)
  + (-94 / 1105920 : 𝕂) • (a * b * a * a * a * b * a * a)
  + (-128 / 1105920 : 𝕂) • (a * b * a * a * a * b * a * b)
  + (16 / 1105920 : 𝕂) • (a * b * a * a * a * b * b * a)
  + (94 / 1105920 : 𝕂) • (a * b * a * a * b * a * a * a)
  + (192 / 1105920 : 𝕂) • (a * b * a * a * b * a * a * b)
  + (-160 / 1105920 : 𝕂) • (a * b * a * a * b * a * b * a)
  + (48 / 1105920 : 𝕂) • (a * b * a * a * b * a * b * b)
  + (-62 / 1105920 : 𝕂) • (a * b * a * a * b * b * a * a)
  + (-192 / 1105920 : 𝕂) • (a * b * a * a * b * b * a * b)
  + (-40 / 1105920 : 𝕂) • (a * b * a * a * b * b * b * a)
  + (-32 / 1105920 : 𝕂) • (a * b * a * a * b * b * b * b)
  + (-1 / 1105920 : 𝕂) • (a * b * a * b * a * a * a * a)
  + (-128 / 1105920 : 𝕂) • (a * b * a * b * a * a * a * b)
  + (160 / 1105920 : 𝕂) • (a * b * a * b * a * a * b * a)
  + (-352 / 1105920 : 𝕂) • (a * b * a * b * a * a * b * b)
  + (408 / 1105920 : 𝕂) • (a * b * a * b * a * b * a * a)
  + (992 / 1105920 : 𝕂) • (a * b * a * b * a * b * a * b)
  + (-40 / 1105920 : 𝕂) • (a * b * a * b * a * b * b * a)
  + (96 / 1105920 : 𝕂) • (a * b * a * b * a * b * b * b)
  + (-188 / 1105920 : 𝕂) • (a * b * a * b * b * a * a * a)
  + (-192 / 1105920 : 𝕂) • (a * b * a * b * b * a * a * b)
  + (-48 / 1105920 : 𝕂) • (a * b * a * b * b * a * b * b)
  + (-28 / 1105920 : 𝕂) • (a * b * a * b * b * b * a * a)
  + (64 / 1105920 : 𝕂) • (a * b * a * b * b * b * a * b)
  + (-32 / 1105920 : 𝕂) • (a * b * a * b * b * b * b * a)
  + (-9 / 1105920 : 𝕂) • (a * b * b * a * a * a * a * a)
  + (16 / 1105920 : 𝕂) • (a * b * b * a * a * a * a * b)
  + (-16 / 1105920 : 𝕂) • (a * b * b * a * a * a * b * a)
  + (152 / 1105920 : 𝕂) • (a * b * b * a * a * a * b * b)
  + (-118 / 1105920 : 𝕂) • (a * b * b * a * a * b * a * a)
  + (-352 / 1105920 : 𝕂) • (a * b * b * a * a * b * a * b)
  + (16 / 1105920 : 𝕂) • (a * b * b * a * a * b * b * b)
  + (36 / 1105920 : 𝕂) • (a * b * b * a * b * a * a * a)
  + (48 / 1105920 : 𝕂) • (a * b * b * a * b * a * a * b)
  + (40 / 1105920 : 𝕂) • (a * b * b * a * b * a * b * a)
  + (-96 / 1105920 : 𝕂) • (a * b * b * a * b * a * b * b)
  + (32 / 1105920 : 𝕂) • (a * b * b * a * b * b * a * a)
  + (-48 / 1105920 : 𝕂) • (a * b * b * a * b * b * a * b)
  + (80 / 1105920 : 𝕂) • (a * b * b * a * b * b * b * a)
  + (6 / 1105920 : 𝕂) • (a * b * b * b * a * a * a * a)
  + (40 / 1105920 : 𝕂) • (a * b * b * b * a * a * b * a)
  + (16 / 1105920 : 𝕂) • (a * b * b * b * a * a * b * b)
  + (-88 / 1105920 : 𝕂) • (a * b * b * b * a * b * a * a)
  + (96 / 1105920 : 𝕂) • (a * b * b * b * a * b * a * b)
  + (-80 / 1105920 : 𝕂) • (a * b * b * b * a * b * b * a)
  + (28 / 1105920 : 𝕂) • (a * b * b * b * b * a * a * a)
  + (-32 / 1105920 : 𝕂) • (a * b * b * b * b * a * a * b)
  + (32 / 1105920 : 𝕂) • (a * b * b * b * b * a * b * a)
  + (-8 / 1105920 : 𝕂) • (a * b * b * b * b * b * a * a)
  + (3 / 1105920 : 𝕂) • (b * a * a * a * a * a * a * a)
  + (26 / 1105920 : 𝕂) • (b * a * a * a * a * a * b * a)
  + (-65 / 1105920 : 𝕂) • (b * a * a * a * a * b * a * a)
  + (-16 / 1105920 : 𝕂) • (b * a * a * a * a * b * b * a)
  + (118 / 1105920 : 𝕂) • (b * a * a * a * b * a * a * a)
  + (128 / 1105920 : 𝕂) • (b * a * a * a * b * a * b * a)
  + (-40 / 1105920 : 𝕂) • (b * a * a * a * b * b * a * a)
  + (-112 / 1105920 : 𝕂) • (b * a * a * b * a * a * a * a)
  + (-192 / 1105920 : 𝕂) • (b * a * a * b * a * a * b * a)
  + (80 / 1105920 : 𝕂) • (b * a * a * b * a * b * a * a)
  + (-48 / 1105920 : 𝕂) • (b * a * a * b * a * b * b * a)
  + (34 / 1105920 : 𝕂) • (b * a * a * b * b * a * a * a)
  + (192 / 1105920 : 𝕂) • (b * a * a * b * b * a * b * a)
  + (-52 / 1105920 : 𝕂) • (b * a * a * b * b * b * a * a)
  + (32 / 1105920 : 𝕂) • (b * a * a * b * b * b * b * a)
  + (45 / 1105920 : 𝕂) • (b * a * b * a * a * a * a * a)
  + (128 / 1105920 : 𝕂) • (b * a * b * a * a * a * b * a)
  + (-80 / 1105920 : 𝕂) • (b * a * b * a * a * b * a * a)
  + (352 / 1105920 : 𝕂) • (b * a * b * a * a * b * b * a)
  + (-136 / 1105920 : 𝕂) • (b * a * b * a * b * a * a * a)
  + (-992 / 1105920 : 𝕂) • (b * a * b * a * b * a * b * a)
  + (212 / 1105920 : 𝕂) • (b * a * b * a * b * b * a * a)
  + (-96 / 1105920 : 𝕂) • (b * a * b * a * b * b * b * a)
  + (64 / 1105920 : 𝕂) • (b * a * b * b * a * a * a * a)
  + (192 / 1105920 : 𝕂) • (b * a * b * b * a * a * b * a)
  + (112 / 1105920 : 𝕂) • (b * a * b * b * a * b * a * a)
  + (48 / 1105920 : 𝕂) • (b * a * b * b * a * b * b * a)
  + (-64 / 1105920 : 𝕂) • (b * a * b * b * b * a * a * a)
  + (-64 / 1105920 : 𝕂) • (b * a * b * b * b * a * b * a)
  + (40 / 1105920 : 𝕂) • (b * a * b * b * b * b * a * a)
  + (-6 / 1105920 : 𝕂) • (b * b * a * a * a * a * a * a)
  + (-16 / 1105920 : 𝕂) • (b * b * a * a * a * a * b * a)
  + (-24 / 1105920 : 𝕂) • (b * b * a * a * a * b * a * a)
  + (-152 / 1105920 : 𝕂) • (b * b * a * a * a * b * b * a)
  + (90 / 1105920 : 𝕂) • (b * b * a * a * b * a * a * a)
  + (352 / 1105920 : 𝕂) • (b * b * a * a * b * a * b * a)
  + (-124 / 1105920 : 𝕂) • (b * b * a * a * b * b * a * a)
  + (-16 / 1105920 : 𝕂) • (b * b * a * a * b * b * b * a)
  + (-20 / 1105920 : 𝕂) • (b * b * a * b * a * a * a * a)
  + (-48 / 1105920 : 𝕂) • (b * b * a * b * a * a * b * a)
  + (172 / 1105920 : 𝕂) • (b * b * a * b * a * b * a * a)
  + (96 / 1105920 : 𝕂) • (b * b * a * b * a * b * b * a)
  + (-56 / 1105920 : 𝕂) • (b * b * a * b * b * a * a * a)
  + (48 / 1105920 : 𝕂) • (b * b * a * b * b * a * b * a)
  + (-48 / 1105920 : 𝕂) • (b * b * a * b * b * b * a * a)
  + (-10 / 1105920 : 𝕂) • (b * b * b * a * a * a * a * a)
  + (-92 / 1105920 : 𝕂) • (b * b * b * a * a * b * a * a)
  + (-16 / 1105920 : 𝕂) • (b * b * b * a * a * b * b * a)
  + (-4 / 1105920 : 𝕂) • (b * b * b * a * b * a * a * a)
  + (-96 / 1105920 : 𝕂) • (b * b * b * a * b * a * b * a)
  + (32 / 1105920 : 𝕂) • (b * b * b * a * b * b * a * a)
  + (24 / 1105920 : 𝕂) • (b * b * b * b * a * a * a * a)
  + (32 / 1105920 : 𝕂) • (b * b * b * b * a * a * b * a)
  + (8 / 1105920 : 𝕂) • (b * b * b * b * a * b * a * a)
  + (-8 / 1105920 : 𝕂) • (b * b * b * b * b * a * a * a)

/-- **septic_d8_P4_poly**: V_4-only deg-8 perturbation piece (P_4_d8). Captures only linear-in-V_4 from C_5 (higher-order V_4 contributions exceed deg 8).

CAS-derived; denominator 552960, 154 terms,
Σ|num|/LCM = 4240/552960 ≈ 0.0077. -/
noncomputable def septic_d8_P4_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-7 / 552960 : 𝕂) • (a * a * a * a * a * b * b * b)
  + (14 / 552960 : 𝕂) • (a * a * a * a * b * a * b * b)
  + (23 / 552960 : 𝕂) • (a * a * a * a * b * b * a * b)
  + (-2 / 552960 : 𝕂) • (a * a * a * a * b * b * b * a)
  + (14 / 552960 : 𝕂) • (a * a * a * a * b * b * b * b)
  + (-7 / 552960 : 𝕂) • (a * a * a * b * a * a * b * b)
  + (-46 / 552960 : 𝕂) • (a * a * a * b * a * b * a * b)
  + (4 / 552960 : 𝕂) • (a * a * a * b * a * b * b * a)
  + (-28 / 552960 : 𝕂) • (a * a * a * b * a * b * b * b)
  + (-20 / 552960 : 𝕂) • (a * a * a * b * b * a * a * b)
  + (-6 / 552960 : 𝕂) • (a * a * a * b * b * a * b * a)
  + (-26 / 552960 : 𝕂) • (a * a * a * b * b * a * b * b)
  + (5 / 552960 : 𝕂) • (a * a * a * b * b * b * a * a)
  + (-6 / 552960 : 𝕂) • (a * a * a * b * b * b * a * b)
  + (4 / 552960 : 𝕂) • (a * a * a * b * b * b * b * a)
  + (-4 / 552960 : 𝕂) • (a * a * a * b * b * b * b * b)
  + (23 / 552960 : 𝕂) • (a * a * b * a * a * a * b * b)
  + (-46 / 552960 : 𝕂) • (a * a * b * a * a * b * a * b)
  + (-2 / 552960 : 𝕂) • (a * a * b * a * a * b * b * a)
  + (14 / 552960 : 𝕂) • (a * a * b * a * a * b * b * b)
  + (100 / 552960 : 𝕂) • (a * a * b * a * b * a * a * b)
  + (30 / 552960 : 𝕂) • (a * a * b * a * b * a * b * a)
  + (52 / 552960 : 𝕂) • (a * a * b * a * b * a * b * b)
  + (-19 / 552960 : 𝕂) • (a * a * b * a * b * b * a * a)
  + (12 / 552960 : 𝕂) • (a * a * b * a * b * b * a * b)
  + (-8 / 552960 : 𝕂) • (a * a * b * a * b * b * b * a)
  + (8 / 552960 : 𝕂) • (a * a * b * a * b * b * b * b)
  + (-5 / 552960 : 𝕂) • (a * a * b * b * a * a * a * b)
  + (-25 / 552960 : 𝕂) • (a * a * b * b * a * a * b * a)
  + (-16 / 552960 : 𝕂) • (a * a * b * b * a * a * b * b)
  + (19 / 552960 : 𝕂) • (a * a * b * b * a * b * a * a)
  + (64 / 552960 : 𝕂) • (a * a * b * b * a * b * a * b)
  + (-6 / 552960 : 𝕂) • (a * a * b * b * a * b * b * a)
  + (16 / 552960 : 𝕂) • (a * a * b * b * a * b * b * b)
  + (-5 / 552960 : 𝕂) • (a * a * b * b * b * a * a * a)
  + (-30 / 552960 : 𝕂) • (a * a * b * b * b * a * a * b)
  + (2 / 552960 : 𝕂) • (a * a * b * b * b * a * b * a)
  + (-24 / 552960 : 𝕂) • (a * a * b * b * b * a * b * b)
  + (16 / 552960 : 𝕂) • (a * a * b * b * b * b * a * b)
  + (-4 / 552960 : 𝕂) • (a * a * b * b * b * b * b * a)
  + (-27 / 552960 : 𝕂) • (a * b * a * a * a * a * b * b)
  + (54 / 552960 : 𝕂) • (a * b * a * a * a * b * a * b)
  + (8 / 552960 : 𝕂) • (a * b * a * a * a * b * b * a)
  + (-26 / 552960 : 𝕂) • (a * b * a * a * a * b * b * b)
  + (-70 / 552960 : 𝕂) • (a * b * a * a * b * a * b * a)
  + (52 / 552960 : 𝕂) • (a * b * a * a * b * a * b * b)
  + (25 / 552960 : 𝕂) • (a * b * a * a * b * b * a * a)
  + (-6 / 552960 : 𝕂) • (a * b * a * a * b * b * a * b)
  + (4 / 552960 : 𝕂) • (a * b * a * a * b * b * b * a)
  + (-4 / 552960 : 𝕂) • (a * b * a * a * b * b * b * b)
  + (-90 / 552960 : 𝕂) • (a * b * a * b * a * a * a * b)
  + (70 / 552960 : 𝕂) • (a * b * a * b * a * a * b * a)
  + (-46 / 552960 : 𝕂) • (a * b * a * b * a * a * b * b)
  + (-30 / 552960 : 𝕂) • (a * b * a * b * a * b * a * a)
  + (-128 / 552960 : 𝕂) • (a * b * a * b * a * b * a * b)
  + (12 / 552960 : 𝕂) • (a * b * a * b * a * b * b * a)
  + (-32 / 552960 : 𝕂) • (a * b * a * b * a * b * b * b)
  + (6 / 552960 : 𝕂) • (a * b * a * b * b * a * a * a)
  + (58 / 552960 : 𝕂) • (a * b * a * b * b * a * a * b)
  + (48 / 552960 : 𝕂) • (a * b * a * b * b * a * b * b)
  + (-2 / 552960 : 𝕂) • (a * b * a * b * b * b * a * a)
  + (-32 / 552960 : 𝕂) • (a * b * a * b * b * b * a * b)
  + (8 / 552960 : 𝕂) • (a * b * a * b * b * b * b * a)
  + (27 / 552960 : 𝕂) • (a * b * b * a * a * a * a * b)
  + (-8 / 552960 : 𝕂) • (a * b * b * a * a * a * b * a)
  + (20 / 552960 : 𝕂) • (a * b * b * a * a * a * b * b)
  + (2 / 552960 : 𝕂) • (a * b * b * a * a * b * a * a)
  + (18 / 552960 : 𝕂) • (a * b * b * a * a * b * a * b)
  + (-4 / 552960 : 𝕂) • (a * b * b * a * b * a * a * a)
  + (-12 / 552960 : 𝕂) • (a * b * b * a * b * a * a * b)
  + (-12 / 552960 : 𝕂) • (a * b * b * a * b * a * b * a)
  + (6 / 552960 : 𝕂) • (a * b * b * a * b * b * a * a)
  + (2 / 552960 : 𝕂) • (a * b * b * b * a * a * a * a)
  + (6 / 552960 : 𝕂) • (a * b * b * b * a * a * a * b)
  + (-4 / 552960 : 𝕂) • (a * b * b * b * a * a * b * a)
  + (8 / 552960 : 𝕂) • (a * b * b * b * a * b * a * a)
  + (-4 / 552960 : 𝕂) • (a * b * b * b * b * a * a * a)
  + (4 / 552960 : 𝕂) • (a * b * b * b * b * a * a * b)
  + (-8 / 552960 : 𝕂) • (a * b * b * b * b * a * b * a)
  + (4 / 552960 : 𝕂) • (a * b * b * b * b * b * a * a)
  + (18 / 552960 : 𝕂) • (b * a * a * a * a * a * b * b)
  + (-36 / 552960 : 𝕂) • (b * a * a * a * a * b * a * b)
  + (-27 / 552960 : 𝕂) • (b * a * a * a * a * b * b * a)
  + (-16 / 552960 : 𝕂) • (b * a * a * a * a * b * b * b)
  + (90 / 552960 : 𝕂) • (b * a * a * a * b * a * b * a)
  + (32 / 552960 : 𝕂) • (b * a * a * a * b * a * b * b)
  + (5 / 552960 : 𝕂) • (b * a * a * a * b * b * a * a)
  + (64 / 552960 : 𝕂) • (b * a * a * a * b * b * a * b)
  + (-6 / 552960 : 𝕂) • (b * a * a * a * b * b * b * a)
  + (16 / 552960 : 𝕂) • (b * a * a * a * b * b * b * b)
  + (-16 / 552960 : 𝕂) • (b * a * a * b * a * a * b * b)
  + (-100 / 552960 : 𝕂) • (b * a * a * b * a * b * a * a)
  + (-128 / 552960 : 𝕂) • (b * a * a * b * a * b * a * b)
  + (12 / 552960 : 𝕂) • (b * a * a * b * a * b * b * a)
  + (-32 / 552960 : 𝕂) • (b * a * a * b * a * b * b * b)
  + (20 / 552960 : 𝕂) • (b * a * a * b * b * a * a * a)
  + (-58 / 552960 : 𝕂) • (b * a * a * b * b * a * b * a)
  + (-24 / 552960 : 𝕂) • (b * a * a * b * b * a * b * b)
  + (30 / 552960 : 𝕂) • (b * a * a * b * b * b * a * a)
  + (16 / 552960 : 𝕂) • (b * a * a * b * b * b * a * b)
  + (-4 / 552960 : 𝕂) • (b * a * a * b * b * b * b * a)
  + (36 / 552960 : 𝕂) • (b * a * b * a * a * a * a * b)
  + (-54 / 552960 : 𝕂) • (b * a * b * a * a * a * b * a)
  + (32 / 552960 : 𝕂) • (b * a * b * a * a * a * b * b)
  + (46 / 552960 : 𝕂) • (b * a * b * a * a * b * a * a)
  + (-18 / 552960 : 𝕂) • (b * a * b * a * a * b * b * a)
  + (48 / 552960 : 𝕂) • (b * a * b * a * a * b * b * b)
  + (46 / 552960 : 𝕂) • (b * a * b * a * b * a * a * a)
  + (128 / 552960 : 𝕂) • (b * a * b * a * b * a * a * b)
  + (128 / 552960 : 𝕂) • (b * a * b * a * b * a * b * a)
  + (-64 / 552960 : 𝕂) • (b * a * b * a * b * b * a * a)
  + (-23 / 552960 : 𝕂) • (b * a * b * b * a * a * a * a)
  + (-64 / 552960 : 𝕂) • (b * a * b * b * a * a * a * b)
  + (6 / 552960 : 𝕂) • (b * a * b * b * a * a * b * a)
  + (-12 / 552960 : 𝕂) • (b * a * b * b * a * b * a * a)
  + (6 / 552960 : 𝕂) • (b * a * b * b * b * a * a * a)
  + (-16 / 552960 : 𝕂) • (b * a * b * b * b * a * a * b)
  + (32 / 552960 : 𝕂) • (b * a * b * b * b * a * b * a)
  + (-16 / 552960 : 𝕂) • (b * a * b * b * b * b * a * a)
  + (-18 / 552960 : 𝕂) • (b * b * a * a * a * a * a * b)
  + (27 / 552960 : 𝕂) • (b * b * a * a * a * a * b * a)
  + (-23 / 552960 : 𝕂) • (b * b * a * a * a * b * a * a)
  + (-32 / 552960 : 𝕂) • (b * b * a * a * a * b * a * b)
  + (-20 / 552960 : 𝕂) • (b * b * a * a * a * b * b * a)
  + (-40 / 552960 : 𝕂) • (b * b * a * a * a * b * b * b)
  + (7 / 552960 : 𝕂) • (b * b * a * a * b * a * a * a)
  + (16 / 552960 : 𝕂) • (b * b * a * a * b * a * a * b)
  + (46 / 552960 : 𝕂) • (b * b * a * a * b * a * b * a)
  + (72 / 552960 : 𝕂) • (b * b * a * a * b * a * b * b)
  + (16 / 552960 : 𝕂) • (b * b * a * a * b * b * a * a)
  + (-14 / 552960 : 𝕂) • (b * b * a * b * a * a * a * a)
  + (-32 / 552960 : 𝕂) • (b * b * a * b * a * a * a * b)
  + (-52 / 552960 : 𝕂) • (b * b * a * b * a * a * b * a)
  + (-72 / 552960 : 𝕂) • (b * b * a * b * a * a * b * b)
  + (-52 / 552960 : 𝕂) • (b * b * a * b * a * b * a * a)
  + (26 / 552960 : 𝕂) • (b * b * a * b * b * a * a * a)
  + (24 / 552960 : 𝕂) • (b * b * a * b * b * a * a * b)
  + (-48 / 552960 : 𝕂) • (b * b * a * b * b * a * b * a)
  + (24 / 552960 : 𝕂) • (b * b * a * b * b * b * a * a)
  + (7 / 552960 : 𝕂) • (b * b * b * a * a * a * a * a)
  + (16 / 552960 : 𝕂) • (b * b * b * a * a * a * a * b)
  + (26 / 552960 : 𝕂) • (b * b * b * a * a * a * b * a)
  + (40 / 552960 : 𝕂) • (b * b * b * a * a * a * b * b)
  + (-14 / 552960 : 𝕂) • (b * b * b * a * a * b * a * a)
  + (-48 / 552960 : 𝕂) • (b * b * b * a * a * b * a * b)
  + (28 / 552960 : 𝕂) • (b * b * b * a * b * a * a * a)
  + (32 / 552960 : 𝕂) • (b * b * b * a * b * a * a * b)
  + (32 / 552960 : 𝕂) • (b * b * b * a * b * a * b * a)
  + (-16 / 552960 : 𝕂) • (b * b * b * a * b * b * a * a)
  + (-14 / 552960 : 𝕂) • (b * b * b * b * a * a * a * a)
  + (-16 / 552960 : 𝕂) • (b * b * b * b * a * a * a * b)
  + (4 / 552960 : 𝕂) • (b * b * b * b * a * a * b * a)
  + (-8 / 552960 : 𝕂) • (b * b * b * b * a * b * a * a)
  + (4 / 552960 : 𝕂) • (b * b * b * b * b * a * a * a)

/-- **septic_d8_P5_poly**: V_5-only deg-8 perturbation piece (P_5_d8). Captures only linear-in-V_5 from C_4 (higher-order V_5 contributions exceed deg 8).

CAS-derived; denominator 2211840, 146 terms,
Σ|num|/LCM = 12896/2211840 ≈ 0.0058. -/
noncomputable def septic_d8_P5_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-1 / 2211840 : 𝕂) • (a * a * a * a * a * a * a * b)
  + (7 / 2211840 : 𝕂) • (a * a * a * a * a * a * b * a)
  + (10 / 2211840 : 𝕂) • (a * a * a * a * a * a * b * b)
  + (-21 / 2211840 : 𝕂) • (a * a * a * a * a * b * a * a)
  + (-24 / 2211840 : 𝕂) • (a * a * a * a * a * b * a * b)
  + (-36 / 2211840 : 𝕂) • (a * a * a * a * a * b * b * a)
  + (35 / 2211840 : 𝕂) • (a * a * a * a * b * a * a * a)
  + (16 / 2211840 : 𝕂) • (a * a * a * a * b * a * a * b)
  + (88 / 2211840 : 𝕂) • (a * a * a * a * b * a * b * a)
  + (46 / 2211840 : 𝕂) • (a * a * a * a * b * b * a * a)
  + (32 / 2211840 : 𝕂) • (a * a * a * a * b * b * a * b)
  + (-32 / 2211840 : 𝕂) • (a * a * a * a * b * b * b * a)
  + (-40 / 2211840 : 𝕂) • (a * a * a * a * b * b * b * b)
  + (-35 / 2211840 : 𝕂) • (a * a * a * b * a * a * a * a)
  + (-24 / 2211840 : 𝕂) • (a * a * a * b * a * a * a * b)
  + (8 / 2211840 : 𝕂) • (a * a * a * b * a * a * b * a)
  + (-184 / 2211840 : 𝕂) • (a * a * a * b * a * b * a * a)
  + (-48 / 2211840 : 𝕂) • (a * a * a * b * a * b * a * b)
  + (48 / 2211840 : 𝕂) • (a * a * a * b * a * b * b * a)
  + (80 / 2211840 : 𝕂) • (a * a * a * b * a * b * b * b)
  + (-48 / 2211840 : 𝕂) • (a * a * a * b * b * a * a * b)
  + (16 / 2211840 : 𝕂) • (a * a * a * b * b * a * b * a)
  + (32 / 2211840 : 𝕂) • (a * a * a * b * b * b * a * a)
  + (64 / 2211840 : 𝕂) • (a * a * a * b * b * b * a * b)
  + (16 / 2211840 : 𝕂) • (a * a * a * b * b * b * b * a)
  + (16 / 2211840 : 𝕂) • (a * a * a * b * b * b * b * b)
  + (21 / 2211840 : 𝕂) • (a * a * b * a * a * a * a * a)
  + (20 / 2211840 : 𝕂) • (a * a * b * a * a * a * a * b)
  + (-8 / 2211840 : 𝕂) • (a * a * b * a * a * a * b * a)
  + (-32 / 2211840 : 𝕂) • (a * a * b * a * a * a * b * b)
  + (96 / 2211840 : 𝕂) • (a * a * b * a * a * b * b * a)
  + (16 / 2211840 : 𝕂) • (a * a * b * a * a * b * b * b)
  + (184 / 2211840 : 𝕂) • (a * a * b * a * b * a * a * a)
  + (240 / 2211840 : 𝕂) • (a * a * b * a * b * a * a * b)
  + (-336 / 2211840 : 𝕂) • (a * a * b * a * b * a * b * a)
  + (-144 / 2211840 : 𝕂) • (a * a * b * a * b * a * b * b)
  + (-128 / 2211840 : 𝕂) • (a * a * b * a * b * b * b * a)
  + (-48 / 2211840 : 𝕂) • (a * a * b * a * b * b * b * b)
  + (-46 / 2211840 : 𝕂) • (a * a * b * b * a * a * a * a)
  + (-80 / 2211840 : 𝕂) • (a * a * b * b * a * a * a * b)
  + (144 / 2211840 : 𝕂) • (a * a * b * b * a * a * b * a)
  + (96 / 2211840 : 𝕂) • (a * a * b * b * a * a * b * b)
  + (-240 / 2211840 : 𝕂) • (a * a * b * b * a * b * a * b)
  + (192 / 2211840 : 𝕂) • (a * a * b * b * a * b * b * a)
  + (32 / 2211840 : 𝕂) • (a * a * b * b * a * b * b * b)
  + (-32 / 2211840 : 𝕂) • (a * a * b * b * b * a * a * a)
  + (80 / 2211840 : 𝕂) • (a * a * b * b * b * a * a * b)
  + (-112 / 2211840 : 𝕂) • (a * a * b * b * b * a * b * a)
  + (32 / 2211840 : 𝕂) • (a * a * b * b * b * a * b * b)
  + (-80 / 2211840 : 𝕂) • (a * a * b * b * b * b * a * b)
  + (16 / 2211840 : 𝕂) • (a * a * b * b * b * b * b * a)
  + (-7 / 2211840 : 𝕂) • (a * b * a * a * a * a * a * a)
  + (-8 / 2211840 : 𝕂) • (a * b * a * a * a * a * a * b)
  + (32 / 2211840 : 𝕂) • (a * b * a * a * a * a * b * b)
  + (8 / 2211840 : 𝕂) • (a * b * a * a * a * b * a * a)
  + (-16 / 2211840 : 𝕂) • (a * b * a * a * a * b * a * b)
  + (-48 / 2211840 : 𝕂) • (a * b * a * a * a * b * b * a)
  + (64 / 2211840 : 𝕂) • (a * b * a * a * a * b * b * b)
  + (-8 / 2211840 : 𝕂) • (a * b * a * a * b * a * a * a)
  + (-96 / 2211840 : 𝕂) • (a * b * a * a * b * a * a * b)
  + (240 / 2211840 : 𝕂) • (a * b * a * a * b * a * b * a)
  + (-96 / 2211840 : 𝕂) • (a * b * a * a * b * a * b * b)
  + (-144 / 2211840 : 𝕂) • (a * b * a * a * b * b * a * a)
  + (-192 / 2211840 : 𝕂) • (a * b * a * a * b * b * a * b)
  + (64 / 2211840 : 𝕂) • (a * b * a * a * b * b * b * a)
  + (-32 / 2211840 : 𝕂) • (a * b * a * a * b * b * b * b)
  + (-88 / 2211840 : 𝕂) • (a * b * a * b * a * a * a * a)
  + (-16 / 2211840 : 𝕂) • (a * b * a * b * a * a * a * b)
  + (-240 / 2211840 : 𝕂) • (a * b * a * b * a * a * b * a)
  + (-96 / 2211840 : 𝕂) • (a * b * a * b * a * a * b * b)
  + (336 / 2211840 : 𝕂) • (a * b * a * b * a * b * a * a)
  + (768 / 2211840 : 𝕂) • (a * b * a * b * a * b * a * b)
  + (-96 / 2211840 : 𝕂) • (a * b * a * b * a * b * b * a)
  + (128 / 2211840 : 𝕂) • (a * b * a * b * a * b * b * b)
  + (-16 / 2211840 : 𝕂) • (a * b * a * b * b * a * a * a)
  + (-192 / 2211840 : 𝕂) • (a * b * a * b * b * a * a * b)
  + (-192 / 2211840 : 𝕂) • (a * b * a * b * b * a * b * b)
  + (112 / 2211840 : 𝕂) • (a * b * a * b * b * b * a * a)
  + (256 / 2211840 : 𝕂) • (a * b * a * b * b * b * a * b)
  + (-32 / 2211840 : 𝕂) • (a * b * a * b * b * b * b * a)
  + (36 / 2211840 : 𝕂) • (a * b * b * a * a * a * a * a)
  + (32 / 2211840 : 𝕂) • (a * b * b * a * a * a * a * b)
  + (48 / 2211840 : 𝕂) • (a * b * b * a * a * a * b * a)
  + (-96 / 2211840 : 𝕂) • (a * b * b * a * a * b * a * a)
  + (-96 / 2211840 : 𝕂) • (a * b * b * a * a * b * a * b)
  + (-48 / 2211840 : 𝕂) • (a * b * b * a * b * a * a * a)
  + (-96 / 2211840 : 𝕂) • (a * b * b * a * b * a * a * b)
  + (96 / 2211840 : 𝕂) • (a * b * b * a * b * a * b * a)
  + (-192 / 2211840 : 𝕂) • (a * b * b * a * b * b * a * a)
  + (-192 / 2211840 : 𝕂) • (a * b * b * a * b * b * a * b)
  + (32 / 2211840 : 𝕂) • (a * b * b * b * a * a * a * a)
  + (64 / 2211840 : 𝕂) • (a * b * b * b * a * a * a * b)
  + (-64 / 2211840 : 𝕂) • (a * b * b * b * a * a * b * a)
  + (128 / 2211840 : 𝕂) • (a * b * b * b * a * b * a * a)
  + (128 / 2211840 : 𝕂) • (a * b * b * b * a * b * a * b)
  + (-16 / 2211840 : 𝕂) • (a * b * b * b * b * a * a * a)
  + (-32 / 2211840 : 𝕂) • (a * b * b * b * b * a * a * b)
  + (32 / 2211840 : 𝕂) • (a * b * b * b * b * a * b * a)
  + (-16 / 2211840 : 𝕂) • (a * b * b * b * b * b * a * a)
  + (1 / 2211840 : 𝕂) • (b * a * a * a * a * a * a * a)
  + (8 / 2211840 : 𝕂) • (b * a * a * a * a * a * b * a)
  + (-20 / 2211840 : 𝕂) • (b * a * a * a * a * b * a * a)
  + (-32 / 2211840 : 𝕂) • (b * a * a * a * a * b * b * a)
  + (24 / 2211840 : 𝕂) • (b * a * a * a * b * a * a * a)
  + (16 / 2211840 : 𝕂) • (b * a * a * a * b * a * b * a)
  + (80 / 2211840 : 𝕂) • (b * a * a * a * b * b * a * a)
  + (-64 / 2211840 : 𝕂) • (b * a * a * a * b * b * b * a)
  + (-16 / 2211840 : 𝕂) • (b * a * a * b * a * a * a * a)
  + (96 / 2211840 : 𝕂) • (b * a * a * b * a * a * b * a)
  + (-240 / 2211840 : 𝕂) • (b * a * a * b * a * b * a * a)
  + (96 / 2211840 : 𝕂) • (b * a * a * b * a * b * b * a)
  + (48 / 2211840 : 𝕂) • (b * a * a * b * b * a * a * a)
  + (192 / 2211840 : 𝕂) • (b * a * a * b * b * a * b * a)
  + (-80 / 2211840 : 𝕂) • (b * a * a * b * b * b * a * a)
  + (32 / 2211840 : 𝕂) • (b * a * a * b * b * b * b * a)
  + (24 / 2211840 : 𝕂) • (b * a * b * a * a * a * a * a)
  + (16 / 2211840 : 𝕂) • (b * a * b * a * a * a * b * a)
  + (96 / 2211840 : 𝕂) • (b * a * b * a * a * b * b * a)
  + (48 / 2211840 : 𝕂) • (b * a * b * a * b * a * a * a)
  + (-768 / 2211840 : 𝕂) • (b * a * b * a * b * a * b * a)
  + (240 / 2211840 : 𝕂) • (b * a * b * a * b * b * a * a)
  + (-128 / 2211840 : 𝕂) • (b * a * b * a * b * b * b * a)
  + (-32 / 2211840 : 𝕂) • (b * a * b * b * a * a * a * a)
  + (192 / 2211840 : 𝕂) • (b * a * b * b * a * a * b * a)
  + (192 / 2211840 : 𝕂) • (b * a * b * b * a * b * b * a)
  + (-64 / 2211840 : 𝕂) • (b * a * b * b * b * a * a * a)
  + (-256 / 2211840 : 𝕂) • (b * a * b * b * b * a * b * a)
  + (80 / 2211840 : 𝕂) • (b * a * b * b * b * b * a * a)
  + (-10 / 2211840 : 𝕂) • (b * b * a * a * a * a * a * a)
  + (-32 / 2211840 : 𝕂) • (b * b * a * a * a * a * b * a)
  + (32 / 2211840 : 𝕂) • (b * b * a * a * a * b * a * a)
  + (96 / 2211840 : 𝕂) • (b * b * a * a * b * a * b * a)
  + (-96 / 2211840 : 𝕂) • (b * b * a * a * b * b * a * a)
  + (96 / 2211840 : 𝕂) • (b * b * a * b * a * a * b * a)
  + (144 / 2211840 : 𝕂) • (b * b * a * b * a * b * a * a)
  + (192 / 2211840 : 𝕂) • (b * b * a * b * b * a * b * a)
  + (-32 / 2211840 : 𝕂) • (b * b * a * b * b * b * a * a)
  + (-64 / 2211840 : 𝕂) • (b * b * b * a * a * a * b * a)
  + (-16 / 2211840 : 𝕂) • (b * b * b * a * a * b * a * a)
  + (-80 / 2211840 : 𝕂) • (b * b * b * a * b * a * a * a)
  + (-128 / 2211840 : 𝕂) • (b * b * b * a * b * a * b * a)
  + (-32 / 2211840 : 𝕂) • (b * b * b * a * b * b * a * a)
  + (40 / 2211840 : 𝕂) • (b * b * b * b * a * a * a * a)
  + (32 / 2211840 : 𝕂) • (b * b * b * b * a * a * b * a)
  + (48 / 2211840 : 𝕂) • (b * b * b * b * a * b * a * a)
  + (-16 / 2211840 : 𝕂) • (b * b * b * b * b * a * a * a)

/-- **septic_d8_P6_poly**: V_6-only deg-8 perturbation piece (P_6_d8). Captures only linear-in-V_6 from C_3 (higher-order V_6 contributions exceed deg 8).

CAS-derived; denominator 552960, 126 terms,
Σ|num|/LCM = 2384/552960 ≈ 0.0043. -/
noncomputable def septic_d8_P6_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-1 / 552960 : 𝕂) • (a * a * a * a * a * b * b * b)
  + (4 / 552960 : 𝕂) • (a * a * a * a * b * a * b * b)
  + (2 / 552960 : 𝕂) • (a * a * a * a * b * b * a * b)
  + (-1 / 552960 : 𝕂) • (a * a * a * a * b * b * b * a)
  + (8 / 552960 : 𝕂) • (a * a * a * a * b * b * b * b)
  + (-6 / 552960 : 𝕂) • (a * a * a * b * a * a * b * b)
  + (-8 / 552960 : 𝕂) • (a * a * a * b * a * b * a * b)
  + (4 / 552960 : 𝕂) • (a * a * a * b * a * b * b * a)
  + (-12 / 552960 : 𝕂) • (a * a * a * b * a * b * b * b)
  + (-12 / 552960 : 𝕂) • (a * a * a * b * b * a * b * b)
  + (-16 / 552960 : 𝕂) • (a * a * a * b * b * b * a * b)
  + (8 / 552960 : 𝕂) • (a * a * a * b * b * b * b * a)
  + (-4 / 552960 : 𝕂) • (a * a * a * b * b * b * b * b)
  + (4 / 552960 : 𝕂) • (a * a * b * a * a * a * b * b)
  + (12 / 552960 : 𝕂) • (a * a * b * a * a * b * a * b)
  + (-6 / 552960 : 𝕂) • (a * a * b * a * a * b * b * a)
  + (-12 / 552960 : 𝕂) • (a * a * b * a * a * b * b * b)
  + (48 / 552960 : 𝕂) • (a * a * b * a * b * a * b * b)
  + (24 / 552960 : 𝕂) • (a * a * b * a * b * b * a * b)
  + (-12 / 552960 : 𝕂) • (a * a * b * a * b * b * b * a)
  + (16 / 552960 : 𝕂) • (a * a * b * a * b * b * b * b)
  + (-12 / 552960 : 𝕂) • (a * a * b * b * a * a * b * b)
  + (24 / 552960 : 𝕂) • (a * a * b * b * a * b * a * b)
  + (-12 / 552960 : 𝕂) • (a * a * b * b * a * b * b * a)
  + (-24 / 552960 : 𝕂) • (a * a * b * b * a * b * b * b)
  + (16 / 552960 : 𝕂) • (a * a * b * b * b * a * b * b)
  + (8 / 552960 : 𝕂) • (a * a * b * b * b * b * a * b)
  + (-4 / 552960 : 𝕂) • (a * a * b * b * b * b * b * a)
  + (-1 / 552960 : 𝕂) • (a * b * a * a * a * a * b * b)
  + (-8 / 552960 : 𝕂) • (a * b * a * a * a * b * a * b)
  + (4 / 552960 : 𝕂) • (a * b * a * a * a * b * b * a)
  + (8 / 552960 : 𝕂) • (a * b * a * a * a * b * b * b)
  + (-12 / 552960 : 𝕂) • (a * b * a * a * b * a * b * b)
  + (24 / 552960 : 𝕂) • (a * b * a * a * b * b * a * b)
  + (-12 / 552960 : 𝕂) • (a * b * a * a * b * b * b * a)
  + (-4 / 552960 : 𝕂) • (a * b * a * a * b * b * b * b)
  + (-12 / 552960 : 𝕂) • (a * b * a * b * a * a * b * b)
  + (-96 / 552960 : 𝕂) • (a * b * a * b * a * b * a * b)
  + (48 / 552960 : 𝕂) • (a * b * a * b * a * b * b * a)
  + (16 / 552960 : 𝕂) • (a * b * a * b * a * b * b * b)
  + (-24 / 552960 : 𝕂) • (a * b * a * b * b * a * b * b)
  + (-32 / 552960 : 𝕂) • (a * b * a * b * b * b * a * b)
  + (16 / 552960 : 𝕂) • (a * b * a * b * b * b * b * a)
  + (1 / 552960 : 𝕂) • (a * b * b * a * a * a * a * b)
  + (-4 / 552960 : 𝕂) • (a * b * b * a * a * a * b * a)
  + (6 / 552960 : 𝕂) • (a * b * b * a * a * b * a * a)
  + (36 / 552960 : 𝕂) • (a * b * b * a * a * b * a * b)
  + (-4 / 552960 : 𝕂) • (a * b * b * a * b * a * a * a)
  + (12 / 552960 : 𝕂) • (a * b * b * a * b * a * a * b)
  + (-48 / 552960 : 𝕂) • (a * b * b * a * b * a * b * a)
  + (12 / 552960 : 𝕂) • (a * b * b * a * b * b * a * a)
  + (72 / 552960 : 𝕂) • (a * b * b * a * b * b * a * b)
  + (-40 / 552960 : 𝕂) • (a * b * b * a * b * b * b * a)
  + (1 / 552960 : 𝕂) • (a * b * b * b * a * a * a * a)
  + (-8 / 552960 : 𝕂) • (a * b * b * b * a * a * a * b)
  + (12 / 552960 : 𝕂) • (a * b * b * b * a * a * b * a)
  + (12 / 552960 : 𝕂) • (a * b * b * b * a * b * a * a)
  + (-48 / 552960 : 𝕂) • (a * b * b * b * a * b * a * b)
  + (40 / 552960 : 𝕂) • (a * b * b * b * a * b * b * a)
  + (-8 / 552960 : 𝕂) • (a * b * b * b * b * a * a * a)
  + (4 / 552960 : 𝕂) • (a * b * b * b * b * a * a * b)
  + (-16 / 552960 : 𝕂) • (a * b * b * b * b * a * b * a)
  + (4 / 552960 : 𝕂) • (a * b * b * b * b * b * a * a)
  + (2 / 552960 : 𝕂) • (b * a * a * a * a * a * b * b)
  + (-8 / 552960 : 𝕂) • (b * a * a * a * a * b * a * b)
  + (-1 / 552960 : 𝕂) • (b * a * a * a * a * b * b * a)
  + (-16 / 552960 : 𝕂) • (b * a * a * a * a * b * b * b)
  + (20 / 552960 : 𝕂) • (b * a * a * a * b * a * a * b)
  + (24 / 552960 : 𝕂) • (b * a * a * a * b * a * b * b)
  + (24 / 552960 : 𝕂) • (b * a * a * a * b * b * a * b)
  + (8 / 552960 : 𝕂) • (b * a * a * a * b * b * b * a)
  + (8 / 552960 : 𝕂) • (b * a * a * a * b * b * b * b)
  + (-20 / 552960 : 𝕂) • (b * a * a * b * a * a * a * b)
  + (24 / 552960 : 𝕂) • (b * a * a * b * a * a * b * b)
  + (-96 / 552960 : 𝕂) • (b * a * a * b * a * b * a * b)
  + (-12 / 552960 : 𝕂) • (b * a * a * b * a * b * b * a)
  + (-32 / 552960 : 𝕂) • (b * a * a * b * a * b * b * b)
  + (48 / 552960 : 𝕂) • (b * a * a * b * b * a * b * b)
  + (-32 / 552960 : 𝕂) • (b * a * a * b * b * b * a * b)
  + (-4 / 552960 : 𝕂) • (b * a * a * b * b * b * b * a)
  + (8 / 552960 : 𝕂) • (b * a * b * a * a * a * a * b)
  + (8 / 552960 : 𝕂) • (b * a * b * a * a * a * b * a)
  + (-12 / 552960 : 𝕂) • (b * a * b * a * a * b * a * a)
  + (-36 / 552960 : 𝕂) • (b * a * b * a * a * b * b * a)
  + (8 / 552960 : 𝕂) • (b * a * b * a * b * a * a * a)
  + (96 / 552960 : 𝕂) • (b * a * b * a * b * a * a * b)
  + (96 / 552960 : 𝕂) • (b * a * b * a * b * a * b * a)
  + (-24 / 552960 : 𝕂) • (b * a * b * a * b * b * a * a)
  + (48 / 552960 : 𝕂) • (b * a * b * a * b * b * b * a)
  + (-2 / 552960 : 𝕂) • (b * a * b * b * a * a * a * a)
  + (-24 / 552960 : 𝕂) • (b * a * b * b * a * a * a * b)
  + (-24 / 552960 : 𝕂) • (b * a * b * b * a * a * b * a)
  + (-24 / 552960 : 𝕂) • (b * a * b * b * a * b * a * a)
  + (-72 / 552960 : 𝕂) • (b * a * b * b * a * b * b * a)
  + (16 / 552960 : 𝕂) • (b * a * b * b * b * a * a * a)
  + (32 / 552960 : 𝕂) • (b * a * b * b * b * a * a * b)
  + (32 / 552960 : 𝕂) • (b * a * b * b * b * a * b * a)
  + (-8 / 552960 : 𝕂) • (b * a * b * b * b * b * a * a)
  + (-2 / 552960 : 𝕂) • (b * b * a * a * a * a * a * b)
  + (1 / 552960 : 𝕂) • (b * b * a * a * a * a * b * a)
  + (-4 / 552960 : 𝕂) • (b * b * a * a * a * b * a * a)
  + (6 / 552960 : 𝕂) • (b * b * a * a * b * a * a * a)
  + (-24 / 552960 : 𝕂) • (b * b * a * a * b * a * a * b)
  + (12 / 552960 : 𝕂) • (b * b * a * a * b * a * b * a)
  + (12 / 552960 : 𝕂) • (b * b * a * a * b * b * a * a)
  + (-4 / 552960 : 𝕂) • (b * b * a * b * a * a * a * a)
  + (-24 / 552960 : 𝕂) • (b * b * a * b * a * a * a * b)
  + (12 / 552960 : 𝕂) • (b * b * a * b * a * a * b * a)
  + (-48 / 552960 : 𝕂) • (b * b * a * b * a * b * a * a)
  + (12 / 552960 : 𝕂) • (b * b * a * b * b * a * a * a)
  + (-48 / 552960 : 𝕂) • (b * b * a * b * b * a * a * b)
  + (24 / 552960 : 𝕂) • (b * b * a * b * b * a * b * a)
  + (-16 / 552960 : 𝕂) • (b * b * a * b * b * b * a * a)
  + (1 / 552960 : 𝕂) • (b * b * b * a * a * a * a * a)
  + (16 / 552960 : 𝕂) • (b * b * b * a * a * a * a * b)
  + (-8 / 552960 : 𝕂) • (b * b * b * a * a * a * b * a)
  + (12 / 552960 : 𝕂) • (b * b * b * a * a * b * a * a)
  + (12 / 552960 : 𝕂) • (b * b * b * a * b * a * a * a)
  + (32 / 552960 : 𝕂) • (b * b * b * a * b * a * a * b)
  + (-16 / 552960 : 𝕂) • (b * b * b * a * b * a * b * a)
  + (24 / 552960 : 𝕂) • (b * b * b * a * b * b * a * a)
  + (-8 / 552960 : 𝕂) • (b * b * b * b * a * a * a * a)
  + (-8 / 552960 : 𝕂) • (b * b * b * b * a * a * a * b)
  + (4 / 552960 : 𝕂) • (b * b * b * b * a * a * b * a)
  + (-16 / 552960 : 𝕂) • (b * b * b * b * a * b * a * a)
  + (4 / 552960 : 𝕂) • (b * b * b * b * b * a * a * a)

/-- **septic_d8_cross_V2_V3_poly**: V_2·V_3 cross deg-8 perturbation piece. Bilinear V_2·V_3 from C_5 (deg 3 + 1 + 2 + 2 = 8 from a length-5 nested-bracket with two z-positions).

CAS-derived; denominator 1105920, 174 terms,
Σ|num|/LCM = 13814/1105920 ≈ 0.0125. -/
noncomputable def septic_d8_cross_V2_V3_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-7 / 1105920 : 𝕂) • (a * a * a * a * a * b * a * b)
  + (7 / 1105920 : 𝕂) • (a * a * a * a * a * b * b * a)
  + (30 / 1105920 : 𝕂) • (a * a * a * a * b * a * a * b)
  + (-25 / 1105920 : 𝕂) • (a * a * a * a * b * a * b * a)
  + (-5 / 1105920 : 𝕂) • (a * a * a * a * b * b * a * a)
  + (14 / 1105920 : 𝕂) • (a * a * a * a * b * b * a * b)
  + (-14 / 1105920 : 𝕂) • (a * a * a * a * b * b * b * a)
  + (-50 / 1105920 : 𝕂) • (a * a * a * b * a * a * a * b)
  + (30 / 1105920 : 𝕂) • (a * a * a * b * a * a * b * a)
  + (20 / 1105920 : 𝕂) • (a * a * a * b * a * a * b * b)
  + (20 / 1105920 : 𝕂) • (a * a * a * b * a * b * a * a)
  + (-126 / 1105920 : 𝕂) • (a * a * a * b * a * b * a * b)
  + (86 / 1105920 : 𝕂) • (a * a * a * b * a * b * b * a)
  + (24 / 1105920 : 𝕂) • (a * a * a * b * a * b * b * b)
  + (60 / 1105920 : 𝕂) • (a * a * a * b * b * a * a * b)
  + (-50 / 1105920 : 𝕂) • (a * a * a * b * b * a * b * a)
  + (10 / 1105920 : 𝕂) • (a * a * a * b * b * b * a * a)
  + (-28 / 1105920 : 𝕂) • (a * a * a * b * b * b * a * b)
  + (4 / 1105920 : 𝕂) • (a * a * a * b * b * b * b * a)
  + (45 / 1105920 : 𝕂) • (a * a * b * a * a * a * a * b)
  + (-30 / 1105920 : 𝕂) • (a * a * b * a * a * a * b * a)
  + (-90 / 1105920 : 𝕂) • (a * a * b * a * a * a * b * b)
  + (364 / 1105920 : 𝕂) • (a * a * b * a * a * b * a * b)
  + (-154 / 1105920 : 𝕂) • (a * a * b * a * a * b * b * a)
  + (-60 / 1105920 : 𝕂) • (a * a * b * a * a * b * b * b)
  + (-20 / 1105920 : 𝕂) • (a * a * b * a * b * a * a * a)
  + (-190 / 1105920 : 𝕂) • (a * a * b * a * b * a * a * b)
  + (30 / 1105920 : 𝕂) • (a * a * b * a * b * a * b * a)
  + (36 / 1105920 : 𝕂) • (a * a * b * a * b * a * b * b)
  + (10 / 1105920 : 𝕂) • (a * a * b * a * b * b * a * a)
  + (56 / 1105920 : 𝕂) • (a * a * b * a * b * b * a * b)
  + (-44 / 1105920 : 𝕂) • (a * a * b * a * b * b * b * a)
  + (-8 / 1105920 : 𝕂) • (a * a * b * a * b * b * b * b)
  + (5 / 1105920 : 𝕂) • (a * a * b * b * a * a * a * a)
  + (-20 / 1105920 : 𝕂) • (a * a * b * b * a * a * a * b)
  + (70 / 1105920 : 𝕂) • (a * a * b * b * a * a * b * a)
  + (-72 / 1105920 : 𝕂) • (a * a * b * b * a * a * b * b)
  + (-10 / 1105920 : 𝕂) • (a * a * b * b * a * b * a * a)
  + (44 / 1105920 : 𝕂) • (a * a * b * b * a * b * a * b)
  + (64 / 1105920 : 𝕂) • (a * a * b * b * a * b * b * a)
  + (-10 / 1105920 : 𝕂) • (a * a * b * b * b * a * a * a)
  + (8 / 1105920 : 𝕂) • (a * a * b * b * b * a * a * b)
  + (-32 / 1105920 : 𝕂) • (a * a * b * b * b * a * b * a)
  + (8 / 1105920 : 𝕂) • (a * a * b * b * b * b * a * b)
  + (-18 / 1105920 : 𝕂) • (a * b * a * a * a * a * a * b)
  + (106 / 1105920 : 𝕂) • (a * b * a * a * a * a * b * b)
  + (30 / 1105920 : 𝕂) • (a * b * a * a * a * b * a * a)
  + (-290 / 1105920 : 𝕂) • (a * b * a * a * a * b * a * b)
  + (46 / 1105920 : 𝕂) • (a * b * a * a * a * b * b * a)
  + (4 / 1105920 : 𝕂) • (a * b * a * a * a * b * b * b)
  + (-30 / 1105920 : 𝕂) • (a * b * a * a * b * a * a * a)
  + (-84 / 1105920 : 𝕂) • (a * b * a * a * b * a * a * b)
  + (310 / 1105920 : 𝕂) • (a * b * a * a * b * a * b * a)
  + (-92 / 1105920 : 𝕂) • (a * b * a * a * b * a * b * b)
  + (-70 / 1105920 : 𝕂) • (a * b * a * a * b * b * a * a)
  + (156 / 1105920 : 𝕂) • (a * b * a * a * b * b * a * b)
  + (44 / 1105920 : 𝕂) • (a * b * a * a * b * b * b * a)
  + (40 / 1105920 : 𝕂) • (a * b * a * a * b * b * b * b)
  + (25 / 1105920 : 𝕂) • (a * b * a * b * a * a * a * a)
  + (286 / 1105920 : 𝕂) • (a * b * a * b * a * a * a * b)
  + (-310 / 1105920 : 𝕂) • (a * b * a * b * a * a * b * a)
  + (376 / 1105920 : 𝕂) • (a * b * a * b * a * a * b * b)
  + (-30 / 1105920 : 𝕂) • (a * b * a * b * a * b * a * a)
  + (-576 / 1105920 : 𝕂) • (a * b * a * b * a * b * a * b)
  + (-64 / 1105920 : 𝕂) • (a * b * a * b * a * b * b * a)
  + (-32 / 1105920 : 𝕂) • (a * b * a * b * a * b * b * b)
  + (50 / 1105920 : 𝕂) • (a * b * a * b * b * a * a * a)
  + (76 / 1105920 : 𝕂) • (a * b * a * b * b * a * a * b)
  + (-48 / 1105920 : 𝕂) • (a * b * a * b * b * a * b * b)
  + (32 / 1105920 : 𝕂) • (a * b * a * b * b * b * a * a)
  + (16 / 1105920 : 𝕂) • (a * b * a * b * b * b * b * a)
  + (-7 / 1105920 : 𝕂) • (a * b * b * a * a * a * a * a)
  + (-50 / 1105920 : 𝕂) • (a * b * b * a * a * a * a * b)
  + (-46 / 1105920 : 𝕂) • (a * b * b * a * a * a * b * a)
  + (-152 / 1105920 : 𝕂) • (a * b * b * a * a * a * b * b)
  + (154 / 1105920 : 𝕂) • (a * b * b * a * a * b * a * a)
  + (224 / 1105920 : 𝕂) • (a * b * b * a * a * b * a * b)
  + (-16 / 1105920 : 𝕂) • (a * b * b * a * a * b * b * b)
  + (-86 / 1105920 : 𝕂) • (a * b * b * a * b * a * a * a)
  + (-12 / 1105920 : 𝕂) • (a * b * b * a * b * a * a * b)
  + (64 / 1105920 : 𝕂) • (a * b * b * a * b * a * b * a)
  + (96 / 1105920 : 𝕂) • (a * b * b * a * b * a * b * b)
  + (-64 / 1105920 : 𝕂) • (a * b * b * a * b * b * a * a)
  + (48 / 1105920 : 𝕂) • (a * b * b * a * b * b * a * b)
  + (-80 / 1105920 : 𝕂) • (a * b * b * a * b * b * b * a)
  + (14 / 1105920 : 𝕂) • (a * b * b * b * a * a * a * a)
  + (-12 / 1105920 : 𝕂) • (a * b * b * b * a * a * a * b)
  + (-44 / 1105920 : 𝕂) • (a * b * b * b * a * a * b * a)
  + (-16 / 1105920 : 𝕂) • (a * b * b * b * a * a * b * b)
  + (44 / 1105920 : 𝕂) • (a * b * b * b * a * b * a * a)
  + (-96 / 1105920 : 𝕂) • (a * b * b * b * a * b * a * b)
  + (80 / 1105920 : 𝕂) • (a * b * b * b * a * b * b * a)
  + (-4 / 1105920 : 𝕂) • (a * b * b * b * b * a * a * a)
  + (24 / 1105920 : 𝕂) • (a * b * b * b * b * a * a * b)
  + (-16 / 1105920 : 𝕂) • (a * b * b * b * b * a * b * a)
  + (18 / 1105920 : 𝕂) • (b * a * a * a * a * a * b * a)
  + (-36 / 1105920 : 𝕂) • (b * a * a * a * a * a * b * b)
  + (-45 / 1105920 : 𝕂) • (b * a * a * a * a * b * a * a)
  + (24 / 1105920 : 𝕂) • (b * a * a * a * a * b * a * b)
  + (50 / 1105920 : 𝕂) • (b * a * a * a * a * b * b * a)
  + (32 / 1105920 : 𝕂) • (b * a * a * a * a * b * b * b)
  + (50 / 1105920 : 𝕂) • (b * a * a * a * b * a * a * a)
  + (240 / 1105920 : 𝕂) • (b * a * a * a * b * a * a * b)
  + (-286 / 1105920 : 𝕂) • (b * a * a * a * b * a * b * a)
  + (-16 / 1105920 : 𝕂) • (b * a * a * a * b * a * b * b)
  + (20 / 1105920 : 𝕂) • (b * a * a * a * b * b * a * a)
  + (-128 / 1105920 : 𝕂) • (b * a * a * a * b * b * a * b)
  + (12 / 1105920 : 𝕂) • (b * a * a * a * b * b * b * a)
  + (-32 / 1105920 : 𝕂) • (b * a * a * a * b * b * b * b)
  + (-30 / 1105920 : 𝕂) • (b * a * a * b * a * a * a * a)
  + (-240 / 1105920 : 𝕂) • (b * a * a * b * a * a * a * b)
  + (84 / 1105920 : 𝕂) • (b * a * a * b * a * a * b * a)
  + (-88 / 1105920 : 𝕂) • (b * a * a * b * a * a * b * b)
  + (190 / 1105920 : 𝕂) • (b * a * a * b * a * b * a * a)
  + (304 / 1105920 : 𝕂) • (b * a * a * b * a * b * a * b)
  + (12 / 1105920 : 𝕂) • (b * a * a * b * a * b * b * a)
  + (64 / 1105920 : 𝕂) • (b * a * a * b * a * b * b * b)
  + (-60 / 1105920 : 𝕂) • (b * a * a * b * b * a * a * a)
  + (-76 / 1105920 : 𝕂) • (b * a * a * b * b * a * b * a)
  + (48 / 1105920 : 𝕂) • (b * a * a * b * b * a * b * b)
  + (-8 / 1105920 : 𝕂) • (b * a * a * b * b * b * a * a)
  + (-32 / 1105920 : 𝕂) • (b * a * a * b * b * b * a * b)
  + (-24 / 1105920 : 𝕂) • (b * a * a * b * b * b * b * a)
  + (7 / 1105920 : 𝕂) • (b * a * b * a * a * a * a * a)
  + (-24 / 1105920 : 𝕂) • (b * a * b * a * a * a * a * b)
  + (290 / 1105920 : 𝕂) • (b * a * b * a * a * a * b * a)
  + (8 / 1105920 : 𝕂) • (b * a * b * a * a * a * b * b)
  + (-364 / 1105920 : 𝕂) • (b * a * b * a * a * b * a * a)
  + (-224 / 1105920 : 𝕂) • (b * a * b * a * a * b * b * a)
  + (-96 / 1105920 : 𝕂) • (b * a * b * a * a * b * b * b)
  + (126 / 1105920 : 𝕂) • (b * a * b * a * b * a * a * a)
  + (-304 / 1105920 : 𝕂) • (b * a * b * a * b * a * a * b)
  + (576 / 1105920 : 𝕂) • (b * a * b * a * b * a * b * a)
  + (-44 / 1105920 : 𝕂) • (b * a * b * a * b * b * a * a)
  + (96 / 1105920 : 𝕂) • (b * a * b * a * b * b * b * a)
  + (-14 / 1105920 : 𝕂) • (b * a * b * b * a * a * a * a)
  + (128 / 1105920 : 𝕂) • (b * a * b * b * a * a * a * b)
  + (-156 / 1105920 : 𝕂) • (b * a * b * b * a * a * b * a)
  + (-56 / 1105920 : 𝕂) • (b * a * b * b * a * b * a * a)
  + (-48 / 1105920 : 𝕂) • (b * a * b * b * a * b * b * a)
  + (28 / 1105920 : 𝕂) • (b * a * b * b * b * a * a * a)
  + (32 / 1105920 : 𝕂) • (b * a * b * b * b * a * a * b)
  + (-8 / 1105920 : 𝕂) • (b * a * b * b * b * b * a * a)
  + (36 / 1105920 : 𝕂) • (b * b * a * a * a * a * a * b)
  + (-106 / 1105920 : 𝕂) • (b * b * a * a * a * a * b * a)
  + (90 / 1105920 : 𝕂) • (b * b * a * a * a * b * a * a)
  + (-8 / 1105920 : 𝕂) • (b * b * a * a * a * b * a * b)
  + (152 / 1105920 : 𝕂) • (b * b * a * a * a * b * b * a)
  + (80 / 1105920 : 𝕂) • (b * b * a * a * a * b * b * b)
  + (-20 / 1105920 : 𝕂) • (b * b * a * a * b * a * a * a)
  + (88 / 1105920 : 𝕂) • (b * b * a * a * b * a * a * b)
  + (-376 / 1105920 : 𝕂) • (b * b * a * a * b * a * b * a)
  + (-144 / 1105920 : 𝕂) • (b * b * a * a * b * a * b * b)
  + (72 / 1105920 : 𝕂) • (b * b * a * a * b * b * a * a)
  + (16 / 1105920 : 𝕂) • (b * b * a * a * b * b * b * a)
  + (16 / 1105920 : 𝕂) • (b * b * a * b * a * a * a * b)
  + (92 / 1105920 : 𝕂) • (b * b * a * b * a * a * b * a)
  + (144 / 1105920 : 𝕂) • (b * b * a * b * a * a * b * b)
  + (-36 / 1105920 : 𝕂) • (b * b * a * b * a * b * a * a)
  + (-96 / 1105920 : 𝕂) • (b * b * a * b * a * b * b * a)
  + (-48 / 1105920 : 𝕂) • (b * b * a * b * b * a * a * b)
  + (48 / 1105920 : 𝕂) • (b * b * a * b * b * a * b * a)
  + (-32 / 1105920 : 𝕂) • (b * b * b * a * a * a * a * b)
  + (-4 / 1105920 : 𝕂) • (b * b * b * a * a * a * b * a)
  + (-80 / 1105920 : 𝕂) • (b * b * b * a * a * a * b * b)
  + (60 / 1105920 : 𝕂) • (b * b * b * a * a * b * a * a)
  + (96 / 1105920 : 𝕂) • (b * b * b * a * a * b * a * b)
  + (16 / 1105920 : 𝕂) • (b * b * b * a * a * b * b * a)
  + (-24 / 1105920 : 𝕂) • (b * b * b * a * b * a * a * a)
  + (-64 / 1105920 : 𝕂) • (b * b * b * a * b * a * a * b)
  + (32 / 1105920 : 𝕂) • (b * b * b * a * b * a * b * a)
  + (32 / 1105920 : 𝕂) • (b * b * b * b * a * a * a * b)
  + (-40 / 1105920 : 𝕂) • (b * b * b * b * a * a * b * a)
  + (8 / 1105920 : 𝕂) • (b * b * b * b * a * b * a * a)

/-- **septic_d8_cross_V2_V4_poly**: V_2·V_4 cross deg-8 perturbation piece. Bilinear V_2·V_4 from C_4 (deg 2 + 1 + 1 + 4 = 8).

CAS-derived; denominator 36864, 40 terms,
Σ|num|/LCM = 128/36864 ≈ 0.0035. -/
noncomputable def septic_d8_cross_V2_V4_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-1 / 36864 : 𝕂) • (a * a * a * a * b * b * a * b)
  + (1 / 36864 : 𝕂) • (a * a * a * a * b * b * b * a)
  + (-1 / 36864 : 𝕂) • (a * a * a * b * a * a * b * b)
  + (4 / 36864 : 𝕂) • (a * a * a * b * a * b * a * b)
  + (-2 / 36864 : 𝕂) • (a * a * a * b * a * b * b * a)
  + (2 / 36864 : 𝕂) • (a * a * a * b * b * a * a * b)
  + (-4 / 36864 : 𝕂) • (a * a * a * b * b * a * b * a)
  + (1 / 36864 : 𝕂) • (a * a * a * b * b * b * a * a)
  + (3 / 36864 : 𝕂) • (a * a * b * a * a * a * b * b)
  + (-6 / 36864 : 𝕂) • (a * a * b * a * a * b * a * b)
  + (-6 / 36864 : 𝕂) • (a * a * b * a * b * a * a * b)
  + (12 / 36864 : 𝕂) • (a * a * b * a * b * a * b * a)
  + (-3 / 36864 : 𝕂) • (a * a * b * a * b * b * a * a)
  + (1 / 36864 : 𝕂) • (a * a * b * b * a * a * a * b)
  + (-3 / 36864 : 𝕂) • (a * a * b * b * a * a * b * a)
  + (3 / 36864 : 𝕂) • (a * a * b * b * a * b * a * a)
  + (-1 / 36864 : 𝕂) • (a * a * b * b * b * a * a * a)
  + (-2 / 36864 : 𝕂) • (a * b * a * a * a * a * b * b)
  + (4 / 36864 : 𝕂) • (a * b * a * a * a * b * a * b)
  + (-2 / 36864 : 𝕂) • (a * b * a * a * a * b * b * a)
  + (3 / 36864 : 𝕂) • (a * b * a * a * b * b * a * a)
  + (4 / 36864 : 𝕂) • (a * b * a * b * a * a * a * b)
  + (-12 / 36864 : 𝕂) • (a * b * a * b * a * b * a * a)
  + (4 / 36864 : 𝕂) • (a * b * a * b * b * a * a * a)
  + (-2 / 36864 : 𝕂) • (a * b * b * a * a * a * a * b)
  + (2 / 36864 : 𝕂) • (a * b * b * a * a * a * b * a)
  + (2 / 36864 : 𝕂) • (a * b * b * a * b * a * a * a)
  + (-1 / 36864 : 𝕂) • (a * b * b * b * a * a * a * a)
  + (2 / 36864 : 𝕂) • (b * a * a * a * a * b * b * a)
  + (-4 / 36864 : 𝕂) • (b * a * a * a * b * a * b * a)
  + (-1 / 36864 : 𝕂) • (b * a * a * a * b * b * a * a)
  + (6 / 36864 : 𝕂) • (b * a * a * b * a * b * a * a)
  + (-2 / 36864 : 𝕂) • (b * a * a * b * b * a * a * a)
  + (-4 / 36864 : 𝕂) • (b * a * b * a * a * a * b * a)
  + (6 / 36864 : 𝕂) • (b * a * b * a * a * b * a * a)
  + (-4 / 36864 : 𝕂) • (b * a * b * a * b * a * a * a)
  + (1 / 36864 : 𝕂) • (b * a * b * b * a * a * a * a)
  + (2 / 36864 : 𝕂) • (b * b * a * a * a * a * b * a)
  + (-3 / 36864 : 𝕂) • (b * b * a * a * a * b * a * a)
  + (1 / 36864 : 𝕂) • (b * b * a * a * b * a * a * a)

/-- **septic_d8_cross_V2_V5_poly**: V_2·V_5 cross deg-8 perturbation piece. Bilinear V_2·V_5 from C_3 (deg 1 + 2 + 5 = 8).

CAS-derived; denominator 1105920, 154 terms,
Σ|num|/LCM = 6294/1105920 ≈ 0.0057. -/
noncomputable def septic_d8_cross_V2_V5_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (-1 / 1105920 : 𝕂) • (a * a * a * a * a * b * a * b)
  + (1 / 1105920 : 𝕂) • (a * a * a * a * a * b * b * a)
  + (6 / 1105920 : 𝕂) • (a * a * a * a * b * a * a * b)
  + (-7 / 1105920 : 𝕂) • (a * a * a * a * b * a * b * a)
  + (1 / 1105920 : 𝕂) • (a * a * a * a * b * b * a * a)
  + (8 / 1105920 : 𝕂) • (a * a * a * a * b * b * a * b)
  + (-8 / 1105920 : 𝕂) • (a * a * a * a * b * b * b * a)
  + (-14 / 1105920 : 𝕂) • (a * a * a * b * a * a * a * b)
  + (18 / 1105920 : 𝕂) • (a * a * a * b * a * a * b * a)
  + (-4 / 1105920 : 𝕂) • (a * a * a * b * a * b * a * a)
  + (-12 / 1105920 : 𝕂) • (a * a * a * b * a * b * a * b)
  + (12 / 1105920 : 𝕂) • (a * a * a * b * a * b * b * a)
  + (-28 / 1105920 : 𝕂) • (a * a * a * b * b * a * a * b)
  + (36 / 1105920 : 𝕂) • (a * a * a * b * b * a * b * a)
  + (-8 / 1105920 : 𝕂) • (a * a * a * b * b * b * a * a)
  + (16 / 1105920 : 𝕂) • (a * a * a * b * b * b * a * b)
  + (-16 / 1105920 : 𝕂) • (a * a * a * b * b * b * b * a)
  + (15 / 1105920 : 𝕂) • (a * a * b * a * a * a * a * b)
  + (-18 / 1105920 : 𝕂) • (a * a * b * a * a * a * b * a)
  + (8 / 1105920 : 𝕂) • (a * a * b * a * a * a * b * b)
  + (-24 / 1105920 : 𝕂) • (a * a * b * a * a * b * a * b)
  + (16 / 1105920 : 𝕂) • (a * a * b * a * a * b * b * b)
  + (4 / 1105920 : 𝕂) • (a * a * b * a * b * a * a * a)
  + (60 / 1105920 : 𝕂) • (a * a * b * a * b * a * a * b)
  + (-36 / 1105920 : 𝕂) • (a * a * b * a * b * a * b * a)
  + (-24 / 1105920 : 𝕂) • (a * a * b * a * b * a * b * b)
  + (-48 / 1105920 : 𝕂) • (a * a * b * a * b * b * a * b)
  + (40 / 1105920 : 𝕂) • (a * a * b * a * b * b * b * a)
  + (-8 / 1105920 : 𝕂) • (a * a * b * a * b * b * b * b)
  + (-1 / 1105920 : 𝕂) • (a * a * b * b * a * a * a * a)
  + (20 / 1105920 : 𝕂) • (a * a * b * b * a * a * a * b)
  + (-36 / 1105920 : 𝕂) • (a * a * b * b * a * a * b * a)
  + (-24 / 1105920 : 𝕂) • (a * a * b * b * a * a * b * b)
  + (72 / 1105920 : 𝕂) • (a * a * b * b * a * b * a * b)
  + (32 / 1105920 : 𝕂) • (a * a * b * b * a * b * b * b)
  + (8 / 1105920 : 𝕂) • (a * a * b * b * b * a * a * a)
  + (-40 / 1105920 : 𝕂) • (a * a * b * b * b * a * a * b)
  + (8 / 1105920 : 𝕂) • (a * a * b * b * b * a * b * a)
  + (-48 / 1105920 : 𝕂) • (a * a * b * b * b * a * b * b)
  + (24 / 1105920 : 𝕂) • (a * a * b * b * b * b * a * b)
  + (-6 / 1105920 : 𝕂) • (a * b * a * a * a * a * a * b)
  + (-24 / 1105920 : 𝕂) • (a * b * a * a * a * a * b * b)
  + (18 / 1105920 : 𝕂) • (a * b * a * a * a * b * a * a)
  + (44 / 1105920 : 𝕂) • (a * b * a * a * a * b * a * b)
  + (36 / 1105920 : 𝕂) • (a * b * a * a * a * b * b * a)
  + (-48 / 1105920 : 𝕂) • (a * b * a * a * a * b * b * b)
  + (-18 / 1105920 : 𝕂) • (a * b * a * a * b * a * a * a)
  + (48 / 1105920 : 𝕂) • (a * b * a * a * b * a * a * b)
  + (-180 / 1105920 : 𝕂) • (a * b * a * a * b * a * b * a)
  + (72 / 1105920 : 𝕂) • (a * b * a * a * b * a * b * b)
  + (36 / 1105920 : 𝕂) • (a * b * a * a * b * b * a * a)
  + (48 / 1105920 : 𝕂) • (a * b * a * a * b * b * a * b)
  + (-8 / 1105920 : 𝕂) • (a * b * a * a * b * b * b * a)
  + (24 / 1105920 : 𝕂) • (a * b * a * a * b * b * b * b)
  + (7 / 1105920 : 𝕂) • (a * b * a * b * a * a * a * a)
  + (-132 / 1105920 : 𝕂) • (a * b * a * b * a * a * a * b)
  + (180 / 1105920 : 𝕂) • (a * b * a * b * a * a * b * a)
  + (72 / 1105920 : 𝕂) • (a * b * a * b * a * a * b * b)
  + (36 / 1105920 : 𝕂) • (a * b * a * b * a * b * a * a)
  + (-192 / 1105920 : 𝕂) • (a * b * a * b * a * b * a * b)
  + (-48 / 1105920 : 𝕂) • (a * b * a * b * a * b * b * a)
  + (-96 / 1105920 : 𝕂) • (a * b * a * b * a * b * b * b)
  + (-36 / 1105920 : 𝕂) • (a * b * a * b * b * a * a * a)
  + (96 / 1105920 : 𝕂) • (a * b * a * b * b * a * a * b)
  + (144 / 1105920 : 𝕂) • (a * b * a * b * b * a * b * b)
  + (-8 / 1105920 : 𝕂) • (a * b * a * b * b * b * a * a)
  + (-64 / 1105920 : 𝕂) • (a * b * a * b * b * b * a * b)
  + (-16 / 1105920 : 𝕂) • (a * b * a * b * b * b * b * a)
  + (-1 / 1105920 : 𝕂) • (a * b * b * a * a * a * a * a)
  + (32 / 1105920 : 𝕂) • (a * b * b * a * a * a * a * b)
  + (-36 / 1105920 : 𝕂) • (a * b * b * a * a * a * b * a)
  + (-24 / 1105920 : 𝕂) • (a * b * b * a * a * b * a * b)
  + (-12 / 1105920 : 𝕂) • (a * b * b * a * b * a * a * a)
  + (24 / 1105920 : 𝕂) • (a * b * b * a * b * a * a * b)
  + (48 / 1105920 : 𝕂) • (a * b * b * a * b * a * b * a)
  + (-48 / 1105920 : 𝕂) • (a * b * b * a * b * b * a * b)
  + (80 / 1105920 : 𝕂) • (a * b * b * a * b * b * b * a)
  + (8 / 1105920 : 𝕂) • (a * b * b * b * a * a * a * a)
  + (-16 / 1105920 : 𝕂) • (a * b * b * b * a * a * a * b)
  + (8 / 1105920 : 𝕂) • (a * b * b * b * a * a * b * a)
  + (-40 / 1105920 : 𝕂) • (a * b * b * b * a * b * a * a)
  + (32 / 1105920 : 𝕂) • (a * b * b * b * a * b * a * b)
  + (-80 / 1105920 : 𝕂) • (a * b * b * b * a * b * b * a)
  + (16 / 1105920 : 𝕂) • (a * b * b * b * b * a * a * a)
  + (8 / 1105920 : 𝕂) • (a * b * b * b * b * a * a * b)
  + (16 / 1105920 : 𝕂) • (a * b * b * b * b * a * b * a)
  + (6 / 1105920 : 𝕂) • (b * a * a * a * a * a * b * a)
  + (16 / 1105920 : 𝕂) • (b * a * a * a * a * a * b * b)
  + (-15 / 1105920 : 𝕂) • (b * a * a * a * a * b * a * a)
  + (-24 / 1105920 : 𝕂) • (b * a * a * a * a * b * a * b)
  + (-32 / 1105920 : 𝕂) • (b * a * a * a * a * b * b * a)
  + (32 / 1105920 : 𝕂) • (b * a * a * a * a * b * b * b)
  + (14 / 1105920 : 𝕂) • (b * a * a * a * b * a * a * a)
  + (-40 / 1105920 : 𝕂) • (b * a * a * a * b * a * a * b)
  + (132 / 1105920 : 𝕂) • (b * a * a * a * b * a * b * a)
  + (-48 / 1105920 : 𝕂) • (b * a * a * a * b * a * b * b)
  + (-20 / 1105920 : 𝕂) • (b * a * a * a * b * b * a * a)
  + (-48 / 1105920 : 𝕂) • (b * a * a * a * b * b * a * b)
  + (16 / 1105920 : 𝕂) • (b * a * a * a * b * b * b * a)
  + (-16 / 1105920 : 𝕂) • (b * a * a * a * b * b * b * b)
  + (-6 / 1105920 : 𝕂) • (b * a * a * b * a * a * a * a)
  + (40 / 1105920 : 𝕂) • (b * a * a * b * a * a * a * b)
  + (-48 / 1105920 : 𝕂) • (b * a * a * b * a * a * b * a)
  + (-48 / 1105920 : 𝕂) • (b * a * a * b * a * a * b * b)
  + (-60 / 1105920 : 𝕂) • (b * a * a * b * a * b * a * a)
  + (192 / 1105920 : 𝕂) • (b * a * a * b * a * b * a * b)
  + (-24 / 1105920 : 𝕂) • (b * a * a * b * a * b * b * a)
  + (64 / 1105920 : 𝕂) • (b * a * a * b * a * b * b * b)
  + (28 / 1105920 : 𝕂) • (b * a * a * b * b * a * a * a)
  + (-96 / 1105920 : 𝕂) • (b * a * a * b * b * a * b * a)
  + (-96 / 1105920 : 𝕂) • (b * a * a * b * b * a * b * b)
  + (40 / 1105920 : 𝕂) • (b * a * a * b * b * b * a * a)
  + (64 / 1105920 : 𝕂) • (b * a * a * b * b * b * a * b)
  + (-8 / 1105920 : 𝕂) • (b * a * a * b * b * b * b * a)
  + (1 / 1105920 : 𝕂) • (b * a * b * a * a * a * a * a)
  + (24 / 1105920 : 𝕂) • (b * a * b * a * a * a * a * b)
  + (-44 / 1105920 : 𝕂) • (b * a * b * a * a * a * b * a)
  + (24 / 1105920 : 𝕂) • (b * a * b * a * a * b * a * a)
  + (24 / 1105920 : 𝕂) • (b * a * b * a * a * b * b * a)
  + (12 / 1105920 : 𝕂) • (b * a * b * a * b * a * a * a)
  + (-192 / 1105920 : 𝕂) • (b * a * b * a * b * a * a * b)
  + (192 / 1105920 : 𝕂) • (b * a * b * a * b * a * b * a)
  + (-72 / 1105920 : 𝕂) • (b * a * b * a * b * b * a * a)
  + (-32 / 1105920 : 𝕂) • (b * a * b * a * b * b * b * a)
  + (-8 / 1105920 : 𝕂) • (b * a * b * b * a * a * a * a)
  + (48 / 1105920 : 𝕂) • (b * a * b * b * a * a * a * b)
  + (-48 / 1105920 : 𝕂) • (b * a * b * b * a * a * b * a)
  + (48 / 1105920 : 𝕂) • (b * a * b * b * a * b * a * a)
  + (48 / 1105920 : 𝕂) • (b * a * b * b * a * b * b * a)
  + (-16 / 1105920 : 𝕂) • (b * a * b * b * b * a * a * a)
  + (-64 / 1105920 : 𝕂) • (b * a * b * b * b * a * a * b)
  + (64 / 1105920 : 𝕂) • (b * a * b * b * b * a * b * a)
  + (-24 / 1105920 : 𝕂) • (b * a * b * b * b * b * a * a)
  + (-16 / 1105920 : 𝕂) • (b * b * a * a * a * a * a * b)
  + (24 / 1105920 : 𝕂) • (b * b * a * a * a * a * b * a)
  + (-8 / 1105920 : 𝕂) • (b * b * a * a * a * b * a * a)
  + (48 / 1105920 : 𝕂) • (b * b * a * a * b * a * a * b)
  + (-72 / 1105920 : 𝕂) • (b * b * a * a * b * a * b * a)
  + (24 / 1105920 : 𝕂) • (b * b * a * a * b * b * a * a)
  + (48 / 1105920 : 𝕂) • (b * b * a * b * a * a * a * b)
  + (-72 / 1105920 : 𝕂) • (b * b * a * b * a * a * b * a)
  + (24 / 1105920 : 𝕂) • (b * b * a * b * a * b * a * a)
  + (96 / 1105920 : 𝕂) • (b * b * a * b * b * a * a * b)
  + (-144 / 1105920 : 𝕂) • (b * b * a * b * b * a * b * a)
  + (48 / 1105920 : 𝕂) • (b * b * a * b * b * b * a * a)
  + (-32 / 1105920 : 𝕂) • (b * b * b * a * a * a * a * b)
  + (48 / 1105920 : 𝕂) • (b * b * b * a * a * a * b * a)
  + (-16 / 1105920 : 𝕂) • (b * b * b * a * a * b * a * a)
  + (-64 / 1105920 : 𝕂) • (b * b * b * a * b * a * a * b)
  + (96 / 1105920 : 𝕂) • (b * b * b * a * b * a * b * a)
  + (-32 / 1105920 : 𝕂) • (b * b * b * a * b * b * a * a)
  + (16 / 1105920 : 𝕂) • (b * b * b * b * a * a * a * b)
  + (-24 / 1105920 : 𝕂) • (b * b * b * b * a * a * b * a)
  + (8 / 1105920 : 𝕂) • (b * b * b * b * a * b * a * a)

/-- **septic_d8_cross_V3_V4_poly**: V_3·V_4 cross deg-8 perturbation piece. Bilinear V_3·V_4 from C_3 (deg 1 + 3 + 4 = 8).

CAS-derived; denominator 110592, 66 terms,
Σ|num|/LCM = 308/110592 ≈ 0.0028. -/
noncomputable def septic_d8_cross_V3_V4_poly (𝕂 : Type*) [RCLike 𝕂]
    {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) : 𝔸 :=
    (1 / 110592 : 𝕂) • (a * a * a * b * a * a * b * b)
  + (-2 / 110592 : 𝕂) • (a * a * a * b * a * b * a * b)
  + (1 / 110592 : 𝕂) • (a * a * a * b * b * a * a * b)
  + (2 / 110592 : 𝕂) • (a * a * a * b * b * a * b * b)
  + (-4 / 110592 : 𝕂) • (a * a * a * b * b * b * a * b)
  + (2 / 110592 : 𝕂) • (a * a * a * b * b * b * b * a)
  + (-4 / 110592 : 𝕂) • (a * a * b * a * a * a * b * b)
  + (8 / 110592 : 𝕂) • (a * a * b * a * a * b * a * b)
  + (1 / 110592 : 𝕂) • (a * a * b * a * a * b * b * a)
  + (-2 / 110592 : 𝕂) • (a * a * b * a * b * a * a * b)
  + (-6 / 110592 : 𝕂) • (a * a * b * a * b * a * b * a)
  + (-4 / 110592 : 𝕂) • (a * a * b * a * b * a * b * b)
  + (2 / 110592 : 𝕂) • (a * a * b * a * b * b * a * a)
  + (8 / 110592 : 𝕂) • (a * a * b * a * b * b * a * b)
  + (-4 / 110592 : 𝕂) • (a * a * b * a * b * b * b * a)
  + (-2 / 110592 : 𝕂) • (a * a * b * b * a * a * a * b)
  + (5 / 110592 : 𝕂) • (a * a * b * b * a * a * b * a)
  + (-2 / 110592 : 𝕂) • (a * a * b * b * a * a * b * b)
  + (-2 / 110592 : 𝕂) • (a * a * b * b * a * b * a * a)
  + (4 / 110592 : 𝕂) • (a * a * b * b * a * b * a * b)
  + (-2 / 110592 : 𝕂) • (a * a * b * b * a * b * b * a)
  + (5 / 110592 : 𝕂) • (a * b * a * a * a * a * b * b)
  + (-10 / 110592 : 𝕂) • (a * b * a * a * a * b * a * b)
  + (-2 / 110592 : 𝕂) • (a * b * a * a * a * b * b * a)
  + (14 / 110592 : 𝕂) • (a * b * a * a * b * a * b * a)
  + (-5 / 110592 : 𝕂) • (a * b * a * a * b * b * a * a)
  + (6 / 110592 : 𝕂) • (a * b * a * b * a * a * a * b)
  + (-14 / 110592 : 𝕂) • (a * b * a * b * a * a * b * a)
  + (8 / 110592 : 𝕂) • (a * b * a * b * a * a * b * b)
  + (6 / 110592 : 𝕂) • (a * b * a * b * a * b * a * a)
  + (-16 / 110592 : 𝕂) • (a * b * a * b * a * b * a * b)
  + (8 / 110592 : 𝕂) • (a * b * a * b * a * b * b * a)
  + (-1 / 110592 : 𝕂) • (a * b * b * a * a * a * a * b)
  + (2 / 110592 : 𝕂) • (a * b * b * a * a * a * b * a)
  + (-4 / 110592 : 𝕂) • (a * b * b * a * a * a * b * b)
  + (-1 / 110592 : 𝕂) • (a * b * b * a * a * b * a * a)
  + (8 / 110592 : 𝕂) • (a * b * b * a * a * b * a * b)
  + (-8 / 110592 : 𝕂) • (a * b * b * a * b * a * b * a)
  + (2 / 110592 : 𝕂) • (a * b * b * a * b * b * a * a)
  + (4 / 110592 : 𝕂) • (a * b * b * b * a * b * a * a)
  + (-2 / 110592 : 𝕂) • (a * b * b * b * b * a * a * a)
  + (-2 / 110592 : 𝕂) • (b * a * a * a * a * a * b * b)
  + (4 / 110592 : 𝕂) • (b * a * a * a * a * b * a * b)
  + (1 / 110592 : 𝕂) • (b * a * a * a * a * b * b * a)
  + (-6 / 110592 : 𝕂) • (b * a * a * a * b * a * b * a)
  + (2 / 110592 : 𝕂) • (b * a * a * a * b * b * a * a)
  + (2 / 110592 : 𝕂) • (b * a * a * b * a * b * a * a)
  + (-1 / 110592 : 𝕂) • (b * a * a * b * b * a * a * a)
  + (-4 / 110592 : 𝕂) • (b * a * b * a * a * a * a * b)
  + (10 / 110592 : 𝕂) • (b * a * b * a * a * a * b * a)
  + (-8 / 110592 : 𝕂) • (b * a * b * a * a * b * a * a)
  + (-8 / 110592 : 𝕂) • (b * a * b * a * a * b * b * a)
  + (2 / 110592 : 𝕂) • (b * a * b * a * b * a * a * a)
  + (16 / 110592 : 𝕂) • (b * a * b * a * b * a * b * a)
  + (-4 / 110592 : 𝕂) • (b * a * b * a * b * b * a * a)
  + (-8 / 110592 : 𝕂) • (b * a * b * b * a * b * a * a)
  + (4 / 110592 : 𝕂) • (b * a * b * b * b * a * a * a)
  + (2 / 110592 : 𝕂) • (b * b * a * a * a * a * a * b)
  + (-5 / 110592 : 𝕂) • (b * b * a * a * a * a * b * a)
  + (4 / 110592 : 𝕂) • (b * b * a * a * a * b * a * a)
  + (4 / 110592 : 𝕂) • (b * b * a * a * a * b * b * a)
  + (-1 / 110592 : 𝕂) • (b * b * a * a * b * a * a * a)
  + (-8 / 110592 : 𝕂) • (b * b * a * a * b * a * b * a)
  + (2 / 110592 : 𝕂) • (b * b * a * a * b * b * a * a)
  + (4 / 110592 : 𝕂) • (b * b * a * b * a * b * a * a)
  + (-2 / 110592 : 𝕂) • (b * b * a * b * b * a * a * a)

/-- **9-piece decomposition of `septic_d8_perturbation_poly`**.

CAS-verified at `scripts/verify_d8_operator_decomp.py`: the polynomial
`septic_d8_perturbation_poly(a, b)` equals the sum of 9 operator-form
pieces (P_2, P_3, P_4, P_5, P_6, Cross(V_2,V_3), Cross(V_2,V_4),
Cross(V_2,V_5), Cross(V_3,V_4)) defined above.

This is the polynomial-form Phase C-septic identity foundation, parallel
to `septic_d7_perturbation_poly_pieces_decomp`. The operator-form
Phase C-septic identity (where each piece equals a specific BCH-series
expression) will be established by separate `match_scalars` lemmas for
each piece in a follow-up session.

(Section-level `maxHeartbeats 64000000` covers this proof.) -/
private theorem septic_d8_perturbation_poly_pieces_decomp
    {𝕂 : Type*} [RCLike 𝕂] {𝔸 : Type*} [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸]
    (a b : 𝔸) :
    septic_d8_perturbation_poly 𝕂 a b =
      septic_d8_P2_poly 𝕂 a b + septic_d8_P3_poly 𝕂 a b +
        ...
        septic_d8_cross_V2_V5_poly 𝕂 a b + septic_d8_cross_V3_V4_poly 𝕂 a b := by
  unfold septic_d8_perturbation_poly
        septic_d8_P2_poly septic_d8_P3_poly septic_d8_P4_poly
        septic_d8_P5_poly septic_d8_P6_poly
        septic_d8_cross_V2_V3_poly septic_d8_cross_V2_V4_poly
...
Uniform per-term bound: 1280/276480·s⁷. Σ ≤ 116·1280/276480 =
148480/276480 ≈ 0.5370 ≤ 1, so `‖d7_perturbation‖ ≤ s⁷`.
(Actual Σ|num|/276480 ≈ 0.0509.)

Uses the `Finset.sum` approach mirroring `norm_symmetric_bch_septic_correction_poly_le`.
-/

-- Per-Nat-index family of terms in `septic_d7_perturbation_poly a b`.
set_option maxHeartbeats 1600000 in
private noncomputable def septicD7PerturbationTermN (a b : 𝔸) : Nat → 𝔸
  | 0 => (-9 / 276480 : 𝕂) • (a * a * a * a * a * a * b)
  | 1 => (54 / 276480 : 𝕂) • (a * a * a * a * a * b * a)
  | 2 => (43 / 276480 : 𝕂) • (a * a * a * a * a * b * b)
  | 3 => (-135 / 276480 : 𝕂) • (a * a * a * a * b * a * a)
  | 4 => (-122 / 276480 : 𝕂) • (a * a * a * a * b * a * b)
  | 5 => (-93 / 276480 : 𝕂) • (a * a * a * a * b * b * a)
  | 6 => (-64 / 276480 : 𝕂) • (a * a * a * a * b * b * b)
  | 7 => (180 / 276480 : 𝕂) • (a * a * a * b * a * a * a)
  | 8 => (120 / 276480 : 𝕂) • (a * a * a * b * a * a * b)
  | 9 => (248 / 276480 : 𝕂) • (a * a * a * b * a * b * a)
  | 10 => (108 / 276480 : 𝕂) • (a * a * a * b * a * b * b)
  | 11 => (62 / 276480 : 𝕂) • (a * a * a * b * b * a * a)
  | 12 => (144 / 276480 : 𝕂) • (a * a * a * b * b * a * b)
  | 13 => (4 / 276480 : 𝕂) • (a * a * a * b * b * b * a)
  | 14 => (52 / 276480 : 𝕂) • (a * a * a * b * b * b * b)
  | 15 => (-135 / 276480 : 𝕂) • (a * a * b * a * a * a * a)
  | 16 => (-120 / 276480 : 𝕂) • (a * a * b * a * a * a * b)
  | 17 => (76 / 276480 : 𝕂) • (a * a * b * a * a * b * b)
  | 18 => (-372 / 276480 : 𝕂) • (a * a * b * a * b * a * a)
  | 19 => (-512 / 276480 : 𝕂) • (a * a * b * a * b * a * b)
  | 20 => (36 / 276480 : 𝕂) • (a * a * b * a * b * b * a)
  | 21 => (-88 / 276480 : 𝕂) • (a * a * b * a * b * b * b)
  | 22 => (62 / 276480 : 𝕂) • (a * a * b * b * a * a * a)
  | 23 => (32 / 276480 : 𝕂) • (a * a * b * b * a * a * b)
  | 24 => (16 / 276480 : 𝕂) • (a * a * b * b * a * b * a)
  | 25 => (-8 / 276480 : 𝕂) • (a * a * b * b * a * b * b)
  | 26 => (-32 / 276480 : 𝕂) • (a * a * b * b * b * a * a)
  | 27 => (-128 / 276480 : 𝕂) • (a * a * b * b * b * a * b)
  | 28 => (68 / 276480 : 𝕂) • (a * a * b * b * b * b * a)
  | 29 => (-16 / 276480 : 𝕂) • (a * a * b * b * b * b * b)
  | 30 => (54 / 276480 : 𝕂) • (a * b * a * a * a * a * a)
  | 31 => (60 / 276480 : 𝕂) • (a * b * a * a * a * a * b)
  | 32 => (-68 / 276480 : 𝕂) • (a * b * a * a * a * b * b)
  | 33 => (232 / 276480 : 𝕂) • (a * b * a * a * b * a * b)
  | 34 => (-180 / 276480 : 𝕂) • (a * b * a * a * b * b * a)
  | 35 => (-40 / 276480 : 𝕂) • (a * b * a * a * b * b * b)
  | 36 => (248 / 276480 : 𝕂) • (a * b * a * b * a * a * a)
  | 37 => (152 / 276480 : 𝕂) • (a * b * a * b * a * a * b)
  | 38 => (256 / 276480 : 𝕂) • (a * b * a * b * a * b * a)
  | 39 => (160 / 276480 : 𝕂) • (a * b * a * b * a * b * b)
  | 40 => (16 / 276480 : 𝕂) • (a * b * a * b * b * a * a)
  | 41 => (160 / 276480 : 𝕂) • (a * b * a * b * b * a * b)
  | 42 => (-64 / 276480 : 𝕂) • (a * b * a * b * b * b * a)
  | 43 => (32 / 276480 : 𝕂) • (a * b * a * b * b * b * b)
  | 44 => (-93 / 276480 : 𝕂) • (a * b * b * a * a * a * a)
  | 45 => (-12 / 276480 : 𝕂) • (a * b * b * a * a * a * b)
  | 46 => (-180 / 276480 : 𝕂) • (a * b * b * a * a * b * a)
  | 47 => (-160 / 276480 : 𝕂) • (a * b * b * a * a * b * b)
  | 48 => (36 / 276480 : 𝕂) • (a * b * b * a * b * a * a)
  | 49 => (320 / 276480 : 𝕂) • (a * b * b * a * b * a * b)
  | 50 => (-144 / 276480 : 𝕂) • (a * b * b * a * b * b * a)
  | 51 => (16 / 276480 : 𝕂) • (a * b * b * a * b * b * b)
  | 52 => (4 / 276480 : 𝕂) • (a * b * b * b * a * a * a)
  | 53 => (-80 / 276480 : 𝕂) • (a * b * b * b * a * a * b)
  | 54 => (-64 / 276480 : 𝕂) • (a * b * b * b * a * b * a)
  | 55 => (-64 / 276480 : 𝕂) • (a * b * b * b * a * b * b)
  | 56 => (68 / 276480 : 𝕂) • (a * b * b * b * b * a * a)
  | 57 => (80 / 276480 : 𝕂) • (a * b * b * b * b * a * b)
  | 58 => (-32 / 276480 : 𝕂) • (a * b * b * b * b * b * a)
  | 59 => (-9 / 276480 : 𝕂) • (b * a * a * a * a * a * a)
  | 60 => (-24 / 276480 : 𝕂) • (b * a * a * a * a * a * b)
  | 61 => (60 / 276480 : 𝕂) • (b * a * a * a * a * b * a)
  | 62 => (76 / 276480 : 𝕂) • (b * a * a * a * a * b * b)
  | 63 => (-120 / 276480 : 𝕂) • (b * a * a * a * b * a * a)
  | 64 => (-224 / 276480 : 𝕂) • (b * a * a * a * b * a * b)
  | 65 => (-12 / 276480 : 𝕂) • (b * a * a * a * b * b * a)
  | 66 => (-80 / 276480 : 𝕂) • (b * a * a * a * b * b * b)
  | 67 => (120 / 276480 : 𝕂) • (b * a * a * b * a * a * a)
  | 68 => (144 / 276480 : 𝕂) • (b * a * a * b * a * a * b)
  | 69 => (152 / 276480 : 𝕂) • (b * a * a * b * a * b * a)
  | 70 => (120 / 276480 : 𝕂) • (b * a * a * b * a * b * b)
  | 71 => (32 / 276480 : 𝕂) • (b * a * a * b * b * a * a)
  | 72 => (240 / 276480 : 𝕂) • (b * a * a * b * b * a * b)
  | 73 => (-80 / 276480 : 𝕂) • (b * a * a * b * b * b * a)
  | 74 => (48 / 276480 : 𝕂) • (b * a * a * b * b * b * b)
  | 75 => (-122 / 276480 : 𝕂) • (b * a * b * a * a * a * a)
  | 76 => (-224 / 276480 : 𝕂) • (b * a * b * a * a * a * b)
  | 77 => (232 / 276480 : 𝕂) • (b * a * b * a * a * b * a)
  | 78 => (280 / 276480 : 𝕂) • (b * a * b * a * a * b * b)
  | 79 => (-512 / 276480 : 𝕂) • (b * a * b * a * b * a * a)
  | 80 => (-1280 / 276480 : 𝕂) • (b * a * b * a * b * a * b)
  | 81 => (320 / 276480 : 𝕂) • (b * a * b * a * b * b * a)
  | 82 => (-160 / 276480 : 𝕂) • (b * a * b * a * b * b * b)
  | 83 => (144 / 276480 : 𝕂) • (b * a * b * b * a * a * a)
  | 84 => (240 / 276480 : 𝕂) • (b * a * b * b * a * a * b)
  | 85 => (160 / 276480 : 𝕂) • (b * a * b * b * a * b * a)
  | 86 => (144 / 276480 : 𝕂) • (b * a * b * b * a * b * b)
  | 87 => (-128 / 276480 : 𝕂) • (b * a * b * b * b * a * a)
  | 88 => (-192 / 276480 : 𝕂) • (b * a * b * b * b * a * b)
  | 89 => (80 / 276480 : 𝕂) • (b * a * b * b * b * b * a)
  | 90 => (43 / 276480 : 𝕂) • (b * b * a * a * a * a * a)
  | 91 => (76 / 276480 : 𝕂) • (b * b * a * a * a * a * b)
  | 92 => (-68 / 276480 : 𝕂) • (b * b * a * a * a * b * a)
  | 93 => (-80 / 276480 : 𝕂) • (b * b * a * a * a * b * b)
  | 94 => (76 / 276480 : 𝕂) • (b * b * a * a * b * a * a)
  | 95 => (280 / 276480 : 𝕂) • (b * b * a * a * b * a * b)
  | 96 => (-160 / 276480 : 𝕂) • (b * b * a * a * b * b * a)
  | 97 => (-16 / 276480 : 𝕂) • (b * b * a * a * b * b * b)
  | 98 => (108 / 276480 : 𝕂) • (b * b * a * b * a * a * a)
  | 99 => (120 / 276480 : 𝕂) • (b * b * a * b * a * a * b)
  | 100 => (160 / 276480 : 𝕂) • (b * b * a * b * a * b * a)
  | 101 => (96 / 276480 : 𝕂) • (b * b * a * b * a * b * b)
  | 102 => (-8 / 276480 : 𝕂) • (b * b * a * b * b * a * a)
  | 103 => (144 / 276480 : 𝕂) • (b * b * a * b * b * a * b)
  | 104 => (-64 / 276480 : 𝕂) • (b * b * a * b * b * b * a)
  | 105 => (-64 / 276480 : 𝕂) • (b * b * b * a * a * a * a)
  | 106 => (-80 / 276480 : 𝕂) • (b * b * b * a * a * a * b)
  | 107 => (-40 / 276480 : 𝕂) • (b * b * b * a * a * b * a)
  | 108 => (-16 / 276480 : 𝕂) • (b * b * b * a * a * b * b)
  | 109 => (-88 / 276480 : 𝕂) • (b * b * b * a * b * a * a)
  | 110 => (-160 / 276480 : 𝕂) • (b * b * b * a * b * a * b)
  | 111 => (16 / 276480 : 𝕂) • (b * b * b * a * b * b * a)
  | 112 => (52 / 276480 : 𝕂) • (b * b * b * b * a * a * a)
  | 113 => (48 / 276480 : 𝕂) • (b * b * b * b * a * a * b)
  | 114 => (32 / 276480 : 𝕂) • (b * b * b * b * a * b * a)
  | 115 => (-16 / 276480 : 𝕂) • (b * b * b * b * b * a * a)
  | _ => 0

/-- `Fin 116`-indexed wrapper around `septicD7PerturbationTermN`. -/
private noncomputable def septicD7PerturbationTerm (a b : 𝔸) (i : Fin 116) : 𝔸 :=
  septicD7PerturbationTermN (𝕂 := 𝕂) a b i.val

-- The 116-term sum equals `septic_d7_perturbation_poly`.
set_option maxHeartbeats 16000000 in
set_option maxRecDepth 2000 in
private theorem septic_d7_perturbation_poly_eq_sum (a b : 𝔸) :
    septic_d7_perturbation_poly 𝕂 a b =
      ∑ i : Fin 116, septicD7PerturbationTerm (𝕂 := 𝕂) a b i := by
  unfold septic_d7_perturbation_poly septicD7PerturbationTerm
  rw [Fin.sum_univ_eq_sum_range (fun k => septicD7PerturbationTermN (𝕂 := 𝕂) a b k)]
  simp only [Finset.sum_range_succ, Finset.sum_range_zero,
    septicD7PerturbationTermN, zero_add]

-- Per-index uniform bound: `‖septicD7PerturbationTerm a b i‖ ≤ (1280/276480) · s^7`
set_option maxHeartbeats 4000000 in
private lemma septicD7PerturbationTerm_norm_le (a b : 𝔸) (s : ℝ)
    (ha : ‖a‖ ≤ s) (hb : ‖b‖ ≤ s) (hs : 0 ≤ s) :
    ∀ i : Fin 116, ‖septicD7PerturbationTerm (𝕂 := 𝕂) a b i‖ ≤ (1280 / 276480 : ℝ) * s^7 := fun i =>
  match i with
  | ⟨0, _⟩ =>
    show ‖(-9 / 276480 : 𝕂) • (a * a * a * a * a * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-9 / 276480 : 𝕂) (1280 / 276480 : ℝ)
  ...
  | ⟨1, _⟩ =>
    show ‖(54 / 276480 : 𝕂) • (a * a * a * a * a * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (54 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a a a a a b a s ha ha ha ha ha hb ha (by norm_num) hs
  | ⟨2, _⟩ =>
    show ‖(43 / 276480 : 𝕂) • (a * a * a * a * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (43 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a a b b s ha ha ha ha ha hb hb (by norm_num) hs
  | ⟨3, _⟩ =>
    show ‖(-135 / 276480 : 𝕂) • (a * a * a * a * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-135 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a a a a b a a s ha ha ha ha hb ha ha (by norm_num) hs
  | ⟨4, _⟩ =>
    show ‖(-122 / 276480 : 𝕂) • (a * a * a * a * b * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-122 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b a b s ha ha ha ha hb ha hb (by norm_num) hs
  | ⟨5, _⟩ =>
    show ‖(-93 / 276480 : 𝕂) • (a * a * a * a * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-93 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b b a s ha ha ha ha hb hb ha (by norm_num) hs
  | ⟨6, _⟩ =>
    show ‖(-64 / 276480 : 𝕂) • (a * a * a * a * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-64 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a a b b b s ha ha ha ha hb hb hb (by norm_num) hs
  | ⟨7, _⟩ =>
    show ‖(180 / 276480 : 𝕂) • (a * a * a * b * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (180 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a a a b a a a s ha ha ha hb ha ha ha (by norm_num) hs
  | ⟨8, _⟩ =>
    show ‖(120 / 276480 : 𝕂) • (a * a * a * b * a * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (120 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a a b s ha ha ha hb ha ha hb (by norm_num) hs
  | ⟨9, _⟩ =>
    show ‖(248 / 276480 : 𝕂) • (a * a * a * b * a * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (248 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a b a s ha ha ha hb ha hb ha (by norm_num) hs
  | ⟨10, _⟩ =>
    show ‖(108 / 276480 : 𝕂) • (a * a * a * b * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (108 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b a b b s ha ha ha hb ha hb hb (by norm_num) hs
  | ⟨11, _⟩ =>
    show ‖(62 / 276480 : 𝕂) • (a * a * a * b * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (62 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a a a b b a a s ha ha ha hb hb ha ha (by norm_num) hs
  | ⟨12, _⟩ =>
    show ‖(144 / 276480 : 𝕂) • (a * a * a * b * b * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (144 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b a b s ha ha ha hb hb ha hb (by norm_num) hs
  | ⟨13, _⟩ =>
    show ‖(4 / 276480 : 𝕂) • (a * a * a * b * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (4 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b b a s ha ha ha hb hb hb ha (by norm_num) hs
  | ⟨14, _⟩ =>
    show ‖(52 / 276480 : 𝕂) • (a * a * a * b * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (52 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a a b b b b s ha ha ha hb hb hb hb (by norm_num) hs
  | ⟨15, _⟩ =>
    show ‖(-135 / 276480 : 𝕂) • (a * a * b * a * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-135 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a a b a a a a s ha ha hb ha ha ha ha (by norm_num) hs
  | ⟨16, _⟩ =>
    show ‖(-120 / 276480 : 𝕂) • (a * a * b * a * a * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-120 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a a a b s ha ha hb ha ha ha hb (by norm_num) hs
  | ⟨17, _⟩ =>
    show ‖(76 / 276480 : 𝕂) • (a * a * b * a * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (76 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a a b b s ha ha hb ha ha hb hb (by norm_num) hs
  | ⟨18, _⟩ =>
    show ‖(-372 / 276480 : 𝕂) • (a * a * b * a * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-372 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a a b a b a a s ha ha hb ha hb ha ha (by norm_num) hs
  | ⟨19, _⟩ =>
    show ‖(-512 / 276480 : 𝕂) • (a * a * b * a * b * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-512 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b a b s ha ha hb ha hb ha hb (by norm_num) hs
  | ⟨20, _⟩ =>
    show ‖(36 / 276480 : 𝕂) • (a * a * b * a * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (36 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b b a s ha ha hb ha hb hb ha (by norm_num) hs
  | ⟨21, _⟩ =>
    show ‖(-88 / 276480 : 𝕂) • (a * a * b * a * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-88 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b a b b b s ha ha hb ha hb hb hb (by norm_num) hs
  | ⟨22, _⟩ =>
    show ‖(62 / 276480 : 𝕂) • (a * a * b * b * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (62 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a a b b a a a s ha ha hb hb ha ha ha (by norm_num) hs
  | ⟨23, _⟩ =>
    show ‖(32 / 276480 : 𝕂) • (a * a * b * b * a * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (32 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a a b s ha ha hb hb ha ha hb (by norm_num) hs
  | ⟨24, _⟩ =>
    show ‖(16 / 276480 : 𝕂) • (a * a * b * b * a * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (16 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a b a s ha ha hb hb ha hb ha (by norm_num) hs
  | ⟨25, _⟩ =>
    show ‖(-8 / 276480 : 𝕂) • (a * a * b * b * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-8 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b a b b s ha ha hb hb ha hb hb (by norm_num) hs
  | ⟨26, _⟩ =>
    show ‖(-32 / 276480 : 𝕂) • (a * a * b * b * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-32 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a a b b b a a s ha ha hb hb hb ha ha (by norm_num) hs
  | ⟨27, _⟩ =>
    show ‖(-128 / 276480 : 𝕂) • (a * a * b * b * b * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-128 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b b a b s ha ha hb hb hb ha hb (by norm_num) hs
  | ⟨28, _⟩ =>
    show ‖(68 / 276480 : 𝕂) • (a * a * b * b * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (68 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a a b b b b a s ha ha hb hb hb hb ha (by norm_num) hs
  | ⟨29, _⟩ =>
  ...
  | ⟨33, _⟩ =>
    show ‖(232 / 276480 : 𝕂) • (a * b * a * a * b * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (232 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b a a b a b s ha hb ha ha hb ha hb (by norm_num) hs
  | ⟨34, _⟩ =>
    show ‖(-180 / 276480 : 𝕂) • (a * b * a * a * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-180 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a a b b a s ha hb ha ha hb hb ha (by norm_num) hs
  | ⟨35, _⟩ =>
    show ‖(-40 / 276480 : 𝕂) • (a * b * a * a * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-40 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b a a b b b s ha hb ha ha hb hb hb (by norm_num) hs
  | ⟨36, _⟩ =>
    show ‖(248 / 276480 : 𝕂) • (a * b * a * b * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (248 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a a a s ha hb ha hb ha ha ha (by norm_num) hs
  | ⟨37, _⟩ =>
    show ‖(152 / 276480 : 𝕂) • (a * b * a * b * a * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (152 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b a b a a b s ha hb ha hb ha ha hb (by norm_num) hs
  | ⟨38, _⟩ =>
    show ‖(256 / 276480 : 𝕂) • (a * b * a * b * a * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (256 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b a b a s ha hb ha hb ha hb ha (by norm_num) hs
  | ⟨39, _⟩ =>
    show ‖(160 / 276480 : 𝕂) • (a * b * a * b * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (160 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b a b a b b s ha hb ha hb ha hb hb (by norm_num) hs
  | ⟨40, _⟩ =>
    show ‖(16 / 276480 : 𝕂) • (a * b * a * b * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (16 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b b a a s ha hb ha hb hb ha ha (by norm_num) hs
  | ⟨41, _⟩ =>
    show ‖(160 / 276480 : 𝕂) • (a * b * a * b * b * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (160 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b a b b a b s ha hb ha hb hb ha hb (by norm_num) hs
  | ⟨42, _⟩ =>
    show ‖(-64 / 276480 : 𝕂) • (a * b * a * b * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-64 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b a b b b a s ha hb ha hb hb hb ha (by norm_num) hs
  | ⟨43, _⟩ =>
    show ‖(32 / 276480 : 𝕂) • (a * b * a * b * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (32 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b a b b b b s ha hb ha hb hb hb hb (by norm_num) hs
  | ⟨44, _⟩ =>
    show ‖(-93 / 276480 : 𝕂) • (a * b * b * a * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-93 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a a a a s ha hb hb ha ha ha ha (by norm_num) hs
  | ⟨45, _⟩ =>
    show ‖(-12 / 276480 : 𝕂) • (a * b * b * a * a * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-12 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b b a a a b s ha hb hb ha ha ha hb (by norm_num) hs
  | ⟨46, _⟩ =>
    show ‖(-180 / 276480 : 𝕂) • (a * b * b * a * a * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-180 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a a b a s ha hb hb ha ha hb ha (by norm_num) hs
  | ⟨47, _⟩ =>
    show ‖(-160 / 276480 : 𝕂) • (a * b * b * a * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-160 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b b a a b b s ha hb hb ha ha hb hb (by norm_num) hs
  | ⟨48, _⟩ =>
    show ‖(36 / 276480 : 𝕂) • (a * b * b * a * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (36 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b a a s ha hb hb ha hb ha ha (by norm_num) hs
  | ⟨49, _⟩ =>
    show ‖(320 / 276480 : 𝕂) • (a * b * b * a * b * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (320 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b b a b a b s ha hb hb ha hb ha hb (by norm_num) hs
  | ⟨50, _⟩ =>
    show ‖(-144 / 276480 : 𝕂) • (a * b * b * a * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-144 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b a b b a s ha hb hb ha hb hb ha (by norm_num) hs
  | ⟨51, _⟩ =>
    show ‖(16 / 276480 : 𝕂) • (a * b * b * a * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (16 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b b a b b b s ha hb hb ha hb hb hb (by norm_num) hs
  | ⟨52, _⟩ =>
    show ‖(4 / 276480 : 𝕂) • (a * b * b * b * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (4 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a a a s ha hb hb hb ha ha ha (by norm_num) hs
  | ⟨53, _⟩ =>
    show ‖(-80 / 276480 : 𝕂) • (a * b * b * b * a * a * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-80 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b b b a a b s ha hb hb hb ha ha hb (by norm_num) hs
  | ⟨54, _⟩ =>
    show ‖(-64 / 276480 : 𝕂) • (a * b * b * b * a * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-64 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b a b a s ha hb hb hb ha hb ha (by norm_num) hs
  | ⟨55, _⟩ =>
    show ‖(-64 / 276480 : 𝕂) • (a * b * b * b * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-64 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        a b b b a b b s ha hb hb hb ha hb hb (by norm_num) hs
  | ⟨56, _⟩ =>
    show ‖(68 / 276480 : 𝕂) • (a * b * b * b * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (68 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        a b b b b a a s ha hb hb hb hb ha ha (by norm_num) hs
  | ⟨57, _⟩ =>
  ...
  | ⟨62, _⟩ =>
    show ‖(76 / 276480 : 𝕂) • (b * a * a * a * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (76 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b a a a a b b s hb ha ha ha ha hb hb (by norm_num) hs
  | ⟨63, _⟩ =>
    show ‖(-120 / 276480 : 𝕂) • (b * a * a * a * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-120 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a a b a a s hb ha ha ha hb ha ha (by norm_num) hs
  | ⟨64, _⟩ =>
  ...
  | ⟨66, _⟩ =>
    show ‖(-80 / 276480 : 𝕂) • (b * a * a * a * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-80 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b a a a b b b s hb ha ha ha hb hb hb (by norm_num) hs
  | ⟨67, _⟩ =>
    show ‖(120 / 276480 : 𝕂) • (b * a * a * b * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (120 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b a a a s hb ha ha hb ha ha ha (by norm_num) hs
  | ⟨68, _⟩ =>
  ...
  | ⟨70, _⟩ =>
    show ‖(120 / 276480 : 𝕂) • (b * a * a * b * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (120 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b a a b a b b s hb ha ha hb ha hb hb (by norm_num) hs
  | ⟨71, _⟩ =>
    show ‖(32 / 276480 : 𝕂) • (b * a * a * b * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (32 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a a b b a a s hb ha ha hb hb ha ha (by norm_num) hs
  | ⟨72, _⟩ =>
  ...
  | ⟨74, _⟩ =>
    show ‖(48 / 276480 : 𝕂) • (b * a * a * b * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (48 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b a a b b b b s hb ha ha hb hb hb hb (by norm_num) hs
  | ⟨75, _⟩ =>
    show ‖(-122 / 276480 : 𝕂) • (b * a * b * a * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-122 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a a a a s hb ha hb ha ha ha ha (by norm_num) hs
  | ⟨76, _⟩ =>
  ...
  | ⟨78, _⟩ =>
    show ‖(280 / 276480 : 𝕂) • (b * a * b * a * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (280 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b a b a a b b s hb ha hb ha ha hb hb (by norm_num) hs
  | ⟨79, _⟩ =>
    show ‖(-512 / 276480 : 𝕂) • (b * a * b * a * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-512 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b a b a a s hb ha hb ha hb ha ha (by norm_num) hs
  | ⟨80, _⟩ =>
  ...
  | ⟨82, _⟩ =>
    show ‖(-160 / 276480 : 𝕂) • (b * a * b * a * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-160 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b a b a b b b s hb ha hb ha hb hb hb (by norm_num) hs
  | ⟨83, _⟩ =>
    show ‖(144 / 276480 : 𝕂) • (b * a * b * b * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (144 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b a a a s hb ha hb hb ha ha ha (by norm_num) hs
  | ⟨84, _⟩ =>
  ...
  | ⟨86, _⟩ =>
    show ‖(144 / 276480 : 𝕂) • (b * a * b * b * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (144 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b a b b a b b s hb ha hb hb ha hb hb (by norm_num) hs
  | ⟨87, _⟩ =>
    show ‖(-128 / 276480 : 𝕂) • (b * a * b * b * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-128 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b a b b b a a s hb ha hb hb hb ha ha (by norm_num) hs
  | ⟨88, _⟩ =>
  ...
  | ⟨89, _⟩ =>
    show ‖(80 / 276480 : 𝕂) • (b * a * b * b * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (80 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b a b b b b a s hb ha hb hb hb hb ha (by norm_num) hs
  | ⟨90, _⟩ =>
    show ‖(43 / 276480 : 𝕂) • (b * b * a * a * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (43 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a a a a s hb hb ha ha ha ha ha (by norm_num) hs
  | ⟨91, _⟩ =>
  ...
  | ⟨93, _⟩ =>
    show ‖(-80 / 276480 : 𝕂) • (b * b * a * a * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-80 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b b a a a b b s hb hb ha ha ha hb hb (by norm_num) hs
  | ⟨94, _⟩ =>
    show ‖(76 / 276480 : 𝕂) • (b * b * a * a * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (76 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a a b a a s hb hb ha ha hb ha ha (by norm_num) hs
  | ⟨95, _⟩ =>
  ...
  | ⟨97, _⟩ =>
    show ‖(-16 / 276480 : 𝕂) • (b * b * a * a * b * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-16 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b b a a b b b s hb hb ha ha hb hb hb (by norm_num) hs
  | ⟨98, _⟩ =>
    show ‖(108 / 276480 : 𝕂) • (b * b * a * b * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (108 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b a a a s hb hb ha hb ha ha ha (by norm_num) hs
  | ⟨99, _⟩ =>
  ...
  | ⟨101, _⟩ =>
    show ‖(96 / 276480 : 𝕂) • (b * b * a * b * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (96 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b b a b a b b s hb hb ha hb ha hb hb (by norm_num) hs
  | ⟨102, _⟩ =>
    show ‖(-8 / 276480 : 𝕂) • (b * b * a * b * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-8 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b a b b a a s hb hb ha hb hb ha ha (by norm_num) hs
  | ⟨103, _⟩ =>
  ...
  | ⟨104, _⟩ =>
    show ‖(-64 / 276480 : 𝕂) • (b * b * a * b * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-64 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b b a b b b a s hb hb ha hb hb hb ha (by norm_num) hs
  | ⟨105, _⟩ =>
    show ‖(-64 / 276480 : 𝕂) • (b * b * b * a * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-64 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a a a a s hb hb hb ha ha ha ha (by norm_num) hs
  | ⟨106, _⟩ =>
  ...
  | ⟨108, _⟩ =>
    show ‖(-16 / 276480 : 𝕂) • (b * b * b * a * a * b * b)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-16 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b b b a a b b s hb hb hb ha ha hb hb (by norm_num) hs
  | ⟨109, _⟩ =>
    show ‖(-88 / 276480 : 𝕂) • (b * b * b * a * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-88 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b a b a a s hb hb hb ha hb ha ha (by norm_num) hs
  | ⟨110, _⟩ =>
  ...
  | ⟨111, _⟩ =>
    show ‖(16 / 276480 : 𝕂) • (b * b * b * a * b * b * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (16 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        ...
        b b b a b b a s hb hb hb ha hb hb ha (by norm_num) hs
  | ⟨112, _⟩ =>
    show ‖(52 / 276480 : 𝕂) • (b * b * b * b * a * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (52 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b b a a a s hb hb hb hb ha ha ha (by norm_num) hs
  | ⟨113, _⟩ =>
  ...
  | ⟨115, _⟩ =>
    show ‖(-16 / 276480 : 𝕂) • (b * b * b * b * b * a * a)‖ ≤ (1280 / 276480 : ℝ) * s^7 from
      deg7_smul_word_le (-16 / 276480 : 𝕂) (1280 / 276480 : ℝ)
        (by rw [norm_div]; simp [RCLike.norm_ofNat] <;> norm_num)
        b b b b b a a s hb hb hb hb hb ha ha (by norm_num) hs
  | ⟨_ + 116, h⟩ => absurd h (by omega)

set_option maxHeartbeats 800000 in
/-- **Norm bound for `septic_d7_perturbation_poly`**:
`‖septic_d7_perturbation(a, b)‖ ≤ (‖a‖+‖b‖)⁷`.

Uniform per-i bound `1280/276480` (max |scaled coef|), giving
Σ ≤ 116·1280/276480 = 148480/276480 ≈ 0.5370 ≤ 1.
Actual Σ|num|/276480 ≈ 0.0509.

Companion to `norm_symmetric_bch_septic_correction_poly_le` (the same
polynomial − ½·[C₆(½a,b), ½a]). -/
theorem norm_septic_d7_perturbation_poly_le (a b : 𝔸) :
    ‖septic_d7_perturbation_poly 𝕂 a b‖ ≤ (‖a‖ + ‖b‖) ^ 7 := by
  set s := ‖a‖ + ‖b‖ with hs_def
  have hs_nn : 0 ≤ s := by positivity
  have ha_le : ‖a‖ ≤ s := by linarith [norm_nonneg b]
  have hb_le : ‖b‖ ≤ s := by linarith [norm_nonneg a]
  have hs7_nn : 0 ≤ s ^ 7 := pow_nonneg hs_nn 7
  rw [septic_d7_perturbation_poly_eq_sum]
  calc ‖∑ i : Fin 116, septicD7PerturbationTerm (𝕂 := 𝕂) a b i‖
      ≤ ∑ i : Fin 116, ‖septicD7PerturbationTerm (𝕂 := 𝕂) a b i‖ := norm_sum_le _ _
    _ ≤ ∑ _i : Fin 116, (1280 / 276480 : ℝ) * s^7 :=
        Finset.sum_le_sum (fun i _ => septicD7PerturbationTerm_norm_le (𝕂 := 𝕂) a b s ha_le hb_le hs_nn i)
    _ = 116 * ((1280 / 276480 : ℝ) * s^7) := by
        rw [Finset.sum_const, Finset.card_univ, Fintype.card_fin]; ring
    _ ≤ 1 * s^7 := by nlinarith [hs7_nn]
    _ = s ^ 7 := one_mul _

/-! ### T2-F7e-septic Phase D: Septic extended hdecomp identity

The algebraic decomposition of `sym_bch_cubic - sym_E₃ - sym_E₅ - sym_E₇` into
20 sub-pieces. Deg-9 analog of `symmetric_bch_quintic_extended_hdecomp` (the
13-piece quintic version at one degree lower).

The 20 sub-pieces are organized into 6 groups:

**Group A (nonic-related, 3 sub-pieces)**:
- `R₁_nonic` = bch(a',b) − [(a'+b) + ½[a',b] + C₃ + ... + C₈](a',b)
- `R₂_nonic` = bch(z,a') − [(z+a') + ½[z,a'] + C₃ + ... + C₈](z,a')
- `½·[R₁_nonic, a']`

**Group B-octic (C₈ extras, 2 sub-pieces, NEW for septic)**:
- `½·[C₈(a',b), a']`
- `C₈(z,a') − C₈(a'+b, a')`

**Group C-quintic (Phase B deg-5 cancellation group, 4 sub-pieces; retained from quintic)**:
- `T₅` = C₃(z,a') − C₃(a'+b,a') + (1/96)·[b, [a, [a, b]]]
- `T₆` = C₄(z,a') − C₄(a'+b, a')
- `½·[C₄(a',b), a']`
- `−quintic_correction`

**Group D-quintic (Phase C deg-6 cancellation group, 4 sub-pieces; retained)**:
- `½·[C₅(a',b), a']`
- `C₆(a',b)`
- `C₆(a'+b, a')`
- `C₅(z,a') − C₅(a'+b, a')`

**Group E-septic (Phase B deg-7 cancellation group, 3 sub-pieces, NEW)**:
- `C₇(z,a') − C₇(a'+b, a')`
- `½·[C₆(a',b), a']`
- `−septic_correction`

**Group F-septic (Phase C deg-8 cancellation group, 4 sub-pieces, NEW)**:
- `½·[C₇(a',b), a']`
- `C₈(a',b)`
- `C₈(a'+b, a')`
- `C₆(z,a') − C₆(a'+b, a')`

CAS-verified at `scripts/verify_septic_extended_hdecomp.py`: LHS = RHS as
polynomials in 𝕂⟨a, b⟩ truncated at degree 9 (both have 435 non-zero deg-9
words). Palindromic vanishing of even degrees ensures the LHS sits entirely
at deg 9 (no deg 2, 4, 6, 8 residue).

The proof extends the quintic template by:
...
3. Substituting the sym_E₇ alt-form (via `symmetric_bch_septic_poly_alt_form`, NEW).
4. Using R-nonic definitions instead of R-sept (two more BCH expansion degrees).
5. Using the quartic identity for deg-4 cancellation.
-/
set_option maxHeartbeats 128000000 in
private theorem symmetric_bch_septic_extended_hdecomp
    {𝕂 : Type*} [RCLike 𝕂] {𝔸 : Type*}
    [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] [NormOneClass 𝔸] [CompleteSpace 𝔸]
    (a b : 𝔸) :
    let a' : 𝔸 := (2 : 𝕂)⁻¹ • a
    let z := bch (𝕂 := 𝕂) a' b
    let R₁_nonic := z - (a' + b) - (2 : 𝕂)⁻¹ • (a' * b - b * a') -
                    bch_cubic_term 𝕂 a' b - bch_quartic_term 𝕂 a' b -
                    bch_quintic_term 𝕂 a' b - bch_sextic_term 𝕂 a' b -
                    bch_septic_term 𝕂 a' b - bch_octic_term 𝕂 a' b
    let R₂_nonic := bch (𝕂 := 𝕂) z a' - (z + a') - (2 : 𝕂)⁻¹ • (z * a' - a' * z) -
                    bch_cubic_term 𝕂 z a' - bch_quartic_term 𝕂 z a' -
                    bch_quintic_term 𝕂 z a' - bch_sextic_term 𝕂 z a' -
    ...
    symmetric_bch_cubic 𝕂 a b - symmetric_bch_cubic_poly 𝕂 a b
      ...
      -- Group A: nonic-related (3 sub-pieces)
      R₁_nonic + R₂_nonic +
      (2 : 𝕂)⁻¹ • (R₁_nonic * a' - a' * R₁_nonic) +
      -- Group B-octic: C₈ extras (2 sub-pieces, NEW)
      (2 : 𝕂)⁻¹ • (bch_octic_term 𝕂 a' b * a' - a' * bch_octic_term 𝕂 a' b) +
      (bch_octic_term 𝕂 z a' - bch_octic_term 𝕂 (a' + b) a') +
      -- Group C-quintic: Phase B deg-5 cancellation group (4 sub-pieces, retained)
      (bch_cubic_term 𝕂 z a' - bch_cubic_term 𝕂 (a' + b) a' -
        -((96 : 𝕂)⁻¹ • (b * DC_a - DC_a * b))) +
      (bch_quartic_term 𝕂 z a' - bch_quartic_term 𝕂 (a' + b) a') +
      (2 : 𝕂)⁻¹ • (bch_quartic_term 𝕂 a' b * a' - a' * bch_quartic_term 𝕂 a' b) +
      ...
      -symmetric_bch_septic_correction_poly 𝕂 a b +
      -- Group F-septic: Phase C deg-8 cancellation group (4 sub-pieces, NEW)
      (2 : 𝕂)⁻¹ • (bch_septic_term 𝕂 a' b * a' - a' * bch_septic_term 𝕂 a' b) +
      bch_octic_term 𝕂 a' b +
      bch_octic_term 𝕂 (a' + b) a' +
      (bch_sextic_term 𝕂 z a' - bch_sextic_term 𝕂 (a' + b) a') := by
  intro a' z R₁_nonic R₂_nonic DC_a
  -- Use sym_E₃ alt-form.
  rw [symmetric_bch_cubic_poly_alt_form (𝕂 := 𝕂)]
  -- Use sym_E₅ alt-form.
  rw [symmetric_bch_quintic_poly_alt_form (𝕂 := 𝕂)]
  -- Use sym_E₇ alt-form (NEW for septic).
  rw [symmetric_bch_septic_poly_alt_form (𝕂 := 𝕂)]
  -- Make a' and z explicit (let-bindings unfold).
  show bch (𝕂 := 𝕂) (bch (𝕂 := 𝕂) ((2 : 𝕂)⁻¹ • a) b) ((2 : 𝕂)⁻¹ • a) - (a + b) -
      (bch_cubic_term 𝕂 ((2 : 𝕂)⁻¹ • a) b +
       bch_cubic_term 𝕂 ((2 : 𝕂)⁻¹ • a + b) ((2 : 𝕂)⁻¹ • a) -
       (16 : 𝕂)⁻¹ • (a * (a * b - b * a) - (a * b - b * a) * a)) -
      ...
      (bch_septic_term 𝕂 ((2 : 𝕂)⁻¹ • a) b +
       bch_septic_term 𝕂 ((2 : 𝕂)⁻¹ • a + b) ((2 : 𝕂)⁻¹ • a) +
       symmetric_bch_septic_correction_poly 𝕂 a b) = _
  have hbch_inner : bch (𝕂 := 𝕂) ((2 : 𝕂)⁻¹ • a) b = z := rfl
  -- Express bch(z, a') via R₂_nonic definition (extends through C₈).
  have hbch_z_a' : bch (𝕂 := 𝕂) z a' = (z + a') + (2 : 𝕂)⁻¹ • (z * a' - a' * z) +
      bch_cubic_term 𝕂 z a' + bch_quartic_term 𝕂 z a' +
      bch_quintic_term 𝕂 z a' + bch_sextic_term 𝕂 z a' +
      bch_septic_term 𝕂 z a' + bch_octic_term 𝕂 z a' + R₂_nonic := by
    show bch (𝕂 := 𝕂) z a' = (z + a') + (2 : 𝕂)⁻¹ • (z * a' - a' * z) +
        bch_cubic_term 𝕂 z a' + bch_quartic_term 𝕂 z a' +
        bch_quintic_term 𝕂 z a' + bch_sextic_term 𝕂 z a' +
        bch_septic_term 𝕂 z a' + bch_octic_term 𝕂 z a' +
        (bch (𝕂 := 𝕂) z a' - (z + a') - (2 : 𝕂)⁻¹ • (z * a' - a' * z) -
         ...
         bch_septic_term 𝕂 z a' - bch_octic_term 𝕂 z a')
    abel
  -- z·a' - a'·z split via z = (a'+b) + W.
  have hzcom : z * a' - a' * z = (a' + b) * a' - a' * (a' + b) +
      ((z - (a' + b)) * a' - a' * (z - (a' + b))) := by noncomm_ring
  -- W = z - (a'+b) (extends through C₈).
  have hW_eq : z - (a' + b) =
      (2 : 𝕂)⁻¹ • (a' * b - b * a') + bch_cubic_term 𝕂 a' b +
        bch_quartic_term 𝕂 a' b + bch_quintic_term 𝕂 a' b +
        bch_sextic_term 𝕂 a' b + bch_septic_term 𝕂 a' b +
        bch_octic_term 𝕂 a' b + R₁_nonic := by
    show z - (a' + b) =
        (2 : 𝕂)⁻¹ • (a' * b - b * a') + bch_cubic_term 𝕂 a' b +
        bch_quartic_term 𝕂 a' b + bch_quintic_term 𝕂 a' b +
        bch_sextic_term 𝕂 a' b + bch_septic_term 𝕂 a' b +
  ...
  have hz_eq : z = a' + b + (2 : 𝕂)⁻¹ • (a' * b - b * a') + bch_cubic_term 𝕂 a' b +
      ...
      bch_octic_term 𝕂 a' b + R₁_nonic := by
    rw [show z = (z - (a' + b)) + (a' + b) from by abel, hW_eq]; abel
  -- Quartic identity rearrangement.
  have hQI := symmetric_bch_quartic_identity (𝕂 := 𝕂) a b
  have hQI_rearr : bch_quartic_term 𝕂 (a' + b) a' =
      -((2 : 𝕂)⁻¹ • (bch_cubic_term 𝕂 a' b * a' - a' * bch_cubic_term 𝕂 a' b)) -
      bch_quartic_term 𝕂 a' b +
    ...
    have hW := eq_neg_of_add_eq_zero_right h'
    rw [hW]; abel
  -- Apply the rewrites in sequence (mirrors quintic proof).
  rw [hbch_inner, hbch_z_a', hzcom, hW_eq]
  rw [hQI_rearr]
  nth_rewrite 1 [hz_eq]
  -- Unfold a' to (2:𝕂)⁻¹•a to align all atoms.
  simp only [show a' = ((2 : 𝕂)⁻¹ • a : 𝔸) from rfl]
  -- Distribute smul through products and use match_scalars + ring.
  simp only [smul_sub, smul_add, smul_mul_assoc, mul_smul_comm, smul_smul,
    add_mul, mul_add, sub_mul, mul_sub]
  match_scalars <;> ring
...
/-! ### T2-F7e-septic Phase F.1 bound: Group F-septic ≤ K·s⁷

Group F-septic (4 sub-pieces of `symmetric_bch_septic_extended_hdecomp`):

  ½·[C₇(a', b), a'] + C₈(a', b) + C₈(a'+b, a')
  + (C₆(z, a') − C₆(a'+b, a')).

By `septic_d8_cancellation_poly_form` (`d8_pert + C₈(a',b) + ½·[C₇(a',b), a']
+ C₈(a'+b, a') = 0`), this rewrites as

  (C₆(z, a') − C₆(a'+b, a')) − septic_d8_perturbation_poly(a, b).

Per-piece bounds:
* `‖C₆(z, a') − C₆(a'+b, a')‖ ≤ (45/11)⁵·(48/11)·s⁷ ≈ 5236·s⁷`
  via `norm_bch_sextic_term_diff_le` + standard `M ≤ (45/11)·s`,
  `‖z−(a'+b)‖ ≤ (48/11)·s²` bounds.
* `‖septic_d8_perturbation_poly(a, b)‖ ≤ s⁸` via
  `norm_septic_d8_perturbation_poly_le`.

Combined via triangle inequality + the `s < 1/4` fold s⁸ → s⁷:
  ≤ 6000·s⁷ + s⁸ ≤ 6001·s⁷ ≤ 10⁴·s⁷.

This covers the 17th-20th of 20 pieces of `symmetric_bch_septic_extended_hdecomp`.
Companion to `norm_septic_group_E_le` (Phase B-septic deg-7 cancellation).
Together with `norm_septic_group_AB_le`, this brings the total to 12 of 20
pieces. The remaining 8 pieces (Groups C-quintic + D-quintic) carry the
deg-5/6 leading parts that combine with these septic residuals to drop to
deg-9; that combined-group identity remains for a future session. -/
set_option maxHeartbeats 4000000 in
private theorem norm_septic_group_F_le
    {𝕂 : Type*} [RCLike 𝕂] {𝔸 : Type*}
    [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] [NormOneClass 𝔸] [CompleteSpace 𝔸]
    (a b : 𝔸) (hab : ‖a‖ + ‖b‖ < 1 / 4) :
    ‖(2 : 𝕂)⁻¹ • (bch_septic_term 𝕂 ((2 : 𝕂)⁻¹ • a) b * ((2 : 𝕂)⁻¹ • a) -
     ...
     bch_octic_term 𝕂 ((2 : 𝕂)⁻¹ • a + b) ((2 : 𝕂)⁻¹ • a) +
     (bch_sextic_term 𝕂 (bch (𝕂 := 𝕂) ((2 : 𝕂)⁻¹ • a) b) ((2 : 𝕂)⁻¹ • a) -
        bch_sextic_term 𝕂 ((2 : 𝕂)⁻¹ • a + b) ((2 : 𝕂)⁻¹ • a))‖ ≤
      10000 * (‖a‖ + ‖b‖) ^ 7 := by
  -- ALGEBRAIC step: use septic_d8_cancellation_poly_form to absorb
  -- ½·[C₇, a'] + C₈(a',b) + C₈(a'+b, a') = −d8_pert.
  have hd8 := septic_d8_cancellation_poly_form (𝕂 := 𝕂) a b
  have halg :
      (2 : 𝕂)⁻¹ • (bch_septic_term 𝕂 ((2 : 𝕂)⁻¹ • a) b * ((2 : 𝕂)⁻¹ • a) -
                    ((2 : 𝕂)⁻¹ • a) * bch_septic_term 𝕂 ((2 : 𝕂)⁻¹ • a) b) +
      bch_octic_term 𝕂 ((2 : 𝕂)⁻¹ • a) b +
      ...
      (bch_sextic_term 𝕂 (bch (𝕂 := 𝕂) ((2 : 𝕂)⁻¹ • a) b) ((2 : 𝕂)⁻¹ • a) -
        bch_sextic_term 𝕂 ((2 : 𝕂)⁻¹ • a + b) ((2 : 𝕂)⁻¹ • a)) -
      septic_d8_perturbation_poly 𝕂 a b := by
    linear_combination (norm := abel) hd8
  rw [halg]
  -- SETUP: mirrors `norm_septic_group_E_le`.
  set a' : 𝔸 := (2 : 𝕂)⁻¹ • a with ha'_def
  set s := ‖a‖ + ‖b‖ with hs_def
  set s₁ := ‖a'‖ + ‖b‖ with hs₁_def
  set z := bch (𝕂 := 𝕂) a' b with hz_def
  ...
  have hM_le : ‖z‖ + ‖a' + b‖ + ‖a'‖ ≤ 45/11 * s := by
    ...
    linarith
  have hM_nn : (0 : ℝ) ≤ ‖z‖ + ‖a' + b‖ + ‖a'‖ := by positivity
  -- TERM A: ‖C₆(z, a') − C₆(a'+b, a')‖ ≤ 6000·s⁷.
  have hCA : ‖bch_sextic_term 𝕂 z a' - bch_sextic_term 𝕂 (a' + b) a'‖ ≤
              6000 * s ^ 7 := by
    have h := norm_bch_sextic_term_diff_le (𝕂 := 𝕂) z (a' + b) a'
    -- h : ‖.‖ ≤ M⁵ · ‖z − (a'+b)‖, M ≤ (45/11)·s, ‖W‖ ≤ (48/11)·s².
    -- (45/11)⁵·(48/11)·s⁷ ≈ 1146·4.36·s⁷ ≈ 5001·s⁷ < 6000·s⁷.
    have hM_pow_le : (‖z‖ + ‖a' + b‖ + ‖a'‖) ^ 5 ≤ (45/11 * s) ^ 5 :=
      pow_le_pow_left₀ hM_nn hM_le 5
    have hM_pow_eq : (45/11 * s) ^ 5 = (45/11 : ℝ) ^ 5 * s ^ 5 := by ring
    have h_45_5 : ((45 : ℝ) / 11) ^ 5 ≤ 1146 := by norm_num
    ...
    calc _ ≤ (‖z‖ + ‖a' + b‖ + ‖a'‖) ^ 5 * ‖z - (a' + b)‖ := h
      ...
      _ ≤ (1146 * s ^ 5) * (48/11 * s ^ 2) := by
          apply mul_le_mul_of_nonneg_right _ (by positivity)
          exact mul_le_mul_of_nonneg_right h_45_5 hs5_nn
      _ ≤ 6000 * s ^ 7 := by nlinarith [hs7_nn]
  -- TERM B: ‖septic_d8_perturbation_poly(a, b)‖ ≤ s⁸.
  have hDp : ‖septic_d8_perturbation_poly 𝕂 a b‖ ≤ s ^ 8 :=
    norm_septic_d8_perturbation_poly_le a b
  -- Triangle inequality on the 2-piece difference + final fold s⁸ → s⁷.
  have hsubtriangle :
      ‖(bch_sextic_term 𝕂 z a' - bch_sextic_term 𝕂 (a' + b) a') -
        septic_d8_perturbation_poly 𝕂 a b‖ ≤
      ...
      ‖septic_d8_perturbation_poly 𝕂 a b‖ := by
    rw [sub_eq_add_neg]
    calc _ ≤ _ + ‖-(septic_d8_perturbation_poly 𝕂 a b)‖ := norm_add_le _ _
      _ = _ + ‖septic_d8_perturbation_poly 𝕂 a b‖ := by rw [norm_neg]
  calc _ ≤ ‖bch_sextic_term 𝕂 z a' - bch_sextic_term 𝕂 (a' + b) a'‖ +
          ‖septic_d8_perturbation_poly 𝕂 a b‖ := hsubtriangle
