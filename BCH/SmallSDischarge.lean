...
remainder pattern). -/
private theorem norm_bch_septic_remainder_large_s_le (a b : 𝔸)
    (hab : ‖a‖ + ‖b‖ < Real.log 2) (hs_large : 1 / 10 ≤ ‖a‖ + ‖b‖) :
    ‖bch (𝕂 := 𝕂) a b - (a + b) - (2 : 𝕂)⁻¹ • (a * b - b * a) -
      bch_cubic_term 𝕂 a b - bch_quartic_term 𝕂 a b -
...
private theorem norm_pow7_sub_zpow7_le (y P : 𝔸) {s : ℝ} (hs_nn : 0 ≤ s)
    (hy : ‖y‖ ≤ 2 * s) (hz : ‖y - P‖ ≤ s) (hP : ‖P‖ ≤ s ^ 2) :
...
private theorem norm_y5_sub_z5_sub_y5_6_le (y P T₂ : 𝔸) {s : ℝ} (hs_nn : 0 ≤ s)
    (hy : ‖y‖ ≤ 2 * s) (hz : ‖y - P‖ ≤ s) (hP : ‖P‖ ≤ s ^ 2)
    (hPmT₂ : ‖P - T₂‖ ≤ 5 * s ^ 3) :
    ‖y ^ 5 - (y - P) ^ 5 -
      ((y - P) ^ 4 * T₂ + (y - P) ^ 3 * T₂ * (y - P) +
...
private theorem norm_y6_sub_z6_sub_y6_7_le (y P T₂ : 𝔸) {s : ℝ} (hs_nn : 0 ≤ s)
    (hy : ‖y‖ ≤ 2 * s) (hz : ‖y - P‖ ≤ s) (hP : ‖P‖ ≤ s ^ 2)
    (hPmT₂ : ‖P - T₂‖ ≤ 5 * s ^ 3) :
    ‖y ^ 6 - (y - P) ^ 6 -
      ((y - P) ^ 5 * T₂ + (y - P) ^ 4 * T₂ * (y - P) +
...
private theorem R_plus_T5_plus_T6_eq_neg_deg7_residual (𝕂 : Type*) [RCLike 𝕂] {𝔸 : Type*}
    [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (ea eb a b : 𝔸) :
    let D₁ : 𝔸 := ea - 1 - a
    let D₂ : 𝔸 := eb - 1 - b
    let E₁ : 𝔸 := D₁ - (2 : 𝕂)⁻¹ • a ^ 2
...
private theorem R_plus_T5_plus_T6_plus_T7_eq_neg_deg8_residual (𝕂 : Type*) [RCLike 𝕂]
...
private theorem norm_I1_octic_residual_RHS_le (a b z J_a J_b I_a I_b H₁ H₂ G₁ G₂
...
private theorem norm_PzP_sub_T2zT2_etc_le (z P T₂ T₃ : 𝔸) {s : ℝ} (hs_nn : 0 ≤ s)
    (hs_small : s ≤ 1 / 10) (hz : ‖z‖ ≤ s) (hT₂ : ‖T₂‖ ≤ s ^ 2)
    (hT₃ : ‖T₃‖ ≤ s ^ 3)
    (hPmT₂mT₃ : ‖P - T₂ - T₃‖ ≤ 5 * s ^ 4) :
...
private theorem norm_combined_tricky_octic_le (z P R T₂ T₃ T₄ T₅ T₆ : 𝔸) {s : ℝ}
    (hs_nn : 0 ≤ s) (hs_small : s ≤ 1 / 10)
    (hz : ‖z‖ ≤ s) (hT₂ : ‖T₂‖ ≤ s ^ 2) (hT₃ : ‖T₃‖ ≤ s ^ 3)
    (hT₄ : ‖T₄‖ ≤ s ^ 4) (hT₅ : ‖T₅‖ ≤ s ^ 5)
    (hRT5T6 : ‖R + T₅ + T₆‖ ≤ 7 * s ^ 7)
...
private theorem norm_y4_sub_z4_sub_y4_5_sub_y4_6_sub_y4_7_le (y P T₂ T₃ T₄ : 𝔸)
...
private theorem norm_y5_sub_z5_sub_y5_6_sub_y5_7_le (y P T₂ T₃ : 𝔸)
    {s : ℝ} (hs_nn : 0 ≤ s) (hs_le_one : s ≤ 1)
    (hy : ‖y‖ ≤ 2 * s) (hz : ‖y - P‖ ≤ s) (hP : ‖P‖ ≤ s ^ 2)
    (hT₂ : ‖T₂‖ ≤ s ^ 2)
    (hPmT₂ : ‖P - T₂‖ ≤ 5 * s ^ 3)
...
private theorem pieceB_septic_decomp (𝕂 : Type*) [RCLike 𝕂] {𝔸 : Type*}
    [NormedRing 𝔸] [NormedAlgebra 𝕂 𝔸] (a b : 𝔸) :
    let z : 𝔸 := a + b
    let T₂ : 𝔸 := a * b + (2 : 𝕂)⁻¹ • a ^ 2 + (2 : 𝕂)⁻¹ • b ^ 2
    let T₃_QPI : 𝔸 := (6 : 𝕂)⁻¹ • a ^ 3 + (6 : 𝕂)⁻¹ • b ^ 3 +
